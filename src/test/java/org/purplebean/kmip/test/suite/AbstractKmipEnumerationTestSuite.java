...
public abstract class AbstractKmipEnumerationTestSuite<T extends KmipEnumeration>
  ...
  /**
   * Override and return true if this enumeration supports runtime registry behavior (e.g.,
  ...
  protected void enumeration_equalsAndHashCode_equalInstances() {
    ...
    if (b == null) {
      return; // implementor didn't supply; skip
    }
