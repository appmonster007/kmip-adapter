...
@DisplayName("MaskGeneratorHashingAlgorithm TTLV Serialization")
class MaskGeneratorHashingAlgorithmTtlvTest
    extends AbstractTtlvSerializationTestSuite<MaskGeneratorHashingAlgorithm> {
  @Override
