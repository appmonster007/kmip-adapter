...
@DisplayName("LogoutOpRequestPayload Domain Tests")
class LogoutOpRequestPayloadTest extends AbstractKmipStructureTestSuite<LogoutOpRequestPayload> {
  ...
  @Override
  protected Class<LogoutOpRequestPayload> type() {
    return LogoutOpRequestPayload.class;
  }

  @Override
  protected LogoutOpRequestPayload createDefault() {
