...
class PrivateKeyLinkTest extends AbstractKmipDataTypeTestSuite<PrivateKeyLink>
    implements KmipAttributeTestSuite<PrivateKeyLink> {
  ...
  public PrivateKeyLink createDefault() {
    return PrivateKeyLink.of("test-id");
  }
  ...
  // attribute like PrivateKeyLink round-trips directly through the KmipAttribute registry
  // instead.
  @Override
  public void attribute_roundTrip() {
    PrivateKeyLink obj = createDefault();
    BiFunction<AttributeName, AttributeValue, ? extends KmipAttribute> builder =
        KmipAttribute.getAttributeBuilderFromRegistry(KmipTag.Standard.PRIVATE_KEY_LINK,
            obj.getEncodingType());
