...
class NextLinkTest extends AbstractKmipDataTypeTestSuite<NextLink>
    implements KmipAttributeTestSuite<NextLink> {
  ...
  // attribute like NextLink round-trips directly through the KmipAttribute registry instead.
  @Override
  public void attribute_roundTrip() {
    NextLink obj = createDefault();
    BiFunction<AttributeName, AttributeValue, ? extends KmipAttribute> builder =
        KmipAttribute.getAttributeBuilderFromRegistry(KmipTag.Standard.NEXT_LINK,
            obj.getEncodingType());
