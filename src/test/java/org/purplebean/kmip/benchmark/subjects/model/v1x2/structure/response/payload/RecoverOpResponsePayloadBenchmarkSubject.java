...
/**
 * Benchmark subject for {@link RecoverOpResponsePayload}.
 */
public class RecoverOpResponsePayloadBenchmarkSubject
    extends KmipBenchmarkSubject<RecoverOpResponsePayload> {

  @Getter
  private final KmipSpec spec = KmipSpec.V1_2;

  /**
   * Constructs a new {@link RecoverOpResponsePayloadBenchmarkSubject}.
   */
  public RecoverOpResponsePayloadBenchmarkSubject() throws Exception {
    RecoverOpResponsePayload subject = RecoverOpResponsePayload
        .builder()
