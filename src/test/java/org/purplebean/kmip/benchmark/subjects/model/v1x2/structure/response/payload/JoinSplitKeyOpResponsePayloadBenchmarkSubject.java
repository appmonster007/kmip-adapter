...
/**
 * Benchmark subject for {@link JoinSplitKeyOpResponsePayload}.
 */
public class JoinSplitKeyOpResponsePayloadBenchmarkSubject
    extends KmipBenchmarkSubject<JoinSplitKeyOpResponsePayload> {

  @Getter
  private final KmipSpec spec = KmipSpec.V1_2;

  /**
   * Constructs a new {@link JoinSplitKeyOpResponsePayloadBenchmarkSubject}.
   */
  public JoinSplitKeyOpResponsePayloadBenchmarkSubject() throws Exception {
    JoinSplitKeyOpResponsePayload subject = JoinSplitKeyOpResponsePayload
        .builder()
