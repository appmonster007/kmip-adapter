...
@DisplayName("TransparentEcdsaPublicKey TTLV Serialization Tests")
class TransparentEcdsaPublicKeyTtlvTest extends AbstractTtlvSerializationTestSuite<TransparentEcdsaPublicKey> {
