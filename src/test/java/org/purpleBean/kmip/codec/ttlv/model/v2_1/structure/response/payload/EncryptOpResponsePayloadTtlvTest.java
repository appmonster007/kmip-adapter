...
class EncryptOpResponsePayloadTtlvTest extends AbstractTtlvSerializationTestSuite<EncryptOpResponsePayload> {
    ...
    public EncryptOpResponsePayload createDefault() {
        return EncryptOpResponsePayload.builder().uniqueIdentifier(UniqueIdentifier.of("test-uid")).build();
    }
