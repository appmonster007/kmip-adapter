...
class SignOpResponsePayloadTtlvTest extends AbstractTtlvSerializationTestSuite<SignOpResponsePayload> {
    ...
    public SignOpResponsePayload createDefault() {
        return SignOpResponsePayload.builder().uniqueIdentifier(UniqueIdentifier.of("test-uid")).build();
    }
