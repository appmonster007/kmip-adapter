...
class KeyWrappingSpecificationTtlvTest extends AbstractTtlvSerializationTestSuite<KeyWrappingSpecification> {
    ...
    public KeyWrappingSpecification createVariant() {
        return KeyWrappingSpecification.builder()
                ...
                .encryptionKeyInformation(EncryptionKeyInformation.builder()
                        .uniqueIdentifier(UniqueIdentifier.of(UUID.randomUUID().toString()))
                        .build())
                .build();
    }
}