...
@DisplayName("CancelOpResponsePayload Ttlv Serialization Tests")
class CancelOpResponsePayloadTtlvTest extends AbstractTtlvSerializationTestSuite<CancelOpResponsePayload> {
