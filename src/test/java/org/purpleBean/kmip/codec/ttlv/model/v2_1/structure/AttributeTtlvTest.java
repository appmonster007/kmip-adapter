...
class AttributeTtlvTest extends AbstractTtlvSerializationTestSuite<Attribute> {
    ...
    public Attribute createDefault() {
        return Attribute.builder().vendorIdentification(org.purpleBean.kmip.model.core.type.VendorIdentification.of("vendor")).attributeName(org.purpleBean.kmip.model.core.type.AttributeName.of("TestAttr")).build();
    }
