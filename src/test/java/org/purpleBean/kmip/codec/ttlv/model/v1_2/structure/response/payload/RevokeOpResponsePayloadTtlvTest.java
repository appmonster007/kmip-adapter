...
@DisplayName("RevokeOpResponsePayload Ttlv Serialization Tests")
class RevokeOpResponsePayloadTtlvTest extends AbstractTtlvSerializationTestSuite<RevokeOpResponsePayload> {
