...
class DeriveKeyOpRequestPayloadJsonTest extends AbstractJsonSerializationTestSuite<DeriveKeyOpRequestPayload> {
    ...
    public DeriveKeyOpRequestPayload createVariant() {
        return DeriveKeyOpRequestPayload.builder()
                ...
                .uniqueIdentifier(UniqueIdentifier.builder().value("uid-2").build())
