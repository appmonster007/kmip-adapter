...
class DecryptOpResponsePayloadJsonTest extends AbstractJsonSerializationTestSuite<DecryptOpResponsePayload> {
    ...
    public DecryptOpResponsePayload createDefault() {
        return DecryptOpResponsePayload.builder().uniqueIdentifier(UniqueIdentifier.of("test-uid")).build();
    }
