...
class CreateOpResponsePayloadJsonTest extends AbstractJsonSerializationTestSuite<CreateOpResponsePayload> {
    ...
    public CreateOpResponsePayload createDefault() {
        return CreateOpResponsePayload.builder().objectType(ObjectType.Standard.SYMMETRIC_KEY.inst()).uniqueIdentifier(UniqueIdentifier.of("test-uid")).build();
    }
