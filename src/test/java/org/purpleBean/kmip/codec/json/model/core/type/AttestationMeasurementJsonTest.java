...
@DisplayName("AttestationMeasurement Json Serialization Tests")
class AttestationMeasurementJsonTest extends AbstractJsonSerializationTestSuite<AttestationMeasurement> {
