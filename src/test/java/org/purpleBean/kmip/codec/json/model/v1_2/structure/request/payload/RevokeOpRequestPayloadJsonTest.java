...
@DisplayName("RevokeOpRequestPayload Json Serialization Tests")
class RevokeOpRequestPayloadJsonTest extends AbstractJsonSerializationTestSuite<RevokeOpRequestPayload> {
