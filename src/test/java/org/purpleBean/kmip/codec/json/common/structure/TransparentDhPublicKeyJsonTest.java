...
@DisplayName("TransparentDhPublicKey JSON Serialization Tests")
class TransparentDhPublicKeyJsonTest extends AbstractJsonSerializationTestSuite<TransparentDhPublicKey> {
