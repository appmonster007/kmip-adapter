...
@DisplayName("CancelOpRequestPayload Json Serialization Tests")
class CancelOpRequestPayloadJsonTest extends AbstractJsonSerializationTestSuite<CancelOpRequestPayload> {
