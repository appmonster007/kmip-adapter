...
@DisplayName("TransparentEcdhPublicKey JSON Serialization Tests")
class TransparentEcdhPublicKeyJsonTest extends AbstractJsonSerializationTestSuite<TransparentEcdhPublicKey> {
