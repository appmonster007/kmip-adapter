...
@DisplayName("AttestationCredential Xml Serialization Tests")
class AttestationCredentialXmlTest extends AbstractXmlSerializationTestSuite<AttestationCredential> {
