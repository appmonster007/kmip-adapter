...
@DisplayName("ValidateOpRequestPayload Xml Serialization Tests")
class ValidateOpRequestPayloadXmlTest extends AbstractXmlSerializationTestSuite<ValidateOpRequestPayload> {
