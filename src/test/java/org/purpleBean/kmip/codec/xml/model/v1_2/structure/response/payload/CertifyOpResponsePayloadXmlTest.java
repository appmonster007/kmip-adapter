...
@DisplayName("CertifyOpResponsePayload Xml Serialization Tests")
class CertifyOpResponsePayloadXmlTest extends AbstractXmlSerializationTestSuite<CertifyOpResponsePayload> {
