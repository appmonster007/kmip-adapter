...
class GetAttributesOpRequestPayloadXmlTest extends AbstractXmlSerializationTestSuite<GetAttributesOpRequestPayload> {
    ...
    @Override
    protected GetAttributesOpRequestPayload createVariant() {
        return GetAttributesOpRequestPayload.builder()
