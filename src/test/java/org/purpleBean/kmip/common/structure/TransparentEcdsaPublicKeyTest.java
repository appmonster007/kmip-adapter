...
@DisplayName("TransparentEcdsaPublicKey Domain Tests")
class TransparentEcdsaPublicKeyTest extends AbstractKmipStructureTestSuite<TransparentEcdsaPublicKey> {
