...
class DestroyActionTest extends AbstractKmipEnumerationSuite<DestroyAction> {
    ...
    protected void assertLookupBehaviour() {
        ...
        DestroyAction.Value byName = DestroyAction.fromName(KmipSpec.UnknownVersion, "X-Enum-Custom");
        DestroyAction.Value byVal = DestroyAction.fromValue(KmipSpec.UnknownVersion, 0x80000010);
        assertThat(byName.getDescription()).isEqualTo("X-Enum-Custom");
        assertThat(byVal.getValue()).isEqualTo(0x80000010);

        // Lookup by name/value with unsupported version
        assertThatThrownBy(() -> DestroyAction.fromName(KmipSpec.UnsupportedVersion, "X-Enum-Custom"));
    }
