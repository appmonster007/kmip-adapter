...
class TicketTypeTest extends AbstractKmipEnumerationSuite<TicketType> {
    ...
    protected void assertLookupBehaviour() {
        ...
        TicketType.Value byName = TicketType.fromName(KmipSpec.UnknownVersion, "X-Enum-Custom");
        TicketType.Value byVal = TicketType.fromValue(KmipSpec.UnknownVersion, 0x80000010);
        assertThat(byName.getDescription()).isEqualTo("X-Enum-Custom");
        assertThat(byVal.getValue()).isEqualTo(0x80000010);

        // Lookup by name/value with unsupported version
        assertThatThrownBy(() -> TicketType.fromName(KmipSpec.UnsupportedVersion, "X-Enum-Custom"));
    }
