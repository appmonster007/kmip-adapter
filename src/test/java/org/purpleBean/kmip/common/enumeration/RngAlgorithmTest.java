...
class RngAlgorithmTest extends AbstractKmipEnumerationSuite<RngAlgorithm> {
    ...
    protected void assertLookupBehaviour() {
        ...
        RngAlgorithm.Value byName = RngAlgorithm.fromName(KmipSpec.UnknownVersion, "X-Enum-Custom");
        RngAlgorithm.Value byVal = RngAlgorithm.fromValue(KmipSpec.UnknownVersion, 0x80000010);
        assertThat(byName.getDescription()).isEqualTo("X-Enum-Custom");
        assertThat(byVal.getValue()).isEqualTo(0x80000010);

        // Lookup by name/value with unsupported version
        assertThatThrownBy(() -> RngAlgorithm.fromName(KmipSpec.UnsupportedVersion, "X-Enum-Custom"));
    }
