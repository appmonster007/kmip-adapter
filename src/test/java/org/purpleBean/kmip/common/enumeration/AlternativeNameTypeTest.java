...
class AlternativeNameTypeTest extends AbstractKmipEnumerationSuite<AlternativeNameType> {
    ...
    protected void assertEnumerationRegistryBehavior() {
        ...
        AlternativeNameType.Value custom = AlternativeNameType.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0));
        ...
        assertThatThrownBy(() -> AlternativeNameType.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> AlternativeNameType.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> AlternativeNameType.register(0x80000011, "   ", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0)))
                .isInstanceOf(IllegalArgumentException.class);
