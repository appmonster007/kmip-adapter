...
class RngModeTest extends AbstractKmipEnumerationSuite<RngMode> {
    ...
    protected void assertLookupBehaviour() {
        ...
        RngMode.Value byName = RngMode.fromName(KmipSpec.UnknownVersion, "X-Enum-Custom");
        RngMode.Value byVal = RngMode.fromValue(KmipSpec.UnknownVersion, 0x80000010);
        assertThat(byName.getDescription()).isEqualTo("X-Enum-Custom");
        assertThat(byVal.getValue()).isEqualTo(0x80000010);

        // Lookup by name/value with unsupported version
        assertThatThrownBy(() -> RngMode.fromName(KmipSpec.UnsupportedVersion, "X-Enum-Custom"));
    }
