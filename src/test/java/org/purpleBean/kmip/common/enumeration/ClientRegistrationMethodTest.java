...
class ClientRegistrationMethodTest extends AbstractKmipEnumerationSuite<ClientRegistrationMethod> {
    ...
    protected void assertLookupBehaviour() {
        ...
        ClientRegistrationMethod.Value byName = ClientRegistrationMethod.fromName(KmipSpec.UnknownVersion, "X-Enum-Custom");
        ClientRegistrationMethod.Value byVal = ClientRegistrationMethod.fromValue(KmipSpec.UnknownVersion, 0x80000010);
        assertThat(byName.getDescription()).isEqualTo("X-Enum-Custom");
        assertThat(byVal.getValue()).isEqualTo(0x80000010);

        // Lookup by name/value with unsupported version
        assertThatThrownBy(() -> ClientRegistrationMethod.fromName(KmipSpec.UnsupportedVersion, "X-Enum-Custom"));
    }
