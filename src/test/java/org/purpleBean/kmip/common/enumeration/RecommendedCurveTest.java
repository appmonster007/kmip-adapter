...
class RecommendedCurveTest extends AbstractKmipEnumerationSuite<RecommendedCurve> {
    ...
    protected void assertEnumerationRegistryBehavior() {
        ...
        RecommendedCurve.Value custom = RecommendedCurve.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion));
        ...
        assertThatThrownBy(() -> RecommendedCurve.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> RecommendedCurve.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> RecommendedCurve.register(0x80000011, "   ", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
