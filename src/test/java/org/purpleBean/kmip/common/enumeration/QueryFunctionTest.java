...
class QueryFunctionTest extends AbstractKmipEnumerationSuite<QueryFunction> {
    ...
    protected void assertLookupBehaviour() {
        ...
        withKmipSpec(
                ...
                () -> {
                    QueryFunction.Value byName = QueryFunction.fromName("X-Enum-Custom");
                    QueryFunction.Value byVal = QueryFunction.fromValue(0x80000010);
        ...
        withKmipSpec(
                ...
                () -> assertThatThrownBy(() -> QueryFunction.fromName("X-Enum-Custom"))
        );
    }
    ...
    protected void assertEnumerationRegistryBehavior() {
        ...
        QueryFunction.Value custom = QueryFunction.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion));
        ...
        assertThatThrownBy(() -> QueryFunction.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> QueryFunction.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> QueryFunction.register(0x80000011, "   ", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
