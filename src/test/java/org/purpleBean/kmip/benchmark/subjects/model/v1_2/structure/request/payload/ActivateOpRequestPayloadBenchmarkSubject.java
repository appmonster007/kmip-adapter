...
public class ActivateOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<ActivateOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public ActivateOpRequestPayloadBenchmarkSubject() throws Exception {
        ActivateOpRequestPayload subject = ActivateOpRequestPayload.builder()
