...
public class AlternativeNameTypeBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    private AlternativeNameType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new AlternativeNameType(AlternativeNameType.Standard.UNINTERPRETED_TEXT_STRING);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, AlternativeNameType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, AlternativeNameType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), AlternativeNameType.class);
    }
}
