...
public class DeactivationReasonCodeBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private DeactivationReasonCode obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new DeactivationReasonCode(DeactivationReasonCode.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, DeactivationReasonCode.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, DeactivationReasonCode.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), DeactivationReasonCode.class);
    }
}
