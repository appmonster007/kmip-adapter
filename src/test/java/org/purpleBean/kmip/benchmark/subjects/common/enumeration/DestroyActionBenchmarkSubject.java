...
public class DestroyActionBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private DestroyAction obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new DestroyAction(DestroyAction.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, DestroyAction.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, DestroyAction.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), DestroyAction.class);
    }
}
