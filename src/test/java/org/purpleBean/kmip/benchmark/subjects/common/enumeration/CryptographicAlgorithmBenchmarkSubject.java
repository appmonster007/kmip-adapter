...
public class CryptographicAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    private CryptographicAlgorithm obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new CryptographicAlgorithm(CryptographicAlgorithm.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, CryptographicAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, CryptographicAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), CryptographicAlgorithm.class);
    }
}
