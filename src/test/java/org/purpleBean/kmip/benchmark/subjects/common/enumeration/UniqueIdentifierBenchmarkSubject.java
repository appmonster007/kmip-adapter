...
public class UniqueIdentifierBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new UniqueIdentifier(UniqueIdentifier.Standard.ID_PLACEHOLDER);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, UniqueIdentifier.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, UniqueIdentifier.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), UniqueIdentifier.class);
    }
}
