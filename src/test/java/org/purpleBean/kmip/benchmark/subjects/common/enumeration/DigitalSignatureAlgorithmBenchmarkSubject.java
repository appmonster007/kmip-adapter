...
public class DigitalSignatureAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    private DigitalSignatureAlgorithm obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new DigitalSignatureAlgorithm(DigitalSignatureAlgorithm.Standard.MD2_WITH_RSA_ENCRYPTION);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, DigitalSignatureAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, DigitalSignatureAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), DigitalSignatureAlgorithm.class);
    }
}
