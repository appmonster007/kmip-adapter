...
public class KeyWrapTypeBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private KeyWrapType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new KeyWrapType(KeyWrapType.Standard.NOT_WRAPPED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, KeyWrapType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, KeyWrapType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), KeyWrapType.class);
    }
}
