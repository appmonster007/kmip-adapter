...
public class ObtainLeaseOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<ObtainLeaseOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public ObtainLeaseOpResponsePayloadBenchmarkSubject() throws Exception {
        ObtainLeaseOpResponsePayload subject = ObtainLeaseOpResponsePayload.builder()
