...
public class ObjectClassBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new ObjectClass(ObjectClass.Standard.USER);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ObjectClass.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ObjectClass.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ObjectClass.class);
    }
}
