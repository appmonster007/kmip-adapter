...
public class TransparentEcPublicKeyBenchmarkSubject extends KmipBenchmarkSubject<TransparentEcPublicKey> {
    ...
    public TransparentEcPublicKeyBenchmarkSubject() throws Exception {
        ...
        TransparentEcPublicKey subject = TransparentEcPublicKey.builder()
