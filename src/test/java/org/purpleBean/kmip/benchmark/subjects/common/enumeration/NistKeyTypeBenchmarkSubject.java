...
public class NistKeyTypeBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, NistKeyType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, NistKeyType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), NistKeyType.class);
    }
}
