...
public class ActivateOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<ActivateOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public ActivateOpResponsePayloadBenchmarkSubject() throws Exception {
        ActivateOpResponsePayload subject = ActivateOpResponsePayload.builder()
