...
public class TicketTypeBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private TicketType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new TicketType(TicketType.Standard.LOGIN);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, TicketType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, TicketType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), TicketType.class);
    }
}
