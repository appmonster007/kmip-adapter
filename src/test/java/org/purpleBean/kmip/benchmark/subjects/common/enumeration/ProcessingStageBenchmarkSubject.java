...
public class ProcessingStageBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private ProcessingStage obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new ProcessingStage(ProcessingStage.Standard.SUBMITTED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ProcessingStage.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ProcessingStage.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ProcessingStage.class);
    }
}
