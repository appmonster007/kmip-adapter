...
public class LinkTypeBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private LinkType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new LinkType(LinkType.Standard.CERTIFICATE_LINK);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, LinkType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, LinkType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), LinkType.class);
    }
}
