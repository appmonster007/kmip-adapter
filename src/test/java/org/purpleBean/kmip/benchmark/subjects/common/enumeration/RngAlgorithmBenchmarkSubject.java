...
public class RngAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private RngAlgorithm obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new RngAlgorithm(RngAlgorithm.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, RngAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, RngAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), RngAlgorithm.class);
    }
}
