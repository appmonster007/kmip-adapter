...
public class OtpAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new OtpAlgorithm(OtpAlgorithm.Standard.HOTP);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, OtpAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, OtpAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), OtpAlgorithm.class);
    }
}
