...
public class Pkcs11InputParametersBenchmarkSubject extends KmipBenchmarkSubject<Pkcs11InputParameters> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion;

    public Pkcs11InputParametersBenchmarkSubject() throws Exception {
        Pkcs11InputParameters subject = Pkcs11InputParameters.of(ByteBuffer.wrap(new byte[]{0x01, 0x02, 0x03}));
