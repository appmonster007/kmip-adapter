...
public class RevokeOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<RevokeOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public RevokeOpRequestPayloadBenchmarkSubject() throws Exception {
        RevokeOpRequestPayload subject = RevokeOpRequestPayload.builder()
