...
public class DestroyOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<DestroyOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public DestroyOpRequestPayloadBenchmarkSubject() throws Exception {
        DestroyOpRequestPayload subject = DestroyOpRequestPayload.builder()
