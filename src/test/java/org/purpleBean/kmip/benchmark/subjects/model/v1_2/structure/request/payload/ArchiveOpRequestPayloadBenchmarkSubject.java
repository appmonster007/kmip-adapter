...
public class ArchiveOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<ArchiveOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public ArchiveOpRequestPayloadBenchmarkSubject() throws Exception {
        ArchiveOpRequestPayload subject = ArchiveOpRequestPayload.builder()
