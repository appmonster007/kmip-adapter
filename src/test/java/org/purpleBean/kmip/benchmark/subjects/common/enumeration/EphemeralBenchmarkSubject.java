...
public class EphemeralBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private Ephemeral obj;
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, Ephemeral.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, Ephemeral.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), Ephemeral.class);
    }
}
