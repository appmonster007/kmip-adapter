...
public class SetConstraintsOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<SetConstraintsOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion; // TODO: Adjust if needed

    public SetConstraintsOpResponsePayloadBenchmarkSubject() throws Exception {
        SetConstraintsOpResponsePayload subject = SetConstraintsOpResponsePayload.builder().build();  // TODO: Create a default instance
