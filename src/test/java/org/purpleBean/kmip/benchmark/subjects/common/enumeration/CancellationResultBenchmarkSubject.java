...
public class CancellationResultBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    private CancellationResult obj;
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, CancellationResult.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, CancellationResult.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), CancellationResult.class);
    }
}
