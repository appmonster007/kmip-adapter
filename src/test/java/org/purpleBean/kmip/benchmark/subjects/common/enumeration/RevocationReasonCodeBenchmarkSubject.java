...
public class RevocationReasonCodeBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private RevocationReasonCode obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new RevocationReasonCode(RevocationReasonCode.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, RevocationReasonCode.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, RevocationReasonCode.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), RevocationReasonCode.class);
    }
}
