...
public class ObjectGroupMemberBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private ObjectGroupMember obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new ObjectGroupMember(ObjectGroupMember.Standard.GROUP_MEMBER_FRESH);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ObjectGroupMember.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ObjectGroupMember.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ObjectGroupMember.class);
    }
}
