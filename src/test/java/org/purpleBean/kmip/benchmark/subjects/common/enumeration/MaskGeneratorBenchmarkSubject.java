...
public class MaskGeneratorBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new MaskGenerator(MaskGenerator.Standard.MFG1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, MaskGenerator.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, MaskGenerator.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), MaskGenerator.class);
    }
}
