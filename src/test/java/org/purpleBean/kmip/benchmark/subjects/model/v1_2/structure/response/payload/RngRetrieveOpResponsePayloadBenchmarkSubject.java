...
public class RngRetrieveOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<RngRetrieveOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public RngRetrieveOpResponsePayloadBenchmarkSubject() throws Exception {
        RngRetrieveOpResponsePayload subject = RngRetrieveOpResponsePayload.builder()
