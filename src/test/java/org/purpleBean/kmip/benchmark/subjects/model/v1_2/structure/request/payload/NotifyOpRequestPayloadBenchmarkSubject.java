...
public class NotifyOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<NotifyOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public NotifyOpRequestPayloadBenchmarkSubject() throws Exception {
        NotifyOpRequestPayload subject = NotifyOpRequestPayload.builder()
