...
public class BlockCipherModeBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new BlockCipherMode(BlockCipherMode.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, BlockCipherMode.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, BlockCipherMode.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), BlockCipherMode.class);
    }
}
