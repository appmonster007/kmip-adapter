...
public class MacVerifyOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<MacVerifyOpRequestPayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion;

    public MacVerifyOpRequestPayloadBenchmarkSubject() throws Exception {
        MacVerifyOpRequestPayload subject = MacVerifyOpRequestPayload.builder().build();
