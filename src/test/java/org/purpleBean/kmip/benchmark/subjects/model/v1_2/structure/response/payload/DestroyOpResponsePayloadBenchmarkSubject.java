...
public class DestroyOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<DestroyOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public DestroyOpResponsePayloadBenchmarkSubject() throws Exception {
        DestroyOpResponsePayload subject = DestroyOpResponsePayload.builder()
