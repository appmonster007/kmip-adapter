...
public class ObliterateOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<ObliterateOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion; // TODO: Adjust if needed

    public ObliterateOpResponsePayloadBenchmarkSubject() throws Exception {
        ObliterateOpResponsePayload subject = ObliterateOpResponsePayload.builder().build();  // TODO: Create a default instance
