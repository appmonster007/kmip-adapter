...
public class DrbgAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private DrbgAlgorithm obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new DrbgAlgorithm(DrbgAlgorithm.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, DrbgAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, DrbgAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), DrbgAlgorithm.class);
    }
}
