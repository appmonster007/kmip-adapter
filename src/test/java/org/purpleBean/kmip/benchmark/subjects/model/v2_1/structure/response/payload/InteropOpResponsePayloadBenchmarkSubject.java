...
public class InteropOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<InteropOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion; // TODO: Adjust if needed

    public InteropOpResponsePayloadBenchmarkSubject() throws Exception {
        InteropOpResponsePayload subject = InteropOpResponsePayload.builder().build();  // TODO: Create a default instance
