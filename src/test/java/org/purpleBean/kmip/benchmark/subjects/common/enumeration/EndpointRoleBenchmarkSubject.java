...
public class EndpointRoleBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new EndpointRole(EndpointRole.Standard.CLIENT);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, EndpointRole.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, EndpointRole.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), EndpointRole.class);
    }
}
