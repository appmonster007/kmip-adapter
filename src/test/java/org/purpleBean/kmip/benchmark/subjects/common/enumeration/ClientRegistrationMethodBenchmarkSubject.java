...
public class ClientRegistrationMethodBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private ClientRegistrationMethod obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new ClientRegistrationMethod(ClientRegistrationMethod.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ClientRegistrationMethod.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ClientRegistrationMethod.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ClientRegistrationMethod.class);
    }
}
