...
public class RecommendedCurveBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, RecommendedCurve.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, RecommendedCurve.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), RecommendedCurve.class);
    }
}
