...
public class MacOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<MacOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion;

    public MacOpResponsePayloadBenchmarkSubject() throws Exception {
        MacOpResponsePayload subject = MacOpResponsePayload.builder().build();
