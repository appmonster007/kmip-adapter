...
public class AdjustmentTypeBenchmarkSubject implements KmipBenchmarkSubject {
    private JsonMapper json;
    private XmlMapper xml;
    private TtlvMapper ttlv;

    private AdjustmentType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new AdjustmentType(AdjustmentType.Standard.INCREMENT);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, AdjustmentType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, AdjustmentType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), AdjustmentType.class);
    }
}
