...
public class ResultStatusBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private ResultStatus obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new ResultStatus(ResultStatus.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ResultStatus.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ResultStatus.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ResultStatus.class);
    }
}
