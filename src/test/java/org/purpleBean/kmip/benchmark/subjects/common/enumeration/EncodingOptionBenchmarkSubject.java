...
public class EncodingOptionBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, EncodingOption.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, EncodingOption.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), EncodingOption.class);
    }
}
