...
public class DerivationMethodBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, DerivationMethod.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, DerivationMethod.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), DerivationMethod.class);
    }
}
