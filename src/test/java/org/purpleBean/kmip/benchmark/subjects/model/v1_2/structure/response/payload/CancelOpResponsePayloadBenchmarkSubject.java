...
public class CancelOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<CancelOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public CancelOpResponsePayloadBenchmarkSubject() throws Exception {
        CancelOpResponsePayload subject = CancelOpResponsePayload.builder()
