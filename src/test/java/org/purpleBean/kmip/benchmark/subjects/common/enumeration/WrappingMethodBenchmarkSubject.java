...
public class WrappingMethodBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, WrappingMethod.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, WrappingMethod.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), WrappingMethod.class);
    }
}
