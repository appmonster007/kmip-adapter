...
public class SplitKeyMethodBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private SplitKeyMethod obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new SplitKeyMethod(SplitKeyMethod.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, SplitKeyMethod.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, SplitKeyMethod.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), SplitKeyMethod.class);
    }
}
