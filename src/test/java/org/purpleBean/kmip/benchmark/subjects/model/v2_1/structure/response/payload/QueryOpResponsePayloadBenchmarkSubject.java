...
public class QueryOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<QueryOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion;

    public QueryOpResponsePayloadBenchmarkSubject() throws Exception {
        QueryOpResponsePayload subject = QueryOpResponsePayload.builder()
