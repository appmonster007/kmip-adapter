...
public class ShreddingAlgorithmBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    private ShreddingAlgorithm obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new ShreddingAlgorithm(ShreddingAlgorithm.Standard.UNSPECIFIED);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, ShreddingAlgorithm.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, ShreddingAlgorithm.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), ShreddingAlgorithm.class);
    }
}
