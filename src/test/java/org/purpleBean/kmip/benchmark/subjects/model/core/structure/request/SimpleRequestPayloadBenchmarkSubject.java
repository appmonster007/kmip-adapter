...
public class SimpleRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<SimpleRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.UnknownVersion;

    public SimpleRequestPayloadBenchmarkSubject() throws Exception {
        SimpleRequestPayload subject = SimpleRequestPayload.builder().build();
