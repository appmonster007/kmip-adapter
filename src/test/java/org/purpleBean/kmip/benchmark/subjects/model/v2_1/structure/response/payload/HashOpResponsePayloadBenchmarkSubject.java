...
public class HashOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<HashOpResponsePayload> {

    @Getter
    private KmipSpec spec = KmipSpec.UnknownVersion;

    public HashOpResponsePayloadBenchmarkSubject() throws Exception {
        HashOpResponsePayload subject = HashOpResponsePayload.builder().build();
