...
public class NotifyOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<NotifyOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public NotifyOpResponsePayloadBenchmarkSubject() throws Exception {
        NotifyOpResponsePayload subject = NotifyOpResponsePayload.builder()
                .build();
