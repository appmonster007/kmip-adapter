...
public class KeyFormatTypeBenchmarkSubject implements KmipBenchmarkSubject {
    private ObjectMapper json;
    private ObjectMapper xml;
    private TtlvMapper ttlv;

    private KeyFormatType obj;
    ...
    public void setup() throws Exception {
        ...
        obj = new KeyFormatType(KeyFormatType.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, KeyFormatType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, KeyFormatType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), KeyFormatType.class);
    }
}
