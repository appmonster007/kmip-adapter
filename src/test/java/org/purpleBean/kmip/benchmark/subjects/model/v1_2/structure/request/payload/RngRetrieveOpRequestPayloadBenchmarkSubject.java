...
public class RngRetrieveOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<RngRetrieveOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public RngRetrieveOpRequestPayloadBenchmarkSubject() throws Exception {
        RngRetrieveOpRequestPayload subject = RngRetrieveOpRequestPayload.builder()
