...
public class TransparentEcPrivateKeyBenchmarkSubject extends KmipBenchmarkSubject<TransparentEcPrivateKey> {
    ...
    public TransparentEcPrivateKeyBenchmarkSubject() throws Exception {
        ...
        TransparentEcPrivateKey subject = TransparentEcPrivateKey.builder()
