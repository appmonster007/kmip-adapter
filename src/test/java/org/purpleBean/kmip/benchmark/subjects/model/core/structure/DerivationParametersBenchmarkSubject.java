...
public class DerivationParametersBenchmarkSubject extends KmipBenchmarkSubject<DerivationParameters> {

    @Getter
    private final KmipSpec spec = KmipSpec.UnknownVersion;

    public DerivationParametersBenchmarkSubject() throws Exception {
        DerivationParameters subject = DerivationParameters.builder()
