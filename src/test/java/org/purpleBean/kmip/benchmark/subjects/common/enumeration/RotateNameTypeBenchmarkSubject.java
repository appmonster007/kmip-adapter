...
public class RotateNameTypeBenchmarkSubject extends KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new RotateNameType(RotateNameType.Standard.UNINTERPRETED_TEXT_STRING);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, RotateNameType.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, RotateNameType.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), RotateNameType.class);
    }
}
