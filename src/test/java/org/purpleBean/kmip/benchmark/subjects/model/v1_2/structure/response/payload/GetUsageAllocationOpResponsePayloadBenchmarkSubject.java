...
public class GetUsageAllocationOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<GetUsageAllocationOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public GetUsageAllocationOpResponsePayloadBenchmarkSubject() throws Exception {
        GetUsageAllocationOpResponsePayload subject = GetUsageAllocationOpResponsePayload.builder()
