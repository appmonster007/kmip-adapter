...
public class CheckOpResponsePayloadBenchmarkSubject extends KmipBenchmarkSubject<CheckOpResponsePayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public CheckOpResponsePayloadBenchmarkSubject() throws Exception {
        CheckOpResponsePayload subject = CheckOpResponsePayload.builder()
