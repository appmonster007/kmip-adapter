...
public class CancelOpRequestPayloadBenchmarkSubject extends KmipBenchmarkSubject<CancelOpRequestPayload> {

    @Getter
    private final KmipSpec spec = KmipSpec.V1_2;

    public CancelOpRequestPayloadBenchmarkSubject() throws Exception {
        CancelOpRequestPayload subject = CancelOpRequestPayload.builder()
