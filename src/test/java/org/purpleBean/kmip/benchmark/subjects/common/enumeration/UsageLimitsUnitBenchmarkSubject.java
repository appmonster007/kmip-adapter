...
public class UsageLimitsUnitBenchmarkSubject implements KmipBenchmarkSubject {
    ...
    public void setup() throws Exception {
        ...
        obj = new UsageLimitsUnit(UsageLimitsUnit.Standard.PLACEHOLDER_1);
    ...
    public Object jsonDeserialize() throws Exception {
        return json.readValue(jsonStr, UsageLimitsUnit.class);
    }
    ...
    public Object xmlDeserialize() throws Exception {
        return xml.readValue(xmlStr, UsageLimitsUnit.class);
    }
    ...
    public Object ttlvDeserialize() throws Exception {
        return ttlv.readValue(ttlvBuf.duplicate(), UsageLimitsUnit.class);
    }
}
