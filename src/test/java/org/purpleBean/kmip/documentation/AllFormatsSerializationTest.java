    ...
    BenchmarkSubjects
        ...
        .forEach((name, subject) -> {
          try {
            ...
            subjectResults.put("spec", subject
                .getSpec()
                .toString());
            subjectResults.put("class", subject
                .getType()
                .getName());

            subjectResults.put("json", subject.getJsonStr());
            subjectResults.put("xml", subject.getXmlStr());
            subjectResults.put("ttlv", hexFormat.formatHex(subject
                .getTtlvBuf()
                .array()));
    ...
    for (Map.Entry<String, Map<String, String>> entry : results.entrySet()) {
      ...
      if (subjectResults.containsKey("error")) {
        sb
            ...
            .append(subjectName)
            .append(" | | | | | | ")
            .append(escapeHtml(subjectResults.get("error")))
            .append(" |\n");
      } else {
        sb
            .append("| ")
        ...
        sb
            ...
            .append(" | `");
        sb
            .append(subjectResults.get("spec"))
            .append("` | `");
        sb
...
//                (subjectResults.get("json"))).append("</code></pre></details> | ");
        ...
        sb
            .append("`")
            .append(subjectResults.get("xml"))
            .append("` | ");
        sb
            .append("`")
            .append(subjectResults.get("ttlv"))
            .append("` |\n");
      }
    }
  ...
  void documentAllStructuredFormats() {
    ...
    BenchmarkSubjects
        ...
        .forEach((name, subject) -> {
          try {
            ...
            subjectResults.put("ttlv", TtlvObject
                .fromBuffer(subject.getTtlvBuf())
                .getStructuredByteString());
    ...
    for (Map.Entry<String, Map<String, String>> entry : results.entrySet()) {
      ...
      if (subjectResults.containsKey("error")) {
        ...
        sb.append("```\n");
        sb
            .append(subjectResults.get("error"))
            .append("\n");
        sb.append("```\n\n");
      } else {
        sb
        ...
        sb.append("```json\n");
        sb
            .append(subjectResults.get("json"))
            .append("\n");
        sb.append("```\n\n");
