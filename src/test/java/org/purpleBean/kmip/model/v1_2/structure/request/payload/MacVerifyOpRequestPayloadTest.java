...
class MacVerifyOpRequestPayloadTest extends AbstractKmipStructureTestSuite<MacVerifyOpRequestPayload> {
    ...
    protected void validateComponents(List<KmipDataType> values) {
        ...
        assertThat(values.get(2)).isInstanceOf(MacData.class);
    }
}
