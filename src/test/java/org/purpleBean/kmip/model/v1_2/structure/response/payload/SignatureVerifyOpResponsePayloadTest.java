...
class SignatureVerifyOpResponsePayloadTest extends AbstractKmipStructureTestSuite<SignatureVerifyOpResponsePayload> {
    ...
    protected void validateComponents(List<KmipDataType> values) {
        ...
        assertThat(values.get(1)).isInstanceOf(ValidityIndicator.class);
        assertThat(values.get(2)).isInstanceOf(DataByteString.class);
    }
}
