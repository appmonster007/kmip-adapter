...
class ItemTypeTest extends AbstractKmipEnumerationTestSuite<ItemType> {
    ...
    public void assertEnumerationRegistryBehavior() {
        ...
        // Example:
        ItemType.Value custom = ItemType.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion));
        ...
        assertThatThrownBy(() -> ItemType.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> ItemType.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
