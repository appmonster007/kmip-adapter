...
@DisplayName("RotateInterval Domain Tests")
class RotateIntervalTest extends AbstractKmipDataTypeTestSuite<RotateInterval> implements KmipAttributeTestSuite<RotateInterval> {
    ...
    @Override
    protected Class<RotateInterval> type() {
