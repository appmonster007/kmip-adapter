...
@DisplayName("Description Domain Tests")
class DescriptionTest extends AbstractKmipDataTypeTestSuite<Description> implements KmipAttributeTestSuite<Description> {
    ...
    @Override
    protected Class<Description> type() {
