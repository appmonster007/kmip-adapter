...
class StateTest extends AbstractKmipEnumerationTestSuite<State> implements KmipAttributeTestSuite<State> {
    ...
    protected void assertEnumerationRegistryBehavior() {
        ...
        State.Value custom = State.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion));
        ...
        assertThatThrownBy(() -> State.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> State.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
