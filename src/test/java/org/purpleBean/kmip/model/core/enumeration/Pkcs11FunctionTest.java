...
class Pkcs11FunctionTest extends AbstractKmipEnumerationTestSuite<Pkcs11Function> {
    ...
    protected Pkcs11Function createDefault() {
        ...
        return Pkcs11Function.register(0x80000001, "X-Default-Value", Set.of(KmipSpec.UnknownVersion)).inst();
    }
    ...
    protected Pkcs11Function createDifferentFromDefault() {
        ...
        return Pkcs11Function.register(0x80000002, "X-Variant-Value", Set.of(KmipSpec.UnknownVersion)).inst();
    }
