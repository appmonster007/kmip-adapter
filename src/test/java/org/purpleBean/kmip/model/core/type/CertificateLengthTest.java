...
class CertificateLengthTest extends AbstractKmipDataTypeTestSuite<CertificateLength> implements KmipAttributeTestSuite<CertificateLength> {
    ...
    public CertificateLength createDefault() {
        return CertificateLength.of(2048);
    }
    ...
    public AttributeValue expectedAttributeValue() {
        return AttributeValue.ofInteger(2048);
    }
