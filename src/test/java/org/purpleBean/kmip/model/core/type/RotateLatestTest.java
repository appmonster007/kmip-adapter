...
@DisplayName("RotateLatest Domain Tests")
class RotateLatestTest extends AbstractKmipDataTypeTestSuite<RotateLatest> implements KmipAttributeTestSuite<RotateLatest> {
    ...
    @Override
    protected Class<RotateLatest> type() {
