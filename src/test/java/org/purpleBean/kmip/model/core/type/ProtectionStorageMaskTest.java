...
@DisplayName("ProtectionStorageMask Domain Tests")
class ProtectionStorageMaskTest extends AbstractKmipDataTypeTestSuite<ProtectionStorageMask> implements KmipAttributeTestSuite<ProtectionStorageMask> {
    ...
    @Override
    protected Class<ProtectionStorageMask> type() {
