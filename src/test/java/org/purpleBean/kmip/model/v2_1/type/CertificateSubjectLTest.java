...
@DisplayName("CertificateSubjectL Domain Tests")
class CertificateSubjectLTest extends AbstractKmipDataTypeTestSuite<CertificateSubjectL> implements KmipAttributeTestSuite<CertificateSubjectL> {
    ...
    @Override
    protected Class<CertificateSubjectL> type() {
        return CertificateSubjectL.class;
    }

    @Override
    public CertificateSubjectL createDefault() {
        return CertificateSubjectL.of(FIXED_VALUE);
    }
