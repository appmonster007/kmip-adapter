...
@DisplayName("CertificateIssuerO Domain Tests")
class CertificateIssuerOTest extends AbstractKmipDataTypeTestSuite<CertificateIssuerO> implements KmipAttributeTestSuite<CertificateIssuerO> {
    ...
    @Override
    protected Class<CertificateIssuerO> type() {
        return CertificateIssuerO.class;
    }

    @Override
    public CertificateIssuerO createDefault() {
        return CertificateIssuerO.of(FIXED_VALUE);
    }
