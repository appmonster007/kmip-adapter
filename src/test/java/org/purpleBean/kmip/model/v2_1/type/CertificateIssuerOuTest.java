...
@DisplayName("CertificateIssuerOu Domain Tests")
class CertificateIssuerOuTest extends AbstractKmipDataTypeTestSuite<CertificateIssuerOu> implements KmipAttributeTestSuite<CertificateIssuerOu> {
    ...
    @Override
    protected Class<CertificateIssuerOu> type() {
        return CertificateIssuerOu.class;
    }

    @Override
    public CertificateIssuerOu createDefault() {
        return CertificateIssuerOu.of(FIXED_VALUE);
    }
