...
@DisplayName("CertificateSubjectEmail Domain Tests")
class CertificateSubjectEmailTest extends AbstractKmipDataTypeTestSuite<CertificateSubjectEmail> implements KmipAttributeTestSuite<CertificateSubjectEmail> {
    ...
    @Override
    protected Class<CertificateSubjectEmail> type() {
        return CertificateSubjectEmail.class;
    }

    @Override
    public CertificateSubjectEmail createDefault() {
        return CertificateSubjectEmail.of(FIXED_VALUE);
    }
