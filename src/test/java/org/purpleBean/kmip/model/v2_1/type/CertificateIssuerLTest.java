...
@DisplayName("CertificateIssuerL Domain Tests")
class CertificateIssuerLTest extends AbstractKmipDataTypeTestSuite<CertificateIssuerL> implements KmipAttributeTestSuite<CertificateIssuerL> {
    ...
    @Override
    protected Class<CertificateIssuerL> type() {
        return CertificateIssuerL.class;
    }

    @Override
    public CertificateIssuerL createDefault() {
        return CertificateIssuerL.of(FIXED_VALUE);
    }
