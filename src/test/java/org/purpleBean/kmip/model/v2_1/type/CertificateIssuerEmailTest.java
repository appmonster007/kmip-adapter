...
@DisplayName("CertificateIssuerEmail Domain Tests")
class CertificateIssuerEmailTest extends AbstractKmipDataTypeTestSuite<CertificateIssuerEmail> implements KmipAttributeTestSuite<CertificateIssuerEmail> {
    ...
    @Override
    protected Class<CertificateIssuerEmail> type() {
        return CertificateIssuerEmail.class;
    }

    @Override
    public CertificateIssuerEmail createDefault() {
        return CertificateIssuerEmail.of(FIXED_VALUE);
    }
