...
@DisplayName("Sensitive Domain Tests")
class SensitiveTest extends AbstractKmipDataTypeTestSuite<Sensitive> implements KmipAttributeTestSuite<Sensitive> {
    ...
    @Override
    protected Class<Sensitive> type() {
