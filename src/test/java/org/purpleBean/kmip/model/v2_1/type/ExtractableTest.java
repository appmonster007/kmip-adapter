...
@DisplayName("Extractable Domain Tests")
class ExtractableTest extends AbstractKmipDataTypeTestSuite<Extractable> implements KmipAttributeTestSuite<Extractable> {
    ...
    @Override
    protected Class<Extractable> type() {
