...
class UniqueIdentifierTest extends AbstractKmipEnumerationTestSuite<UniqueIdentifier> {
    ...
    protected UniqueIdentifier createDefault() {
        // TODO: Replace with an actual Standard enum value, e.g., UniqueIdentifier.Standard.SOME_VALUE.inst();
        ...
        return UniqueIdentifier.register(0x80000001, "X-Default-Value", Set.of(KmipSpec.UnknownVersion)).inst();
    }
    ...
    protected UniqueIdentifier createDifferentFromDefault() {
        ...
        return UniqueIdentifier.register(0x80000002, "X-Variant-Value", Set.of(KmipSpec.UnknownVersion)).inst();
    }
