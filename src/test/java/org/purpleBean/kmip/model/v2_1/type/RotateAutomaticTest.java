...
@DisplayName("RotateAutomatic Domain Tests")
class RotateAutomaticTest extends AbstractKmipDataTypeTestSuite<RotateAutomatic> implements KmipAttributeTestSuite<RotateAutomatic> {
    ...
    @Override
    protected Class<RotateAutomatic> type() {
