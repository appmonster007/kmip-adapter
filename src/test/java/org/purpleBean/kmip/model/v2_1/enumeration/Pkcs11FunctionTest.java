...
class Pkcs11FunctionTest extends AbstractKmipEnumerationTestSuite<Pkcs11Function> {
    ...
    protected Pkcs11Function createDefault() {
        // TODO: Replace with an actual Standard enum value, e.g., Pkcs11Function.Standard.SOME_VALUE.inst();
        ...
        return Pkcs11Function.register(0x80000001, "X-Default-Value", Set.of(KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0)).inst();
    }
    ...
    protected Pkcs11Function createDifferentFromDefault() {
        ...
        return Pkcs11Function.register(0x80000002, "X-Variant-Value", Set.of(KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0)).inst();
    }
    ...
    protected void assertEnumerationRegistryBehavior() {
        ...
        // Example:
        Pkcs11Function.Value custom = Pkcs11Function.register(0x80000010, "X-Enum-Custom", Set.of(KmipSpec.UnknownVersion));
        ...
        assertThatThrownBy(() -> Pkcs11Function.register(0x7FFFFFFF, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> Pkcs11Function.register(0x00000001, "Bad-Range", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
        assertThatThrownBy(() -> Pkcs11Function.register(0x80000011, "   ", Set.of(KmipSpec.UnknownVersion)))
                .isInstanceOf(IllegalArgumentException.class);
