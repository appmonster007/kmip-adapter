...
@DisplayName("CertificateIssuerSt Domain Tests")
class CertificateIssuerStTest extends AbstractKmipDataTypeTestSuite<CertificateIssuerSt> implements KmipAttributeTestSuite<CertificateIssuerSt> {
    ...
    @Override
    protected Class<CertificateIssuerSt> type() {
        return CertificateIssuerSt.class;
    }

    @Override
    public CertificateIssuerSt createDefault() {
        return CertificateIssuerSt.of(FIXED_VALUE);
    }
