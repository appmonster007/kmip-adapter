...
class NistSecurityCategoryTest extends AbstractKmipDataTypeTestSuite<NistSecurityCategory> implements KmipAttributeTestSuite<NistSecurityCategory> {
    ...
    public void attribute_serverModifiable_respectsState() {
        ...
        for (State.Standard s : State.Standard.values()) {
            assertThat(attr.isServerModifiable(s.inst())).as("isServerModifiable(%s)", s).isFalse();
        }
    }
    ...
    public void attribute_clientModifiable_respectsState() {
        NistSecurityCategory attr = createDefault();
        for (State.Standard s : State.Standard.values()) {
            assertThat(attr.isClientModifiable(s.inst())).as("isClientModifiable(%s)", s).isFalse();
        }
    }
