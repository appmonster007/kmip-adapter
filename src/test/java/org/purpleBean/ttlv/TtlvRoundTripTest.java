        ...
        withKmipSpec(
                ...
                () -> {
                    ...
                    assertThat(buffer.remaining())
                            .isGreaterThan(8); // At least tag (3) + type (1) + length (4)
                    ...
                    int length =
                            (ttlvBytes[4] << 24)
                                    ...
                                    | (ttlvBytes[7] & 0xFF);
                    assertThat(length)
                            .isEqualTo(32); // 16 bytes per integer field (8 bytes data + 8 bytes padding)
        ...
        withKmipSpec(
                ...
                () -> {
                    ...
                    ActivationDateAttribute original =
                            ActivationDateAttribute.builder().dateTime(now).build();
