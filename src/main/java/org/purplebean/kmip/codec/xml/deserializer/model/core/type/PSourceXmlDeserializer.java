...
/**
 * XML deserializer for {@link PSource}.
 */
public class PSourceXmlDeserializer
    extends AbstractKmipDataTypeXmlDeserializer<PSource, PSource.PSourceBuilder> {

  /**
   * Constructs a new {@link PSourceXmlDeserializer}.
   */
  public PSourceXmlDeserializer() {
