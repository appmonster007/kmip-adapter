...
/**
 * XML deserializer for {@link Modulus}.
 */
public class ModulusXmlDeserializer
    extends AbstractKmipDataTypeXmlDeserializer<Modulus, Modulus.ModulusBuilder> {

  /**
   * Constructs a new {@link ModulusXmlDeserializer}.
   */
