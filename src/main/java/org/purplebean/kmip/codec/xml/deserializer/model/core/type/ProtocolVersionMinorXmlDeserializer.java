...
/**
 * XML deserializer for {@link ProtocolVersionMinor}.
 */
public class ProtocolVersionMinorXmlDeserializer extends
    AbstractKmipDataTypeXmlDeserializer<ProtocolVersionMinor,
        ProtocolVersionMinor.ProtocolVersionMinorBuilder> {

  /**
   * Constructs a new {@link ProtocolVersionMinorXmlDeserializer}.
   */
