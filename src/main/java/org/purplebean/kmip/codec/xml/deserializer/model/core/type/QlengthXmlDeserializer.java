...
/**
 * XML deserializer for {@link Qlength}.
 */
public class QlengthXmlDeserializer
    extends AbstractKmipDataTypeXmlDeserializer<Qlength, Qlength.QlengthBuilder> {

  /**
   * Constructs a new {@link QlengthXmlDeserializer}.
   */
