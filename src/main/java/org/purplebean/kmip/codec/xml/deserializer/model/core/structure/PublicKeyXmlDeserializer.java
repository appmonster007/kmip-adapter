...
/**
 * XML deserializer for {@link PublicKey}.
 */
public class PublicKeyXmlDeserializer
    extends AbstractKmipDataTypeXmlDeserializer<PublicKey, PublicKey.PublicKeyBuilder> {

  /**
   * Constructs a new {@link PublicKeyXmlDeserializer}.
   */
