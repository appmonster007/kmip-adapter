...
/**
 * XML deserializer for {@link Operation}.
 */
public class OperationXmlDeserializer
    extends AbstractKmipDataTypeXmlDeserializer<Operation, Operation.OperationBuilder> {

  /**
   * Constructs a new {@link OperationXmlDeserializer}.
   */
