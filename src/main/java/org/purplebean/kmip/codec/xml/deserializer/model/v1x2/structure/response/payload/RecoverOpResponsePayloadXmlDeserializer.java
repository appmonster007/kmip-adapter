...
/**
 * XML deserializer for {@link RecoverOpResponsePayload}.
 */
public class RecoverOpResponsePayloadXmlDeserializer extends
    AbstractKmipDataTypeXmlDeserializer<RecoverOpResponsePayload,
        RecoverOpResponsePayload.RecoverOpResponsePayloadBuilder> {

  /**
   * Constructs a new {@link RecoverOpResponsePayloadXmlDeserializer}.
   */
