...
/**
 * JSON deserializer for {@link RandomIv}.
 */
public class RandomIvJsonDeserializer
    extends AbstractKmipDataTypeJsonDeserializer<RandomIv, RandomIv.RandomIvBuilder> {

  /**
   * Constructs a new {@link RandomIvJsonDeserializer}.
   */
