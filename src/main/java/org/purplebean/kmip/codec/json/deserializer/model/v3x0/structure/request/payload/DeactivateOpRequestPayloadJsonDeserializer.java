...
/**
 * JSON deserializer for {@link DeactivateOpRequestPayload}.
 */
public class DeactivateOpRequestPayloadJsonDeserializer extends
    AbstractKmipDataTypeJsonDeserializer<DeactivateOpRequestPayload,
        DeactivateOpRequestPayload.DeactivateOpRequestPayloadBuilder> {

  /**
   * Constructs a new {@link DeactivateOpRequestPayloadJsonDeserializer}.
   */
  ...
  protected void setValue(DeactivateOpRequestPayload.DeactivateOpRequestPayloadBuilder builder,
    ...
    switch (nodeTag) {
      ...
      case KmipTag.Standard.DEACTIVATION_REASON ->
          builder.deactivationReason(ctxt.readValue(p, DeactivationReason.class));
      case KmipTag.Standard.DEACTIVATION_DATE ->
          builder.deactivationDate(ctxt.readValue(p, DeactivationDate.class));
