...
/**
 * JSON deserializer for {@link Y}.
 */
public class YJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Y, Y.YBuilder> {

  /**
   * Constructs a new {@link YJsonDeserializer}.
   */
