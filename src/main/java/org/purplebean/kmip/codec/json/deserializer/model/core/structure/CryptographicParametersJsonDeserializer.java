...
/**
 * JSON deserializer for {@link CryptographicParameters}.
 */
public class CryptographicParametersJsonDeserializer extends
  ...
  /**
   * Constructs a new {@link CryptographicParametersJsonDeserializer}.
   */
  ...
  protected void setValue(CryptographicParameters.CryptographicParametersBuilder builder,
    ...
    switch (nodeTag) {
      ...
      case KmipTag.Standard.MASK_GENERATOR ->
          builder.maskGenerator(ctxt.readValue(p, MaskGenerator.class));
      case KmipTag.Standard.MASK_GENERATOR_HASHING_ALGORITHM -> builder
          .maskGeneratorHashingAlgorithm(ctxt.readValue(p, MaskGeneratorHashingAlgorithm.class));
      case KmipTag.Standard.SALT_LENGTH -> builder.saltLength(ctxt.readValue(p, SaltLength.class));
      case KmipTag.Standard.P_SOURCE -> builder.pSource(ctxt.readValue(p, PSource.class));
