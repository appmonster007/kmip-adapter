...
/**
 * JSON deserializer for {@link ResponsePayloadStructure}.
 */
public class ResponsePayloadStructureJsonDeserializer
    extends KmipDataTypeJsonDeserializer<ResponsePayloadStructure> {
