...
public class SetEndpointRoleOpResponsePayload implements ResponsePayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          SetEndpointRoleOpResponsePayload.class);
      ResponsePayloadStructure.register(spec, operation, SetEndpointRoleOpResponsePayload.class,
          SetEndpointRoleOpResponsePayload::of);
    }
  }
  ...
  /**
   * Returns the {@link SetEndpointRoleOpResponsePayload} instance wrapping the given value.
   */
