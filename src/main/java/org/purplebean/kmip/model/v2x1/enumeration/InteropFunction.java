...
public class InteropFunction implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), InteropFunction::fromName,
          InteropFunction::fromValue);
    }
  }
  ...
  @Builder
  private InteropFunction(@NonNull Value value) {
    this.value = value;
    validate();
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for InteropFunction is not supported for KMIP spec %s",
   ...
   */
  public interface Value extends KmipEnumeration.Value<InteropFunction> {
  }
