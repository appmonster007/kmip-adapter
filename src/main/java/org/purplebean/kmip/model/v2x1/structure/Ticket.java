 ...
 *
 * <p>Contains a TicketType and a TicketValue opaque byte token, used in Login and DelegatedLogin
 * operations.
 */
@Data
...
public class Ticket implements KmipStructure {
  ...
  public static Ticket of(List<KmipDataType> values) {
    ...
    return Ticket
        .builder()
        .ticketType((TicketType) map
            .get(TicketType.kmipTag)
            .get(0))
        .ticketValue((TicketValue) map
            .get(TicketValue.kmipTag)
            .get(0))
        .build();
  }
