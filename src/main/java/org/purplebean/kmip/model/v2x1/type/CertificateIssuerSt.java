...
public class CertificateIssuerSt implements KmipDataType, KmipAttribute {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerSt.class,
          CertificateIssuerSt::of);
    }
  }
  ...
  /**
   * Returns the {@link CertificateIssuerSt} instance wrapping the given value.
   */
