...
public class ProtectionStorageMask implements KmipMaskType, KmipAttribute {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, ProtectionStorageMask.class,
          ProtectionStorageMask::of);
    ...
    static Value fromName(String name) {
      ...
      return Optional
          ...
          .orElseThrow(() -> new NoSuchElementException(
              String.format("No ProtectionStorageMask value found for '%s' in KMIP spec %s", name,
                  spec)
          ));
    }
