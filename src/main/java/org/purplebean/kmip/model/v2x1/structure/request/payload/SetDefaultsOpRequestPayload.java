...
public class SetDefaultsOpRequestPayload implements RequestPayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          SetDefaultsOpRequestPayload.class);
      RequestPayloadStructure.register(spec, operation, SetDefaultsOpRequestPayload.class,
          SetDefaultsOpRequestPayload::of);
    }
  }
  ...
  public KmipDataType[] getValue() {
    return defaultsInformation == null ? new KmipDataType[0] :
        new KmipDataType[] {defaultsInformation};
  }
