...
public class ObtainLeaseOpResponsePayload implements ResponsePayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          ObtainLeaseOpResponsePayload.class);
      ResponsePayloadStructure.register(spec, operation, ObtainLeaseOpResponsePayload.class,
          ObtainLeaseOpResponsePayload::of);
    }
  }
  ...
  public static ObtainLeaseOpResponsePayload of(List<KmipDataType> values) {
    ...
    if (map.containsKey(LastChangeDate.kmipTag)) {
      builder.lastChangeDate((LastChangeDate) map
          .get(LastChangeDate.kmipTag)
          .getFirst());
    }
