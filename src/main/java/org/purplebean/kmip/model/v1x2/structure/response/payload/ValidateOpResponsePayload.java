  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          ValidateOpResponsePayload.class);
      ResponsePayloadStructure.register(spec, operation, ValidateOpResponsePayload.class,
          ValidateOpResponsePayload::of);
    }
  }
