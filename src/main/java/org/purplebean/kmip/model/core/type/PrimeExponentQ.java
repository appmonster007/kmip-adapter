...
public class PrimeExponentQ implements KmipDataType {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.PRIME_EXPONENT_Q.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, PrimeExponentQ.class);
    }
  }
  ...
  @Builder
  private PrimeExponentQ(@NonNull BigInteger value) {
    this.value = value;
    validate();
  }

  /**
   * Returns the {@link PrimeExponentQ} instance wrapping the given value.
   */
