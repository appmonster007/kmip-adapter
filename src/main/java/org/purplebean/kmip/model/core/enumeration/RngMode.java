 ...
 *   <li>{@code SHARED_INSTANTIATION}: The RNG is instantiated once and shared among multiple
 *   users.</li>
...
public class RngMode implements KmipEnumeration {
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for RngMode is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    SHARED_INSTANTIATION(0x00000002, "SharedInstantiation", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
    NON_SHARED_INSTANTIATION(0x00000003, "NonSharedInstantiation", KmipSpec.UnknownVersion,
