 ...
 *   <li>{@code POLYNOMIAL_SHARING_GF_216}: The key is split using Shamir's Secret Sharing over
 *   the Galois Field GF(2^16).</li>
 *   <li>{@code POLYNOMIAL_SHARING_PRIME_FIELD}: The key is split using Shamir's Secret Sharing
 *   over a prime field.</li>
 *   <li>{@code POLYNOMIAL_SHARING_GF_28}: The key is split using Shamir's Secret Sharing over
 *   the Galois Field GF(2^8).</li>
 * </ul>
 *
 * @see KmipEnumeration
...
public class SplitKeyMethod implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), SplitKeyMethod::fromName,
          SplitKeyMethod::fromValue);
    }
  }
  ...
  /**
   * Returns the {@link SplitKeyMethod} instance wrapping the given value.
   */
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for SplitKeyMethod is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    POLYNOMIAL_SHARING_GF_216(0x00000002, "PolynomialSharingGF2_16", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    POLYNOMIAL_SHARING_PRIME_FIELD(0x00000003, "PolynomialSharingPrimeField",
        KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    POLYNOMIAL_SHARING_GF_28(0x00000004, "PolynomialSharingGF2_8", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0);
