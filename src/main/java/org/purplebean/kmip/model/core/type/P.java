...
public class P implements KmipDataType {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, P.class);
    }
  }
  ...
  @Builder
  private P(@NonNull BigInteger value) {
    this.value = value;
    validate();
  }

  /**
   * Returns the {@link P} instance wrapping the given value.
   */
