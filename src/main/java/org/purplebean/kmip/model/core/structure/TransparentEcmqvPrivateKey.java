...
/**
 * KMIP TransparentEcmqvPrivateKey attribute structure.
 */
@Data
...
public class TransparentEcmqvPrivateKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_ECMQV_PRIVATE_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentEcmqvPrivateKey.class,
          TransparentEcmqvPrivateKey::of);
    }
  }
  ...
  @Builder
  private TransparentEcmqvPrivateKey(@NonNull RecommendedCurve recommendedCurve, @NonNull D d) {
  ...
  /**
   * Returns the {@link TransparentEcmqvPrivateKey} instance wrapping the given value.
   */
   ...
   * Returns the {@link TransparentEcmqvPrivateKey} instance wrapping the given value.
   */
  public static TransparentEcmqvPrivateKey of(@NonNull RecommendedCurve recommendedCurve,
                                              @NonNull D d) {
