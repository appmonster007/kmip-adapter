 ...
 *   <li>{@code DERIVATION_BASE_OBJECT_LINK}: A link to the base object used in a key derivation
 *   .</li>
...
public class LinkType implements KmipEnumeration {
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for LinkType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    CERTIFICATE_LINK(0x00000101, "CertificateLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    PUBLIC_KEY_LINK(0x00000102, "PublicKeyLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    PRIVATE_KEY_LINK(0x00000103, "PrivateKeyLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    DERIVATION_BASE_OBJECT_LINK(0x00000104, "DerivationBaseObjectLink", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1),
    DERIVED_KEY_LINK(0x00000105, "DerivedKeyLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    REPLACEMENT_OBJECT_LINK(0x00000106, "ReplacementObjectLink", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1),
    REPLACED_OBJECT_LINK(0x00000107, "ReplacedObjectLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    ...
    PREVIOUS_LINK(0x0000010A, "PreviousLink", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1),
    NEXT_LINK(0x0000010B, "NextLink", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1),
    PKCS_12_CERTIFICATE_LINK(0x0000010C, "PKCS_12CertificateLink", KmipSpec.UnknownVersion,
        KmipSpec.V2_1),
    PKCS_12_PASSWORD_LINK(0x0000010D, "PKCS_12PasswordLink", KmipSpec.UnknownVersion,
        KmipSpec.V2_1),
