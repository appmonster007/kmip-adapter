...
public class DrbgAlgorithm implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.DRBG_ALGORITHM.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, DrbgAlgorithm.class);
      KmipEnumeration.register(spec, kmipTag.getValue(), DrbgAlgorithm::fromName,
          DrbgAlgorithm::fromValue);
    }
  }
  ...
  /**
   * Returns the {@link DrbgAlgorithm} instance wrapping the given value.
   */
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No DrbgAlgorithm value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No DrbgAlgorithm value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for DrbgAlgorithm is not supported for KMIP spec %s",
   ...
   */
  public interface Value extends KmipEnumeration.Value<DrbgAlgorithm> {
  }
