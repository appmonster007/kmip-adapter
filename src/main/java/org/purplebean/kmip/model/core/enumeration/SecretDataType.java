 ...
 *
 * @see KmipEnumeration
 * @see org.purplebean.kmip.model.core.objects.SecretData
 */
@Data
...
public class SecretDataType implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), SecretDataType::fromName,
          SecretDataType::fromValue);
    }
  }
  ...
  @Builder
  private SecretDataType(@NonNull Value value) {
    this.value = value;
    validate();
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for SecretDataType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    PASSWORD(0x00000001, "Password", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
   ...
   */
  public interface Value extends KmipEnumeration.Value<SecretDataType> {
  }
