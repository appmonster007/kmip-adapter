...
public class DestroyDate implements KmipDataType, KmipAttribute {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.DESTROY_DATE.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, DestroyDate.class,
          DestroyDate::of);
    }
  }
  ...
  @Builder
  private DestroyDate(@NonNull OffsetDateTime value) {
    this.value = value;
    validate();
  }
