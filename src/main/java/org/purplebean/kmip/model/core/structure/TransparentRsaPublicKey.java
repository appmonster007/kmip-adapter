...
public class TransparentRsaPublicKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_RSA_PUBLIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentRsaPublicKey.class,
          TransparentRsaPublicKey::of);
    }
  }
  ...
  @Builder
  private TransparentRsaPublicKey(@NonNull Modulus modulus,
