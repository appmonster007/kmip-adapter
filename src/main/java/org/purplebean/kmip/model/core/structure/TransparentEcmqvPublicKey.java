...
/**
 * KMIP TransparentEcmqvPublicKey attribute structure.
 */
@Data
...
public class TransparentEcmqvPublicKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_ECMQV_PUBLIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentEcmqvPublicKey.class,
          TransparentEcmqvPublicKey::of);
    }
  }
  ...
  @Builder
  private TransparentEcmqvPublicKey(@NonNull RecommendedCurve recommendedCurve,
  ...
  /**
   * Returns the {@link TransparentEcmqvPublicKey} instance wrapping the given value.
   */
   ...
   * Returns the {@link TransparentEcmqvPublicKey} instance wrapping the given value.
   */
  public static TransparentEcmqvPublicKey of(@NonNull RecommendedCurve recommendedCurve,
                                             @NonNull QString qString) {
