...
/**
 * KMIP NonceId dataType.
 */
@Data
@Builder(toBuilder = true)
public class NonceId implements KmipDataType {

  public static final KmipTag kmipTag = KmipTag.Standard.NONCE_ID.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, NonceId.class);
    }
  }
  ...
  /**
   * Returns the {@link NonceId} instance wrapping the given value.
   */
