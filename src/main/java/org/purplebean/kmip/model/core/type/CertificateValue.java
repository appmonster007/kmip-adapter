...
public class CertificateValue implements KmipDataType {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.CERTIFICATE_VALUE.inst();
  ...
  @Builder
  private CertificateValue(@NonNull ByteBuffer value) {
    this.value = value;
    validate();
  }

  /**
   * Returns the {@link CertificateValue} instance wrapping the given value.
   */
