...
public class DeviceSerialNumber implements KmipDataType {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.DEVICE_SERIAL_NUMBER.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, DeviceSerialNumber.class);
    }
  }
  ...
  @Builder
  private DeviceSerialNumber(@NonNull String value) {
    this.value = value;
    validate();
  }
