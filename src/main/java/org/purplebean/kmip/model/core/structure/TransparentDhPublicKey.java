...
/**
 * KMIP TransparentDhPublicKey attribute structure.
 */
@Data
...
public class TransparentDhPublicKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_DH_PUBLIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentDhPublicKey.class,
          TransparentDhPublicKey::of);
    }
  }
  ...
  /**
   * Returns the {@link TransparentDhPublicKey} instance wrapping the given value.
   */
