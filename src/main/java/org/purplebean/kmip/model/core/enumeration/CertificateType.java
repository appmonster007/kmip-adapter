...
public class CertificateType implements KmipEnumeration, KmipAttribute {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateType.class,
          CertificateType::of);
      KmipEnumeration.register(spec, kmipTag.getValue(), CertificateType::fromName,
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No CertificateType value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No CertificateType value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for CertificateType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    X_509(0x00000001, "X_509", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    ...
    @Override
    public CertificateType inst() {
      return CertificateType.of(this);
    }
  }
   ...
   */
  public interface Value extends KmipEnumeration.Value<CertificateType> {
  }
