...
public class ShreddingAlgorithm implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), ShreddingAlgorithm::fromName,
          ShreddingAlgorithm::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for ShreddingAlgorithm is not supported for KMIP spec %s",
