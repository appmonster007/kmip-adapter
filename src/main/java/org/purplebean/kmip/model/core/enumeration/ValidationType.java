 ...
 *   <li>{@code HYBRID}: The validation applies to a hybrid module (a combination of hardware,
 *   software, and/or firmware).</li>
 * </ul>
 *
 * @see KmipEnumeration
...
public class ValidationType implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.VALIDATION_TYPE.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), ValidationType::fromName,
          ValidationType::fromValue);
    }
  }
  ...
  @Builder
  private ValidationType(@NonNull Value value) {
    this.value = value;
    validate();
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No ValidationType value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No ValidationType value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for ValidationType is not supported for KMIP spec %s",
