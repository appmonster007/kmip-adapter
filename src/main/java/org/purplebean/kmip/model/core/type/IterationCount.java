...
public class IterationCount implements KmipDataType {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.ITERATION_COUNT.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, IterationCount.class);
    }
  }
