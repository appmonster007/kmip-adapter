...
public class KeyValueLocationType implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), KeyValueLocationType::fromName,
          KeyValueLocationType::fromValue);
    }
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No KeyValueLocationType value found for '%s' in KMIP spec %s", name,
                spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for KeyValueLocationType is not supported for KMIP spec %s",
