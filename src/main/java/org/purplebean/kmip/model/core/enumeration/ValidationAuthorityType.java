 ...
 *   <li>{@code COMMON_CRITERIA}: The Common Criteria for Information Technology Security
 *   Evaluation.</li>
 * </ul>
 *
 * @see KmipEnumeration
 * @see org.purplebean.kmip.model.core.structure.ValidationInformation
 */
@Data
@Builder(toBuilder = true)
public class ValidationAuthorityType implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.VALIDATION_AUTHORITY_TYPE.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), ValidationAuthorityType::fromName,
          ValidationAuthorityType::fromValue);
    }
  }
  ...
  @Builder
  private ValidationAuthorityType(@NonNull Value value) {
    this.value = value;
    validate();
  }

  /**
   * Returns the {@link ValidationAuthorityType} instance wrapping the given value.
   */
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No ValidationAuthorityType value found for '%s' in KMIP spec %s", name,
                spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No ValidationAuthorityType value found for %d in KMIP spec %s", value,
                spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for ValidationAuthorityType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    @Override
    public ValidationAuthorityType inst() {
      return ValidationAuthorityType.of(this);
    }
  }
