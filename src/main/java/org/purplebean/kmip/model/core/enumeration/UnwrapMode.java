...
public class UnwrapMode implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.UNWRAP_MODE.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, UnwrapMode.class);
      KmipEnumeration.register(spec, kmipTag.getValue(), UnwrapMode::fromName,
          UnwrapMode::fromValue);
    }
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No UnwrapMode value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No UnwrapMode value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for UnwrapMode is not supported for KMIP spec %s",
   ...
   */
  public interface Value extends KmipEnumeration.Value<UnwrapMode> {
  }
