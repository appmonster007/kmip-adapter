...
/**
 * KMIP TransparentEcdhPublicKey attribute structure.
 */
@Data
...
public class TransparentEcdhPublicKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_ECDH_PUBLIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentEcdhPublicKey.class,
          TransparentEcdhPublicKey::of);
    }
  }
  ...
  @Builder
  private TransparentEcdhPublicKey(@NonNull RecommendedCurve recommendedCurve,
  ...
  /**
   * Returns the {@link TransparentEcdhPublicKey} instance wrapping the given value.
   */
   ...
   * Returns the {@link TransparentEcdhPublicKey} instance wrapping the given value.
   */
  public static TransparentEcdhPublicKey of(@NonNull RecommendedCurve recommendedCurve,
                                            @NonNull QString qString) {
