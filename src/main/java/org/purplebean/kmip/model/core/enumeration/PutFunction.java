...
public class PutFunction implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), PutFunction::fromName,
          PutFunction::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for PutFunction is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    REPLACE(0x00000002, "Replace", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0);
