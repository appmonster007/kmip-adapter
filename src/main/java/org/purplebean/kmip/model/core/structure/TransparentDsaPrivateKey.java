...
/**
 * KMIP TransparentDsaPrivateKey attribute structure.
 */
@Data
...
public class TransparentDsaPrivateKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_DSA_PRIVATE_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentDsaPrivateKey.class,
          TransparentDsaPrivateKey::of);
    }
  }
  ...
  @Builder
  private TransparentDsaPrivateKey(@NonNull P p, @NonNull Q q, @NonNull G g, @NonNull X x) {
    this.p = p;
    this.q = q;
    this.g = g;
    this.x = x;
  ...
  /**
   * Returns the {@link TransparentDsaPrivateKey} instance wrapping the given value.
   */
   ...
   * Returns the {@link TransparentDsaPrivateKey} instance wrapping the given value.
   */
  public static TransparentDsaPrivateKey of(@NonNull P p, @NonNull Q q, @NonNull G g,
                                            @NonNull X x) {
