...
public class NameType implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.NAME_TYPE.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), NameType::fromName, NameType::fromValue);
    }
  }
  ...
  @Builder
  private NameType(@NonNull Value value) {
    this.value = value;
    validate();
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for NameType is not supported for KMIP spec %s",
  ...
  /**
   * The standard enumeration of Name Types.
   */
  @Getter
  @AllArgsConstructor
  @ToString
  public enum Standard implements Value {
    ...
    @Override
    public NameType inst() {
      return NameType.of(this);
    }
  }

  /**
   * An interface representing a Name Type value, which can be either a standard
   * value or a custom extension.
   */
  public interface Value extends KmipEnumeration.Value<NameType> {
  }

  /**
   * Represents a custom, vendor-specific Name Type.
   */
  @Getter
  @AllArgsConstructor
  @ToString
