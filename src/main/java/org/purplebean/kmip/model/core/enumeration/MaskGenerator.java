...
public class MaskGenerator implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.MASK_GENERATOR.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, MaskGenerator.class);
      KmipEnumeration.register(spec, kmipTag.getValue(), MaskGenerator::fromName,
          MaskGenerator::fromValue);
    }
  }
  ...
  /**
   * Returns the {@link MaskGenerator} instance wrapping the given value.
   */
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No MaskGenerator value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No MaskGenerator value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for MaskGenerator is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    MFG1(0x00000001, "MGF1", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0);
    ...
    @Override
    public MaskGenerator inst() {
      return MaskGenerator.of(this);
    }
  }
   ...
   */
  public interface Value extends KmipEnumeration.Value<MaskGenerator> {
  }
