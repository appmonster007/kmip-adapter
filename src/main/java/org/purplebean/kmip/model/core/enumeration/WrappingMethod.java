 ...
 *   <li>{@code MAC_SIGN}: The key is authenticated with a Message Authentication Code (MAC) or a
 *   digital signature.</li>
 *   <li>{@code ENCRYPT_THEN_MAC_SIGN}: The key is first encrypted and then a MAC or signature is
 *   computed over the ciphertext.</li>
 *   <li>{@code MAC_SIGN_THEN_ENCRYPT}: A MAC or signature is computed over the plaintext key,
 *   and then both the key and the MAC/signature are encrypted together.</li>
...
public class WrappingMethod implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), WrappingMethod::fromName,
          WrappingMethod::fromValue);
    }
  }
  ...
  /**
   * Returns the {@link WrappingMethod} instance wrapping the given value.
   */
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for WrappingMethod is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ENCRYPT(0x00000001, "Encrypt", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC_SIGN(0x00000002, "MacSign", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    ENCRYPT_THEN_MAC_SIGN(0x00000003, "EncryptThenMacSign", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
    MAC_SIGN_THEN_ENCRYPT(0x00000004, "MacSignThenEncrypt", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
