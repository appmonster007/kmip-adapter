...
public class TransparentDsaPublicKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_DSA_PUBLIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentDsaPublicKey.class,
          TransparentDsaPublicKey::of);
    }
  }
