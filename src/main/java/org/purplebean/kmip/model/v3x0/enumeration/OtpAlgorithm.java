...
public class OtpAlgorithm implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), OtpAlgorithm::fromName,
          OtpAlgorithm::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for OtpAlgorithm is not supported for KMIP spec %s",
