...
/**
 * KMIP CreateGroup Response Payload (V3_0).
 *
...
public class CreateGroupOpResponsePayload implements ResponsePayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          CreateGroupOpResponsePayload.class);
      ResponsePayloadStructure.register(spec, operation, CreateGroupOpResponsePayload.class,
          CreateGroupOpResponsePayload::of);
    }
  }
  ...
  @Builder
  private CreateGroupOpResponsePayload(@NonNull UniqueIdentifier uniqueIdentifier) {
