 ...
 *   <li>{@code passwordSaltAlgorithm} — optional Enumeration (tag PASSWORD_SALT_ALGORITHM
 *   0x4201A3)</li>
...
public class PasswordCredential implements CredentialValue, KmipStructure {
  ...
  public KmipDataType[] getValue() {
    return Stream
        .of(password, passwordSalt, passwordSaltAlgorithm, saltedPassword, iterationCount)
