 ...
 *   <li>{@code DEACTIVATION_DATE}: The object was deactivated because its deactivation date has
 *   passed.</li>
 *   <li>{@code PROTECT_STOP_DATE}: The object was deactivated because its protect stop date has
 *   passed.</li>
 *   <li>{@code USAGE_LIMIT}: The object was deactivated because its usage limit has been reached
 *   .</li>
 * </ul>
 *
 * @see KmipEnumeration
...
public class DeactivationReasonCode implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), DeactivationReasonCode::fromName,
          DeactivationReasonCode::fromValue);
    }
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No DeactivationReasonCode value found for '%s' in KMIP spec %s", name,
                spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No DeactivationReasonCode value found for %d in KMIP spec %s", value,
                spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for DeactivationReasonCode is not supported for KMIP spec %s",
