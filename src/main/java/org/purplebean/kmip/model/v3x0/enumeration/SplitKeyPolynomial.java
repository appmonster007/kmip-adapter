...
public class SplitKeyPolynomial implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), SplitKeyPolynomial::fromName,
          SplitKeyPolynomial::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for SplitKeyPolynomial is not supported for KMIP spec %s",
