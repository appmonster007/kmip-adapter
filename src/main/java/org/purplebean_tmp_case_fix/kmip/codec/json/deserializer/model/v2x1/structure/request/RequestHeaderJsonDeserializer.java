package org.purplebean.kmip.codec.json.deserializer.model.v2x1.structure.request;
...
public class RequestHeaderJsonDeserializer extends
  ...
  protected void setValue(RequestHeader.RequestHeaderBuilder builder, String tag, String type,
    ...
    switch (nodeTag) {
      ...
      case KmipTag.Standard.CLIENT_CORRELATION_VALUE ->
          builder.clientCorrelationValue(ctxt.readValue(p, ClientCorrelationValue.class));
      case KmipTag.Standard.SERVER_CORRELATION_VALUE ->
          builder.serverCorrelationValue(ctxt.readValue(p, ServerCorrelationValue.class));
