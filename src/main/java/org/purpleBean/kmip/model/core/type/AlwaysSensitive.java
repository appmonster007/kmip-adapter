...
public class AlwaysSensitive implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, AlwaysSensitive.class, AlwaysSensitive::of);
        }
    }
    ...
    public static AlwaysSensitive of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
