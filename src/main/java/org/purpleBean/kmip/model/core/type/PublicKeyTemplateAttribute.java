...
/**
 * KMIP PublicKeyTemplateAttribute dataType.
 */
@Data
@Builder(toBuilder = true)
public class PublicKeyTemplateAttribute implements KmipDataType {
    ...
    @Builder
    private PublicKeyTemplateAttribute(@NonNull String value) {
        this.value = value;
        validate();
    }

    public static PublicKeyTemplateAttribute of(@NonNull String value) {
        return PublicKeyTemplateAttribute.builder().value(value).build();
    }
