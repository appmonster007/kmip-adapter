...
public class AttributeValueBigInteger implements AttributeValue {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, AttributeValueBigInteger.class);
        }
    }
