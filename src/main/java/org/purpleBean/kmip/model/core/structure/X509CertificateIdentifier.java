...
public class X509CertificateIdentifier implements KmipStructure, KmipAttribute {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          X509CertificateIdentifier.class);
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType,
          X509CertificateIdentifier.class, X509CertificateIdentifier::of);
    }
  }
  ...
  @Builder
  private X509CertificateIdentifier(@NonNull IssuerDistinguishedName issuerDistinguishedName,
                                    @NonNull CertificateSerialNumber certificateSerialNumber) {
  ...
  public static X509CertificateIdentifier of(@NonNull AttributeName attributeName,
    ...
    return X509CertificateIdentifier
        ...
        .issuerDistinguishedName((IssuerDistinguishedName) map
            ...
            .get(0))
        .certificateSerialNumber((CertificateSerialNumber) map
            .get(CertificateSerialNumber.kmipTag)
            .get(0))
        .build();
  }
