...
public class DerivationMethod implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), DerivationMethod::fromName,
          DerivationMethod::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for DerivationMethod is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    PBKDF2(0x00000001, "PBKDF2", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    ...
    ENCRYPT(0x00000004, "Encrypt", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    NIST800_108_C(0x00000005, "Nist800108C", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    NIST800_108_F(0x00000006, "Nist800108F", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    NIST800_108_DPI(0x00000007, "Nist800108Dpi", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
    ASYMMETRIC_KEY(0x00000008, "AsymmetricKey", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
    AWS_SIGNATURE_VERSION_4(0x00000009, "AwsSignatureVersion4", KmipSpec.UnknownVersion,
        KmipSpec.V2_1, KmipSpec.V3_0),
