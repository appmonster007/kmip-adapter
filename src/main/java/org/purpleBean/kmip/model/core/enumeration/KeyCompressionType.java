...
public class KeyCompressionType implements KmipEnumeration {
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipEnumeration.register(spec, kmipTag.getValue(), KeyCompressionType::fromName, KeyCompressionType::fromValue);
        }
    }
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for KeyCompressionType is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
    ...
    public enum Standard implements Value {
        EC_PUBLIC_KEY_TYPE_UNCOMPRESSED(0x00000001, "EcPublicKeyTypeUncompressed", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        EC_PUBLIC_KEY_TYPE_X9_62_COMPRESSED_PRIME(0x00000002, "EcPublicKeyTypeX962CompressedPrime", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        EC_PUBLIC_KEY_TYPE_X9_62_COMPRESSED_CHAR2(0x00000003, "EcPublicKeyTypeX962CompressedChar2", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        EC_PUBLIC_KEY_TYPE_X9_62_HYBRID(0x00000004, "EcPublicKeyTypeX962Hybrid", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0);
