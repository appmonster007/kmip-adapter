...
/**
 * KMIP AttestationMeasurement dataType.
 */
@Data
@Builder(toBuilder = true)
public class AttestationMeasurement implements KmipDataType {

  public static final KmipTag kmipTag = KmipTag.Standard.ATTESTATION_MEASUREMENT.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, AttestationMeasurement.class);
    }
  }
  ...
  @Builder
  private AttestationMeasurement(@NonNull ByteBuffer value) {
    this.value = value;
    validate();
  }
