...
public class NetworkIdentifier implements KmipDataType {
  ...
  public static final KmipTag kmipTag = KmipTag.Standard.NETWORK_IDENTIFIER.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, NetworkIdentifier.class);
    }
  }
  ...
  @Builder
  private NetworkIdentifier(@NonNull String value) {
    this.value = value;
    validate();
  }
