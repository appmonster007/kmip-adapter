...
public class PrivateKeyTemplateAttribute implements KmipStructure {
    ...
    @Builder
    private PrivateKeyTemplateAttribute(List<Name> names, List<Attribute> attributes) {
    ...
    public static PrivateKeyTemplateAttribute of(List<Name> names, List<Attribute> attributes) {
        return PrivateKeyTemplateAttribute.builder().names(names).attributes(attributes).build();
    }
