 ...
 *   <li>{@code QUERY_APPLICATION_NAMESPACES}: Request a list of the application namespaces
 *   supported by the server.</li>
 *   <li>{@code QUERY_EXTENSION_LIST}: Request a list of the extensions supported by the server
 *   .</li>
 *   <li>{@code QUERY_EXTENSION_MAP}: Request a map of the extensions supported by the server.</li>
 *   <li>{@code QUERY_ATTESTATION_TYPES}: Request a list of the attestation types supported by
 *   the server.</li>
 *   <li>{@code QUERY_RNGS}: Request information about the Random Number Generators (RNGs)
 *   supported by the server.</li>
 *   <li>{@code QUERY_VALIDATIONS}: Request information about the validation mechanisms supported
 *   by the server.</li>
 ...
 *   <li>{@code QUERY_CLIENT_REGISTRATION_METHODS}: Request a list of the client registration
 *   methods supported by the server.</li>
 *   <li>{@code QUERY_DEFAULTS_INFORMATION}: Request information about the server's default
 *   attribute values.</li>
 *   <li>{@code QUERY_STORAGE_PROTECTION_MASKS}: Request information about the storage protection
 *   masks supported by the server.</li>
 *   <li>{@code QUERY_CREDENTIAL_INFORMATION}: Request information about the credential types
 *   supported by the server.</li>
 * </ul>
 *
 * @see KmipEnumeration
...
public class QueryFunction implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), QueryFunction::fromName,
          QueryFunction::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for QueryFunction is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    QUERY_OPERATIONS(0x00000001, "QueryOperations", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_OBJECTS(0x00000002, "QueryObjects", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    QUERY_SERVER_INFORMATION(0x00000003, "QueryServerInformation", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_APPLICATION_NAMESPACES(0x00000004, "QueryApplicationNamespaces", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_EXTENSION_LIST(0x00000005, "QueryExtensionList", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_EXTENSION_MAP(0x00000006, "QueryExtensionMap", KmipSpec.UnknownVersion, KmipSpec.V1_2,
        KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_ATTESTATION_TYPES(0x00000007, "QueryAttestationTypes", KmipSpec.UnknownVersion,
        KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_RNGS(0x00000008, "QueryRngs", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_VALIDATIONS(0x00000009, "QueryValidations", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
    QUERY_PROFILES(0x0000000A, "QueryProfiles", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
    QUERY_CAPABILITIES(0x0000000B, "QueryCapabilities", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
    QUERY_CLIENT_REGISTRATION_METHODS(0x0000000C, "QueryClientRegistrationMethods",
        KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_DEFAULTS_INFORMATION(0x0000000D, "QueryDefaultsInformation", KmipSpec.UnknownVersion,
        KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_STORAGE_PROTECTION_MASKS(0x0000000E, "QueryStorageProtectionMasks",
        KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
    QUERY_CREDENTIAL_INFORMATION(0x0000000F, "QueryCredentialInformation", KmipSpec.UnknownVersion,
        KmipSpec.V3_0);
