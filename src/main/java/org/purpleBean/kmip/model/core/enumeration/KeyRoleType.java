...
public class KeyRoleType implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.KEY_ROLE_TYPE.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, KeyRoleType.class);
      KmipEnumeration.register(spec, kmipTag.getValue(), KeyRoleType::fromName,
          KeyRoleType::fromValue);
    }
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for KeyRoleType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    MKSMC(0x00000005, "Mksmc", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MKSMI(0x00000006, "Mksmi", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MKDAC(0x00000007, "Mkdac", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    ...
    MKOTH(0x0000000A, "Mkoth", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    KEK(0x0000000B, "Kek", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    MAC16609(0x0000000C, "Mac16609", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC97971(0x0000000D, "Mac97971", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC97972(0x0000000E, "Mac97972", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC97973(0x0000000F, "Mac97973", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC97974(0x00000010, "Mac97974", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    MAC97975(0x00000011, "Mac97975", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    ZPK(0x00000012, "Zpk", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    PVKIBM(0x00000013, "Pvkibm", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    PVKPVV(0x00000014, "Pvkpvv", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
    PVKOTH(0x00000015, "Pvkoth", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0),
   ...
   */
  public interface Value extends KmipEnumeration.Value<KeyRoleType> {
  }
