 ...
 *
 * @see KmipEnumeration
 * @see KeyValueLocation
 */
@Data
@Builder(toBuilder = true)
public class KeyValueLocationType implements KmipEnumeration {
    public static final KmipTag kmipTag = KmipTag.Standard.KEY_VALUE_LOCATION_TYPE.inst();
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, KeyValueLocationType.class);
            KmipEnumeration.register(spec, kmipTag.getValue(), KeyValueLocationType::fromName, KeyValueLocationType::fromValue);
        }
    }
    ...
    @Builder
    private KeyValueLocationType(@NonNull Value value) {
        this.value = value;
        validate();
    }
    ...
    public static Value fromName(String name) {
        ...
        return Optional.ofNullable(v)
                ...
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No KeyValueLocationType value found for '%s' in KMIP spec %s", name, spec)
                ));
    }
    ...
    public static Value fromValue(int value) {
        ...
        return Optional.ofNullable(v)
                .filter(Value::isSupported)
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No KeyValueLocationType value found for %d in KMIP spec %s", value, spec)
                ));
    }
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for KeyValueLocationType is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
     ...
     */
    public interface Value extends KmipEnumeration.Value<KeyValueLocationType> {
    }
