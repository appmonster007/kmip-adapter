...
public class AttributeValueInterval implements AttributeValue {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, AttributeValueInterval.class);
        }
    }
    ...
    @Builder
    private AttributeValueInterval(@NonNull Integer value) {
        this.value = value;
        validate();
    }
