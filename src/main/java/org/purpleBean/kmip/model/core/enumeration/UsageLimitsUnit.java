...
public class UsageLimitsUnit implements KmipEnumeration {
  public static final KmipTag kmipTag = KmipTag.Standard.USAGE_LIMITS_UNIT.inst();
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), UsageLimitsUnit::fromName,
          UsageLimitsUnit::fromValue);
    }
  }
  ...
  @Builder
  private UsageLimitsUnit(@NonNull Value value) {
    this.value = value;
    validate();
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No UsageLimitsUnit value found for '%s' in KMIP spec %s", name, spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No UsageLimitsUnit value found for %d in KMIP spec %s", value, spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for UsageLimitsUnit is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    BYTE(0x00000001, "Byte", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
    OBJECT(0x00000002, "Object", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1,
        KmipSpec.V3_0);
