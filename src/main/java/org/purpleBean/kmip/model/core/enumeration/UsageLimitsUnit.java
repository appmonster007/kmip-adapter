...
public class UsageLimitsUnit implements KmipEnumeration {
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for UsageLimitsUnit is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
    ...
    public enum Standard implements Value {
        ...
        OBJECT(0x00000002, "Object", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0);
