...
public class TransparentSymmetricKey implements KeyMaterial, KmipStructure {
  ...
  private static final KeyFormatType.Value keyFormatTypeValue =
      KeyFormatType.Standard.TRANSPARENT_SYMMETRIC_KEY;
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KeyMaterial.register(spec, encodingType, keyFormatTypeValue, TransparentSymmetricKey.class,
          TransparentSymmetricKey::of);
    }
  }
  ...
  public static TransparentSymmetricKey of(@NonNull KeyMaterial value) {
    ...
    return TransparentSymmetricKey.of((Key) map
        .get(Key.kmipTag)
        .getFirst());
  }
