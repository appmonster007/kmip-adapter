...
public class PutFunction implements KmipEnumeration {
    public static final KmipTag kmipTag = KmipTag.Standard.PUT_FUNCTION.inst();
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, PutFunction.class);
            KmipEnumeration.register(spec, kmipTag.getValue(), PutFunction::fromName, PutFunction::fromValue);
        }
    }
    ...
    @Builder
    private PutFunction(@NonNull Value value) {
        this.value = value;
        validate();
    }
    ...
    public static Value fromName(String name) {
        ...
        return Optional.ofNullable(v)
                ...
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No PutFunction value found for '%s' in KMIP spec %s", name, spec)
                ));
    }
    ...
    public static Value fromValue(int value) {
        ...
        return Optional.ofNullable(v)
                .filter(Value::isSupported)
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No PutFunction value found for %d in KMIP spec %s", value, spec)
                ));
    }
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for PutFunction is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
    ...
    public enum Standard implements Value {
        NEW(0x00000001, "New", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        REPLACE(0x00000002, "Replace", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0);
        ...
        @Override
        public PutFunction inst() {
            return PutFunction.of(this);
        }
    }
     ...
     */
    public interface Value extends KmipEnumeration.Value<PutFunction> {
    }
