...
public class ShreddingAlgorithm implements KmipEnumeration {
    public static final KmipTag kmipTag = KmipTag.Standard.SHREDDING_ALGORITHM.inst();
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ShreddingAlgorithm.class);
            KmipEnumeration.register(spec, kmipTag.getValue(), ShreddingAlgorithm::fromName, ShreddingAlgorithm::fromValue);
        }
    }
    ...
    @Builder
    private ShreddingAlgorithm(@NonNull Value value) {
        this.value = value;
        validate();
    }
    ...
    public static Value fromName(String name) {
        ...
        return Optional.ofNullable(v)
                ...
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No ShreddingAlgorithm value found for '%s' in KMIP spec %s", name, spec)
                ));
    }
    ...
    public static Value fromValue(int value) {
        ...
        return Optional.ofNullable(v)
                .filter(Value::isSupported)
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No ShreddingAlgorithm value found for %d in KMIP spec %s", value, spec)
                ));
    }
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for ShreddingAlgorithm is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
     ...
     */
    public interface Value extends KmipEnumeration.Value<ShreddingAlgorithm> {
    }
