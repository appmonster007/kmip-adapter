 ...
 *
 * @see KmipEnumeration
 * @see org.purpleBean.kmip.model.core.structure.Ticket
 */
@Data
@Builder(toBuilder = true)
public class TicketType implements KmipEnumeration {
    public static final KmipTag kmipTag = KmipTag.Standard.TICKET_TYPE.inst();
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, TicketType.class);
            KmipEnumeration.register(spec, kmipTag.getValue(), TicketType::fromName, TicketType::fromValue);
        }
    }
    ...
    @Builder
    private TicketType(@NonNull Value value) {
        this.value = value;
        validate();
    }
    ...
    public static Value fromName(String name) {
        ...
        return Optional.ofNullable(v)
                ...
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No TicketType value found for '%s' in KMIP spec %s", name, spec)
                ));
    }
    ...
    public static Value fromValue(int value) {
        ...
        return Optional.ofNullable(v)
                .filter(Value::isSupported)
                .orElseThrow(() -> new NoSuchElementException(
                        String.format("No TicketType value found for %d in KMIP spec %s", value, spec)
                ));
    }
    ...
    private void validate() {
        ...
        if (!value.isSupported()) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for TicketType is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        if (!isSupported()) {
    ...
    public enum Standard implements Value {
        ...
        @Override
        public TicketType inst() {
            return TicketType.of(this);
        }
    }
     ...
     */
    public interface Value extends KmipEnumeration.Value<TicketType> {
    }
