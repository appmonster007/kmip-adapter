...
public class KeyValueLocation implements KmipStructure, KmipAttribute {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, KeyValueLocation.class,
          KeyValueLocation::of);
    }
  }
  ...
  @Builder
  private KeyValueLocation(@NonNull KeyValueLocationValue keyValueLocationValue,
                           @NonNull KeyValueLocationType keyValueLocationType) {
  ...
  public static KeyValueLocation of(@NonNull AttributeName attributeName,
    ...
    return KeyValueLocation
        .builder()
        .keyValueLocationValue((KeyValueLocationValue) map
            .get(KeyValueLocationValue.kmipTag)
            .get(0))
        .keyValueLocationType((KeyValueLocationType) map
            .get(KeyValueLocationType.kmipTag)
            .get(0))
        .build();
  }
  ...
  public KmipDataType[] getValue() {
    return Stream
        .of(keyValueLocationValue, keyValueLocationType)
