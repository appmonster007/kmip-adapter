...
public class RngRetrieveOpRequestPayload implements RequestPayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          RngRetrieveOpRequestPayload.class);
      RequestPayloadStructure.register(spec, operation, RngRetrieveOpRequestPayload.class,
          RngRetrieveOpRequestPayload::of);
    }
  }
  ...
  public static RngRetrieveOpRequestPayload of(List<KmipDataType> values) {
    ...
    if (map.containsKey(DataLength.kmipTag)) {
      builder.dataLength((DataLength) map
          .get(DataLength.kmipTag)
          .getFirst());
    }
