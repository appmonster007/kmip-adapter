...
public class ActivateOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ActivateOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, ActivateOpRequestPayload.class, ActivateOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private ActivateOpRequestPayload(
