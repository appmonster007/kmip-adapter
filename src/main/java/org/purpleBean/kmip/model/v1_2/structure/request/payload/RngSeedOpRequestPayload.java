...
public class RngSeedOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, RngSeedOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, RngSeedOpRequestPayload.class, RngSeedOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private RngSeedOpRequestPayload(
