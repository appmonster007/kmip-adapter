...
public class JoinSplitKeyOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, JoinSplitKeyOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, JoinSplitKeyOpRequestPayload.class, JoinSplitKeyOpRequestPayload::of);
        }
    }
    ...
    public static JoinSplitKeyOpRequestPayload of(List<KmipDataType> values) {
        ...
        if (map.containsKey(SecretDataType.kmipTag)) {
            builder.secretDataType((SecretDataType) map.get(SecretDataType.kmipTag).getFirst());
        }
