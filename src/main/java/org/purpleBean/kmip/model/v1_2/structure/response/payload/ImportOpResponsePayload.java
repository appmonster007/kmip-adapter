...
/**
 * KMIP Import Response Payload (stub).
 */
@Data
...
public class ImportOpResponsePayload implements ResponsePayloadStructure {
    ...
    @Builder
    private ImportOpResponsePayload() { validate(); }

    public static ImportOpResponsePayload of(List<KmipDataType> values) { return ImportOpResponsePayload.builder().build(); }
