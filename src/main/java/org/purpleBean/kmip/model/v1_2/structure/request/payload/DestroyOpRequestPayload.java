...
public class DestroyOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, DestroyOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, DestroyOpRequestPayload.class, DestroyOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private DestroyOpRequestPayload(
