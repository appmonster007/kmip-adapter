...
public class RecoverOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, RecoverOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, RecoverOpRequestPayload.class, RecoverOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private RecoverOpRequestPayload(
