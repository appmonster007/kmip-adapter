...
public class GetAttributeListOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, GetAttributeListOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, GetAttributeListOpRequestPayload.class, GetAttributeListOpRequestPayload::of);
        }
    }
