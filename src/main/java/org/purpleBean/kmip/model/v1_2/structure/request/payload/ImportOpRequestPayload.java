...
/**
 * KMIP Import Request Payload (stub).
 */
@Data
...
public class ImportOpRequestPayload implements RequestPayloadStructure {
    ...
    @Builder
    private ImportOpRequestPayload() { validate(); }

    public static ImportOpRequestPayload of(List<KmipDataType> values) { return ImportOpRequestPayload.builder().build(); }
