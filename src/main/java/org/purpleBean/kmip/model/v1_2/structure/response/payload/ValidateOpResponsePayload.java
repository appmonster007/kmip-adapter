...
public class ValidateOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ValidateOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, ValidateOpResponsePayload.class, ValidateOpResponsePayload::of);
        }
    }
    ...
    @Builder
    private ValidateOpResponsePayload(
    ...
    public List<KmipDataType> getValues() {
        return Stream.of(validityIndicator)
