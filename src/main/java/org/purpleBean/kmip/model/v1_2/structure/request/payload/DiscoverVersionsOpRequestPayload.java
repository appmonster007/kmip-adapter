...
public class DiscoverVersionsOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, DiscoverVersionsOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, DiscoverVersionsOpRequestPayload.class, DiscoverVersionsOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private DiscoverVersionsOpRequestPayload(
