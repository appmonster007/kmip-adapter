...
public class DeleteAttributeOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, DeleteAttributeOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, DeleteAttributeOpResponsePayload.class, DeleteAttributeOpResponsePayload::of);
        }
    }
