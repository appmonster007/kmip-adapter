...
public class ActivateOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ActivateOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, ActivateOpResponsePayload.class, ActivateOpResponsePayload::of);
        }
    }
    ...
    @Builder
    private ActivateOpResponsePayload(
    ...
    public static ActivateOpResponsePayload of(List<KmipDataType> values) {
        var builder = ActivateOpResponsePayload.builder();
