...
public class RngRetrieveOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, RngRetrieveOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, RngRetrieveOpRequestPayload.class, RngRetrieveOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private RngRetrieveOpRequestPayload(
