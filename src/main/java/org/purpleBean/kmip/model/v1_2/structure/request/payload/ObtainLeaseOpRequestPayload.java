...
public class ObtainLeaseOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ObtainLeaseOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, ObtainLeaseOpRequestPayload.class, ObtainLeaseOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private ObtainLeaseOpRequestPayload(
