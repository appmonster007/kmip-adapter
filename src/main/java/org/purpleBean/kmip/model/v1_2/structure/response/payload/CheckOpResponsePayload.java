...
public class CheckOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            ResponsePayloadStructure.register(spec, operation, CheckOpResponsePayload.class, CheckOpResponsePayload::of);
        }
    }
    ...
    public static CheckOpResponsePayload of(List<KmipDataType> values) {
        ...
        if (map.containsKey(CryptographicUsageMask.kmipTag)) {
            builder.cryptographicUsageMask((CryptographicUsageMask) map.get(CryptographicUsageMask.kmipTag).getFirst());
        }
