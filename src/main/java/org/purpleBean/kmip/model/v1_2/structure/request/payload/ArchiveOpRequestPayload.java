...
public class ArchiveOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ArchiveOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, ArchiveOpRequestPayload.class, ArchiveOpRequestPayload::of);
        }
    }
    ...
    @Builder
    private ArchiveOpRequestPayload(
