...
public class PublicKeyLink implements KmipStructure {
    ...
    // public static PublicKeyLink of(@NonNull KmipDataType value) {
    ...
    //     // PublicKeyLinkBuilder builder = PublicKeyLink.builder();
    ...
    public static PublicKeyLink of(
                // @NonNull Field1 field1,
