...
/**
 * KMIP Obliterate Request Payload (stub). Field-level design pending — currently registers as an
...
public class ObliterateOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ObliterateOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, ObliterateOpRequestPayload.class, ObliterateOpRequestPayload::of);
        }
    }

    @Builder
    private ObliterateOpRequestPayload() {
        validate();
    }
