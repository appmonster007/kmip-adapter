 ...
 * <p>
 * Fork of
 * {@link org.purpleBean.kmip.model.v1_2.structure.request.payload.ReKeyKeyPairOpRequestPayload} for
...
public class ReKeyKeyPairOpRequestPayload implements RequestPayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType,
          ReKeyKeyPairOpRequestPayload.class);
      RequestPayloadStructure.register(spec, operation, ReKeyKeyPairOpRequestPayload.class,
          ReKeyKeyPairOpRequestPayload::of);
    }
  }
  ...
  public static ReKeyKeyPairOpRequestPayload of(List<KmipDataType> values) {
    ...
    if (map.containsKey(CommonTemplateAttribute.kmipTag)) {
      builder.commonTemplateAttribute((CommonTemplateAttribute) map
          .get(CommonTemplateAttribute.kmipTag)
          .getFirst());
    }
