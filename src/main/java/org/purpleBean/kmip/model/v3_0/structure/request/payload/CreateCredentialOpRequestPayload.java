...
public class CreateCredentialOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, CreateCredentialOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, CreateCredentialOpRequestPayload.class, CreateCredentialOpRequestPayload::of);
        }
    }
