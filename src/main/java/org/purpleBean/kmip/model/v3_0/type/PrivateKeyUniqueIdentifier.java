...
/**
 * KMIP {@code PrivateKeyUniqueIdentifier} dataType ({@code 0x420066}), encoded as an {@code Identifier}
 * (KMIP 3.0 {@code §4.68} only — same underlying bytes as {@code TextString} but a distinct TTLV Item Type).
 * <p>
 * Unrelated to {@link org.purpleBean.kmip.model.core.type.PrivateKeyUniqueIdentifier} (the pre-3.0 {@code TextString}
