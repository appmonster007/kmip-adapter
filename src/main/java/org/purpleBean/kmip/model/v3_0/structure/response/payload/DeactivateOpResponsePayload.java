...
/**
 * KMIP Deactivate Response Payload (stub). Field-level design pending — currently registers as an
...
public class DeactivateOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, DeactivateOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, DeactivateOpResponsePayload.class, DeactivateOpResponsePayload::of);
        }
    }

    @Builder
    private DeactivateOpResponsePayload() {
        validate();
    }
