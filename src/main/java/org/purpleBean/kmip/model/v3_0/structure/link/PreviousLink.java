...
public class PreviousLink implements KmipStructure {
    ...
    @Builder
    private PreviousLink(@NonNull UniqueIdentifier uniqueIdentifier) {
        this.uniqueIdentifier = uniqueIdentifier;
        validate();
    }

    public static PreviousLink of(@NonNull UniqueIdentifier uniqueIdentifier) {
        return PreviousLink.builder().uniqueIdentifier(uniqueIdentifier).build();
    }
