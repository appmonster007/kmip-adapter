...
public class ObliterateOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ObliterateOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, ObliterateOpResponsePayload.class, ObliterateOpResponsePayload::of);
        }
    }
