...
public class WrappingKeyLink implements KmipStructure {
    ...
    // public static WrappingKeyLink of(@NonNull KmipDataType value) {
    ...
    //     // WrappingKeyLinkBuilder builder = WrappingKeyLink.builder();
    ...
    public static WrappingKeyLink of(
                // @NonNull Field1 field1,
