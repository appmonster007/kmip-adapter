...
public class NextLink implements KmipStructure {
    ...
    @Builder
    private NextLink(@NonNull UniqueIdentifier uniqueIdentifier) {
        this.uniqueIdentifier = uniqueIdentifier;
        validate();
    }

    public static NextLink of(@NonNull UniqueIdentifier uniqueIdentifier) {
        return NextLink.builder().uniqueIdentifier(uniqueIdentifier).build();
    }
