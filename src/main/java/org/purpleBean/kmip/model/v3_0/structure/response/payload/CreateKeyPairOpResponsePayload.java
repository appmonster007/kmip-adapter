 ...
 * <p>
 * Fork of {@link org.purpleBean.kmip.model.v2_1.structure.response.payload.CreateKeyPairOpResponsePayload} for
 * KMIP 3.0, where {@code PrivateKeyUniqueIdentifier}/{@code PublicKeyUniqueIdentifier} are encoded as
 * {@code Identifier} rather than {@code TextString} (see {@link PrivateKeyUniqueIdentifier}, {@link PublicKeyUniqueIdentifier}).
 */
@Data
