...
public class RotateLatest implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, RotateLatest.class, RotateLatest::of);
        }
    }
    ...
    public static RotateLatest of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
