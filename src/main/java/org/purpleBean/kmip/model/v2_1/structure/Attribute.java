...
public class Attribute implements KmipStructure, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.ATTRIBUTE_REGISTRY.put(new KmipAttribute.RegistryKey(spec, kmipTag.getValue(), encodingType), Attribute.class);
        }
    }
    ...
    @Override
    public boolean isServerInitializable() { return false; }

    @Override
    public boolean isClientInitializable() { return true; }

    @Override
    public boolean isServerModifiable(org.purpleBean.kmip.model.core.enumeration.State state) { return true; }

    @Override
    public boolean isClientModifiable(org.purpleBean.kmip.model.core.enumeration.State state) { return true; }

    @Override
    public boolean isClientDeletable() { return true; }

    @Override
    public boolean isMultiInstanceAllowed() { return true; }
    ...
    public static Attribute of(List<KmipDataType> values) {
        ...
        if (map.containsKey(AttributeValue.kmipTag)) {
            builder.attributeValue((AttributeValue) map.get(AttributeValue.kmipTag).getFirst());
        }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(vendorIdentification, attributeName, attributeValue)
