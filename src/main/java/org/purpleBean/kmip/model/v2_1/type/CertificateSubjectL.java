...
public class CertificateSubjectL implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectL.class, CertificateSubjectL::of);
        }
    }
    ...
    public static CertificateSubjectL of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
