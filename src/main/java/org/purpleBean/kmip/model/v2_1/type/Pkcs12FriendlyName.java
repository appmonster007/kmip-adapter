...
public class Pkcs12FriendlyName implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, Pkcs12FriendlyName.class, Pkcs12FriendlyName::of);
        }
    }
    ...
    public static Pkcs12FriendlyName of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
