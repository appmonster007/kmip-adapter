...
public class CertificateSubjectO implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectO.class, CertificateSubjectO::of);
        }
    }
    ...
    public static CertificateSubjectO of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
