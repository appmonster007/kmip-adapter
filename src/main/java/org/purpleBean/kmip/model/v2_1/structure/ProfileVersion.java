...
public class ProfileVersion implements KmipStructure {
    ...
    @Builder
    private ProfileVersion(@NonNull ProfileVersionMajor profileVersionMajor, @NonNull ProfileVersionMinor profileVersionMinor) {
        this.profileVersionMajor = profileVersionMajor;
        this.profileVersionMinor = profileVersionMinor;
        validate();
    }

    public static ProfileVersion of(@NonNull ProfileVersionMajor major, @NonNull ProfileVersionMinor minor) {
        return ProfileVersion.builder().profileVersionMajor(major).profileVersionMinor(minor).build();
    }
    ...
    public static ProfileVersion of(@NonNull KmipDataType value) {
        ...
        for (KmipDataType field : structure.getValue()) {
            if (field instanceof ProfileVersionMajor m) builder.profileVersionMajor(m);
            else if (field instanceof ProfileVersionMinor m) builder.profileVersionMinor(m);
        }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(profileVersionMajor, profileVersionMinor)
