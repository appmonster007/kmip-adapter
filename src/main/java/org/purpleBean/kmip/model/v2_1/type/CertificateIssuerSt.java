...
/**
 * KMIP CertificateIssuerSt datatype attribute.
 */
@Data
@Builder(toBuilder = true)
public class CertificateIssuerSt implements KmipDataType, KmipAttribute {
    public static final KmipTag kmipTag = KmipTag.Standard.CERTIFICATE_ISSUER_ST.inst();
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerSt.class);
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerSt.class, CertificateIssuerSt::of);
        }
    }
    ...
    @Builder
    private CertificateIssuerSt(@NonNull String value) {
        this.value = value;
        validate();
    }

    public static CertificateIssuerSt of(@NonNull String value) {
        return new CertificateIssuerSt(value);
    }

    public static CertificateIssuerSt of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
    ...
    public boolean equals(Object o) {
        ...
        CertificateIssuerSt that = (CertificateIssuerSt) o;
