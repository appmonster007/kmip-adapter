...
public class DelegatedLoginOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, DelegatedLoginOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, DelegatedLoginOpResponsePayload.class, DelegatedLoginOpResponsePayload::of);
        }
    }
