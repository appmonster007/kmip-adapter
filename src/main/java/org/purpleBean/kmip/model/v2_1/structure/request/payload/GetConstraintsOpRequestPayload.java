...
/**
 * KMIP GetConstraints Request Payload (stub). Field-level design pending — currently registers as an
...
public class GetConstraintsOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, GetConstraintsOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, GetConstraintsOpRequestPayload.class, GetConstraintsOpRequestPayload::of);
        }
    }
