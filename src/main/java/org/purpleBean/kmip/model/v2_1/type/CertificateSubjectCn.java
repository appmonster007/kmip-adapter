...
public class CertificateSubjectCn implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectCn.class, CertificateSubjectCn::of);
        }
    }
    ...
    public static CertificateSubjectCn of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
