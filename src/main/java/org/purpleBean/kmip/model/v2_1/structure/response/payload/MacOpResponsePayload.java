...
public class MacOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, MacOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, MacOpResponsePayload.class, MacOpResponsePayload::of);
        }
    }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(uniqueIdentifier, macData, correlationValue)
