...
public class CertificateSubjectSt implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectSt.class, CertificateSubjectSt::of);
        }
    }
    ...
    public static CertificateSubjectSt of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
