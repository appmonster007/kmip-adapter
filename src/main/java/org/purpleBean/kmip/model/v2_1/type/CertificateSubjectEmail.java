...
/**
 * KMIP CertificateSubjectEmail datatype attribute.
 */
@Data
@Builder(toBuilder = true)
public class CertificateSubjectEmail implements KmipDataType, KmipAttribute {
    public static final KmipTag kmipTag = KmipTag.Standard.CERTIFICATE_SUBJECT_EMAIL.inst();
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectEmail.class);
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectEmail.class, CertificateSubjectEmail::of);
        }
    }
    ...
    @Builder
    private CertificateSubjectEmail(@NonNull String value) {
        this.value = value;
        validate();
    }
    ...
    public static CertificateSubjectEmail of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
    ...
    public boolean equals(Object o) {
        ...
        CertificateSubjectEmail that = (CertificateSubjectEmail) o;
