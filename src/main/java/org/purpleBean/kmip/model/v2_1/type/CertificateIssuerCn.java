...
public class CertificateIssuerCn implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerCn.class, CertificateIssuerCn::of);
        }
    }
    ...
    public static CertificateIssuerCn of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
