...
/**
 * KMIP Process Response Payload (stub). Field-level design pending — currently registers as an
...
public class ProcessOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, ProcessOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, ProcessOpResponsePayload.class, ProcessOpResponsePayload::of);
        }
    }

    @Builder
    private ProcessOpResponsePayload() {
        validate();
    }
