...
/**
 * KMIP SetConstraints Response Payload (stub). Field-level design pending — currently registers as an
...
public class SetConstraintsOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, SetConstraintsOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, SetConstraintsOpResponsePayload.class, SetConstraintsOpResponsePayload::of);
        }
    }
