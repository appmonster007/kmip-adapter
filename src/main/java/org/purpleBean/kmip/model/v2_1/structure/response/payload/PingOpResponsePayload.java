...
/**
 * KMIP Ping Response Payload (stub). Field-level design pending — currently registers as an
...
public class PingOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, PingOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, PingOpResponsePayload.class, PingOpResponsePayload::of);
        }
    }

    @Builder
    private PingOpResponsePayload() {
        validate();
    }
