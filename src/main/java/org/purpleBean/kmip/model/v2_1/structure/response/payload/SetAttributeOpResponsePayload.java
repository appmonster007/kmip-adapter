...
/**
 * KMIP SetAttribute Response Payload (V2_1, V3_0).
 *
...
public class SetAttributeOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, SetAttributeOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, SetAttributeOpResponsePayload.class, SetAttributeOpResponsePayload::of);
        }
    }
    ...
    @Builder
    private SetAttributeOpResponsePayload(@NonNull UniqueIdentifier uniqueIdentifier) {
    ...
    public static SetAttributeOpResponsePayload of(@NonNull UniqueIdentifier uniqueIdentifier) {
        return SetAttributeOpResponsePayload.builder().uniqueIdentifier(uniqueIdentifier).build();
    }
