...
public class SignatureVerifyOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, SignatureVerifyOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, SignatureVerifyOpResponsePayload.class, SignatureVerifyOpResponsePayload::of);
        }
    }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(uniqueIdentifier, validityIndicator, data, correlationValue)
