...
public class CertificateSubjectC implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectC.class, CertificateSubjectC::of);
        }
    }
    ...
    public static CertificateSubjectC of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
