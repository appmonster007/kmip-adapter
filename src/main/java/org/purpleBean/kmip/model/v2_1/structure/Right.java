...
public class Right implements KmipStructure {
    ...
    private Right(UsageLimits usageLimits, Operations operations,
                  org.purpleBean.kmip.model.v2_1.structure.Objects managedObjects, ObjectGroups objectGroups) {
    ...
    public static Right of(@NonNull KmipDataType value) {
        ...
        for (KmipDataType field : structure.getValue()) {
            if (field instanceof UsageLimits u) builder.usageLimits(u);
            else if (field instanceof Operations o) builder.operations(o);
            else if (field instanceof org.purpleBean.kmip.model.v2_1.structure.Objects o) builder.managedObjects(o);
            else if (field instanceof ObjectGroups g) builder.objectGroups(g);
        }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(usageLimits, operations, managedObjects, objectGroups)
                .filter(x -> x != null)
