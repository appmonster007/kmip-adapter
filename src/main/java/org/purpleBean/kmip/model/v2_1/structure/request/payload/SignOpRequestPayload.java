...
public class SignOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            RequestPayloadStructure.register(spec, operation, SignOpRequestPayload.class, SignOpRequestPayload::of);
        }
    }
    ...
    public static SignOpRequestPayload of(List<KmipDataType> values) {
        ...
        if (map.containsKey(DigestedData.kmipTag)) {
            builder.digestedData((DigestedData) map.get(DigestedData.kmipTag).getFirst());
        }
