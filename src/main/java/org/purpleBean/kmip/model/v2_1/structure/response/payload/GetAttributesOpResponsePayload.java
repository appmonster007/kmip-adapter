...
public class GetAttributesOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, GetAttributesOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, GetAttributesOpResponsePayload.class, GetAttributesOpResponsePayload::of);
        }
    }
    ...
    public KmipDataType[] getValue() {
        return Stream.of(uniqueIdentifier, attributes)
