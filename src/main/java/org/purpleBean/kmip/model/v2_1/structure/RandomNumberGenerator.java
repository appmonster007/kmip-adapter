...
public class RandomNumberGenerator implements KmipStructure, KmipAttribute {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipAttribute.register(spec, kmipTag.getValue(), encodingType, RandomNumberGenerator.class,
          RandomNumberGenerator::of);
    }
  }
  ...
  public static RandomNumberGenerator of(@NonNull AttributeName attributeName,
    ...
    RngParameters rng = (RngParameters) map
        .get(RngParameters.kmipTag)
        .getFirst();
    return of(rng);
  }
  ...
  public KmipDataType[] getValue() {
    // KMIP §4.46: RandomNumberGenerator emits the RngParameters fields inline (no RngParameters
    // wrapper tag).
    if (rngParameters == null) {
