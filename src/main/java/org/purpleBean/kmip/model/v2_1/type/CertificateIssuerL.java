...
public class CertificateIssuerL implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerL.class, CertificateIssuerL::of);
        }
    }
    ...
    public static CertificateIssuerL of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
