...
public class ProtectionPeriod implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, ProtectionPeriod.class, ProtectionPeriod::of);
        }
    }
    ...
    public static ProtectionPeriod of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
