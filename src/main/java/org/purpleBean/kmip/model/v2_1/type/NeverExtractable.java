...
public class NeverExtractable implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, NeverExtractable.class, NeverExtractable::of);
        }
    }
    ...
    public static NeverExtractable of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
