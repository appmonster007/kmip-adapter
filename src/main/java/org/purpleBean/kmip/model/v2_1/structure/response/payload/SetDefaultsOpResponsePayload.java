...
public class SetDefaultsOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, SetDefaultsOpResponsePayload.class);
            ResponsePayloadStructure.register(spec, operation, SetDefaultsOpResponsePayload.class, SetDefaultsOpResponsePayload::of);
        }
    }

    @Builder
    private SetDefaultsOpResponsePayload() {
        validate();
    }
