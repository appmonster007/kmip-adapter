...
public class CertificateIssuerEmail implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerEmail.class, CertificateIssuerEmail::of);
        }
    }
    ...
    public static CertificateIssuerEmail of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
