 ...
 * <p><b>Standards:</b></p>
 * <ul>
 *   <li>{@code SUBMITTED}: The operation has been submitted but has not yet started processing.</li>
...
public class ProcessingStage implements KmipEnumeration {
    ...
    static {
        ...
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipEnumeration.register(spec, kmipTag.getValue(), ProcessingStage::fromName, ProcessingStage::fromValue);
        }
    }
