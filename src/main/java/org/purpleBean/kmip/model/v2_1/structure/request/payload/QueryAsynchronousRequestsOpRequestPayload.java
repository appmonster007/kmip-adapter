...
public class QueryAsynchronousRequestsOpRequestPayload implements RequestPayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, QueryAsynchronousRequestsOpRequestPayload.class);
            RequestPayloadStructure.register(spec, operation, QueryAsynchronousRequestsOpRequestPayload.class, QueryAsynchronousRequestsOpRequestPayload::of);
        }
    }
