...
public class CertificateSubjectOu implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateSubjectOu.class, CertificateSubjectOu::of);
        }
    }
    ...
    public static CertificateSubjectOu of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
