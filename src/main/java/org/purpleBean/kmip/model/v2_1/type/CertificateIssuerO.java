...
public class CertificateIssuerO implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, CertificateIssuerO.class, CertificateIssuerO::of);
        }
    }
    ...
    public static CertificateIssuerO of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
