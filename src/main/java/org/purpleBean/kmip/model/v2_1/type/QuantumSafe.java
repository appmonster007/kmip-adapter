...
public class QuantumSafe implements KmipDataType, KmipAttribute {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipAttribute.register(spec, kmipTag.getValue(), encodingType, QuantumSafe.class, QuantumSafe::of);
        }
    }
    ...
    public static QuantumSafe of(@NonNull AttributeName attributeName, @NonNull AttributeValue attributeValue) {
