...
public class Attributes implements KmipStructure {
  public static final KmipTag kmipTag = KmipTag.Standard.ATTRIBUTES.inst();
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, Attributes.class);
    }
  }
  ...
  @Builder
  private Attributes(List<KmipAttribute> attributes) {
