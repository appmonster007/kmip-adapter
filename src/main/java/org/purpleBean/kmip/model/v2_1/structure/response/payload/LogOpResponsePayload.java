...
/**
 * KMIP Log Response Payload (stub). Field-level design pending — currently registers as an
...
public class LogOpResponsePayload implements ResponsePayloadStructure {
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            ResponsePayloadStructure.register(spec, operation, LogOpResponsePayload.class, LogOpResponsePayload::of);
        }
    }
