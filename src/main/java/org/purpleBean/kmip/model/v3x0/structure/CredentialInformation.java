 ...
 *
 * <ul>
 *   <li>{@code credentialTypes} — one or more CredentialType enumerations (tag CREDENTIAL_TYPE
 *   0x420024)</li>
 * </ul>
 */
@Data
...
public class CredentialInformation implements KmipStructure {
  ...
  private CredentialInformation(@NonNull List<CredentialType> credentialTypes) {
    this.credentialTypes =
        (credentialTypes == null) ? Collections.emptyList() : List.copyOf(credentialTypes);
    validate();
  }
  ...
  private void validate() {
    ...
    if (credentialTypes == null || credentialTypes.isEmpty()) {
      throw new IllegalArgumentException(
          "CredentialInformation requires at least one CredentialType");
    }
  }
