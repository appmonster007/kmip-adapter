...
public class ItemType implements KmipEnumeration {
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for ItemType is not supported for KMIP spec %s",
  ...
  public enum Standard implements Value {
    ...
    DATE_TIME_EXTENDED(0x0000000B, "DateTimeExtended", KmipSpec.UnknownVersion, KmipSpec.V2_1,
        KmipSpec.V3_0),
