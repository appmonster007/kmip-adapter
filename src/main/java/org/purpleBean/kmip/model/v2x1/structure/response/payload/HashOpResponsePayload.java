...
public class HashOpResponsePayload implements ResponsePayloadStructure {
  ...
  static {
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipDataType.register(spec, kmipTag.getValue(), encodingType, HashOpResponsePayload.class);
      ResponsePayloadStructure.register(spec, operation, HashOpResponsePayload.class,
          HashOpResponsePayload::of);
    }
  }
