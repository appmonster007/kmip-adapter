...
public class AsynchronousIndicator implements KmipEnumeration {
  ...
  static {
    ...
    for (KmipSpec spec : supportedVersions) {
      ...
      KmipEnumeration.register(spec, kmipTag.getValue(), AsynchronousIndicator::fromName,
          AsynchronousIndicator::fromValue);
    }
  }
  ...
  public static Value fromName(String name) {
    ...
    return Optional
        ...
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No AsynchronousIndicator value found for '%s' in KMIP spec %s", name,
                spec)
        ));
  }
  ...
  public static Value fromValue(int value) {
    ...
    return Optional
        ...
        .filter(Value::isSupported)
        .orElseThrow(() -> new NoSuchElementException(
            String.format("No AsynchronousIndicator value found for %d in KMIP spec %s", value,
                spec)
        ));
  }
  ...
  private void validate() {
    ...
    if (!value.isSupported()) {
      throw new IllegalArgumentException(
          String.format("Value '%s' for AsynchronousIndicator is not supported for KMIP spec %s",
