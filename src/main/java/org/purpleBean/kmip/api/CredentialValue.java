 ...
 * <p>
 * This interface extends {@link KmipDataType} and serves as a marker for all
...
public interface CredentialValue extends KmipDataType {
    /**
     * The standard KMIP tag for a CredentialValue, which is always {@link KmipTag.Standard#CREDENTIAL_VALUE}.
     */
     ...
     */
    Map<RegistryKey, Class<? extends KmipDataType>> CREDENTIAL_TYPE_REGISTRY = new ConcurrentHashMap<>();
     ...
     */
    Map<RegistryKey, Function<CredentialValue, ? extends CredentialValue>> CREDENTIAL_TYPE_BUILDER_REGISTRY = new ConcurrentHashMap<>();

    /**
     * Registers a {@link CredentialValue} class and its builder function with the central registries.
     * <p>
     * This method should be called for each supported credential format to enable dynamic
     ...
     * @param credentialTypeValue   The {@link CredentialType.Value} that specifies the format of the credential.
    ...
    static void register(
        ...
        CREDENTIAL_TYPE_BUILDER_REGISTRY.put(new RegistryKey(spec, encodingType, credentialTypeValue), credentialTypeBuilder);
    }
     ...
     */
    record RegistryKey(KmipSpec spec, EncodingType encodingType, CredentialType.Value credentialTypeValue) {
    }
}
