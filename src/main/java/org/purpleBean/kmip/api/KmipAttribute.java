 ...
 * of an attribute, such as whether it is server-initializable, client-modifiable, or always present.
 *
...
public interface KmipAttribute extends KmipDataType {
    ...
    /**
     * A registry mapping a key to a builder function that can construct a specific {@link KmipAttribute} instance.
     */
     ...
     * @param attributeBuilder A {@link BiFunction} that constructs an instance of the attribute from an {@link AttributeName} and {@link AttributeValue}.
     */
    ...
    /**
     * Indicates if the attribute can be modified by the server, potentially depending on the object's state.
    ...
    /**
     * Indicates if the attribute can be modified by a client, potentially depending on the object's state.
     * @param state The current {@link State} of the managed object.
    ...
    /**
     * A composite key for the attribute registries, uniquely identifying an attribute by its specification, tag, and encoding.
     */
