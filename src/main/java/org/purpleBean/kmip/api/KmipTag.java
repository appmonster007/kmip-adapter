 ...
 * <p>
 * A KMIP tag is a 3-byte value that uniquely identifies a specific element (item) within a KMIP message.
 * Tags are fundamental to the Tag-Type-Length-Value (TTLV) encoding scheme used by KMIP.
 * This class provides a comprehensive way to work with both standard tags defined in the KMIP specification
 * and custom extension tags defined by vendors.
 *
 * <p><b>Key Features:</b></p>
 * <ul>
 *   <li><b>Standard Tags:</b> Includes an extensive enumeration ({@link Standard}) of all standard tags
 *       defined across various KMIP versions (1.0 to 3.0).</li>
 *   <li><b>Extension Support:</b> Allows for the dynamic registration and handling of vendor-specific
 ...
 *   <li><b>Version Awareness:</b> Each tag (standard or extension) is aware of the KMIP specifications
...
public class KmipTag {
     ...
     * @param description       A human-readable description of the tag. If null, a hex string representation is used.
     ...
     * (0x540000 - 0x54FFFF). If the tag is already registered, it updates the supported versions if necessary.
     *
     ...
     * @throws IllegalArgumentException if the value is outside the extension range, the description is empty,
     ...
     * @param value The integer value of the tag.
     * @return The corresponding {@link Value} definition.
     * @throws NoSuchElementException if no tag is found for the given value in the current KMIP context.
     */
    ...
    public enum Standard implements Value {
        ...
        CERTIFICATE_ISSUER(0x420015, "CertificateIssuer", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        CERTIFICATE_ISSUER_ALTERNATIVE_NAME(0x420016, "CertificateIssuerAlternativeName", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        CERTIFICATE_ISSUER_DISTINGUISHED_NAME(0x420017, "CertificateIssuerDistinguishedName", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        ...
        CERTIFICATE_SUBJECT(0x42001A, "CertificateSubject", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        CERTIFICATE_SUBJECT_ALTERNATIVE_NAME(0x42001B, "CertificateSubjectAlternativeName", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        CERTIFICATE_SUBJECT_DISTINGUISHED_NAME(0x42001C, "CertificateSubjectDistinguishedName", KmipSpec.UnknownVersion, KmipSpec.V1_1, KmipSpec.V1_2),
        ...
        X_509_CERTIFICATE_IDENTIFIER(0x4200B5, "X_509CertificateIdentifier", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        X_509_CERTIFICATE_ISSUER(0x4200B6, "X_509CertificateIssuer", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        X_509_CERTIFICATE_SUBJECT(0x4200B7, "X_509CertificateSubject", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        ...
        PKCS_12_FRIENDLY_NAME(0x4200FB, "PKCS_12FriendlyName", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
