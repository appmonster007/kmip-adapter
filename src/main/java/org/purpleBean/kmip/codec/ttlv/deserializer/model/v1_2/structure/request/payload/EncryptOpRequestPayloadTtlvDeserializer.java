...
public class EncryptOpRequestPayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<EncryptOpRequestPayload, EncryptOpRequestPayload.EncryptOpRequestPayloadBuilder> {

    public EncryptOpRequestPayloadTtlvDeserializer() {
        super(EncryptOpRequestPayload.kmipTag);
    }
    ...
    @Override
    protected void setValue(EncryptOpRequestPayload.EncryptOpRequestPayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return EncryptOpRequestPayload.encodingType;
    }
}
