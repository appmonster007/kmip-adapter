...
public class KeyValueLocationTtlvSerializer extends KmipDataTypeTtlvSerializer<KeyValueLocation> {
    @Override
    public ByteBuffer serialize(KeyValueLocation value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(KeyValueLocation value, TtlvMapper mapper) throws IOException {
