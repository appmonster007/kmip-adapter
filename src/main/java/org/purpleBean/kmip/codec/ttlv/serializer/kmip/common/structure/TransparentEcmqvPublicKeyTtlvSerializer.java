...
public class TransparentEcmqvPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcmqvPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentEcmqvPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcmqvPublicKey value, TtlvMapper mapper) throws IOException {
