...
public class TransparentEcdhPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcdhPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentEcdhPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcdhPublicKey value, TtlvMapper mapper) throws IOException {
