...
public class QuantumSafeTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<QuantumSafe, QuantumSafe.QuantumSafeBuilder> {
    ...
    @Override
    protected void setValue(QuantumSafe.QuantumSafeBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
