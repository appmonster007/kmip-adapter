...
public class DeviceSerialNumberTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DeviceSerialNumber, DeviceSerialNumber.DeviceSerialNumberBuilder> {
    ...
    @Override
    protected void setValue(DeviceSerialNumber.DeviceSerialNumberBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
