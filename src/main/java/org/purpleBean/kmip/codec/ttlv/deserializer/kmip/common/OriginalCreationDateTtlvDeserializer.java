...
public class OriginalCreationDateTtlvDeserializer extends KmipDataTypeTtlvDeserializer<OriginalCreationDate> {
    ...
    @Override
    public OriginalCreationDate deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
