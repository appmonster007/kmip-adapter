...
public class WrappingKeyLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<WrappingKeyLink, WrappingKeyLink.WrappingKeyLinkBuilder> {
    ...
    @Override
    protected void setValue(WrappingKeyLink.WrappingKeyLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
