...
public class DeleteAttributeOpResponsePayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<DeleteAttributeOpResponsePayload, DeleteAttributeOpResponsePayload.DeleteAttributeOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(DeleteAttributeOpResponsePayload.DeleteAttributeOpResponsePayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return DeleteAttributeOpResponsePayload.encodingType;
    }
}
