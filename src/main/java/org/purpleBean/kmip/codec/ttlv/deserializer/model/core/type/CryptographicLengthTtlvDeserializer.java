...
public class CryptographicLengthTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CryptographicLength, CryptographicLength.CryptographicLengthBuilder> {
    ...
    @Override
    protected void setValue(CryptographicLength.CryptographicLengthBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
