...
public class RotateDateTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<RotateDate, RotateDate.RotateDateBuilder> {
    ...
    @Override
    protected void setValue(RotateDate.RotateDateBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
