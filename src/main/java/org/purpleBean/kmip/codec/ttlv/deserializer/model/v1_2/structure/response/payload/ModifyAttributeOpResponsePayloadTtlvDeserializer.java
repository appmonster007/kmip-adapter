...
public class ModifyAttributeOpResponsePayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ModifyAttributeOpResponsePayload, ModifyAttributeOpResponsePayload.ModifyAttributeOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(ModifyAttributeOpResponsePayload.ModifyAttributeOpResponsePayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
