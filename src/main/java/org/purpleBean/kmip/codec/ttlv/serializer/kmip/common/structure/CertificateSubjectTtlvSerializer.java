...
public class CertificateSubjectTtlvSerializer extends KmipDataTypeTtlvSerializer<CertificateSubject> {
    @Override
    public ByteBuffer serialize(CertificateSubject value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(CertificateSubject value, TtlvMapper mapper) throws IOException {
