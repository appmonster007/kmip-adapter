...
public class ProtectStopDateTtlvDeserializer extends KmipDataTypeTtlvDeserializer<ProtectStopDate> {
    ...
    @Override
    public ProtectStopDate deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
