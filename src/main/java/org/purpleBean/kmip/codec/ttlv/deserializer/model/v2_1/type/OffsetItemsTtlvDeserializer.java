...
public class OffsetItemsTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<OffsetItems, OffsetItems.OffsetItemsBuilder> {
    ...
    @Override
    protected void setValue(OffsetItems.OffsetItemsBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
