...
public class TransparentDhPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentDhPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentDhPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentDhPublicKey value, TtlvMapper mapper) throws IOException {
