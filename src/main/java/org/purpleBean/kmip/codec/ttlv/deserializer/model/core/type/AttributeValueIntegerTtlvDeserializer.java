...
public class AttributeValueIntegerTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<AttributeValueInteger, AttributeValueInteger.AttributeValueIntegerBuilder> {
    ...
    @Override
    protected void setValue(AttributeValueInteger.AttributeValueIntegerBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
