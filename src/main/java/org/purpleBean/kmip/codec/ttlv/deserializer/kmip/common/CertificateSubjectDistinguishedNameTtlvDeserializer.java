...
public class CertificateSubjectDistinguishedNameTtlvDeserializer extends KmipDataTypeTtlvDeserializer<CertificateSubjectDistinguishedName> {
    ...
    @Override
    public CertificateSubjectDistinguishedName deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        if (!certificateSubjectDistinguishedName.isSupported()) {
            throw new NoSuchElementException(String.format("CertificateSubjectDistinguishedName not supported for spec %s", spec));
        }
