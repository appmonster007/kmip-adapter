...
public class ReplaceExistingTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ReplaceExisting, ReplaceExisting.ReplaceExistingBuilder> {
    ...
    @Override
    protected void setValue(ReplaceExisting.ReplaceExistingBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
