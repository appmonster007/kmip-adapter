...
public class DataIntegerTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DataInteger, DataInteger.DataIntegerBuilder> {
    ...
    @Override
    protected void setValue(DataInteger.DataIntegerBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
