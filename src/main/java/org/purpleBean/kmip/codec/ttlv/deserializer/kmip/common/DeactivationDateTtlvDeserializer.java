...
public class DeactivationDateTtlvDeserializer extends KmipDataTypeTtlvDeserializer<DeactivationDate> {
    ...
    @Override
    public DeactivationDate deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
