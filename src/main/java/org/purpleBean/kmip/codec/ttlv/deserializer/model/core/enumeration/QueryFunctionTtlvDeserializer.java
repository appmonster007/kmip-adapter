...
public class QueryFunctionTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<QueryFunction, QueryFunction.QueryFunctionBuilder> {
    ...
    @Override
    protected void setValue(QueryFunction.QueryFunctionBuilder builder, byte[] tagBytes, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
