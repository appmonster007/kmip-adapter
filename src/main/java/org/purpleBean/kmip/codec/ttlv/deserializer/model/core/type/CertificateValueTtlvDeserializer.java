...
public class CertificateValueTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateValue, CertificateValue.CertificateValueBuilder> {
    ...
    @Override
    protected void setValue(CertificateValue.CertificateValueBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
