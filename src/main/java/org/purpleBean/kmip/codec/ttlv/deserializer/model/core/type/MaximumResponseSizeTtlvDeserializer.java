...
public class MaximumResponseSizeTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<MaximumResponseSize, MaximumResponseSize.MaximumResponseSizeBuilder> {
    ...
    @Override
    protected void setValue(MaximumResponseSize.MaximumResponseSizeBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
