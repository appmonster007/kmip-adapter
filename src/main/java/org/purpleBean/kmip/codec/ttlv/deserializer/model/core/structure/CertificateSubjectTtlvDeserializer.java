...
public class CertificateSubjectTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateSubject, CertificateSubject.CertificateSubjectBuilder> {
    ...
    @Override
    protected void setValue(CertificateSubject.CertificateSubjectBuilder builder, byte[] tagBytes, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
