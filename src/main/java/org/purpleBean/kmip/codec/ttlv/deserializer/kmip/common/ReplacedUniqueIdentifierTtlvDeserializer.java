...
public class ReplacedUniqueIdentifierTtlvDeserializer extends KmipDataTypeTtlvDeserializer<ReplacedUniqueIdentifier> {
    ...
    @Override
    public ReplacedUniqueIdentifier deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        if (!replacedUniqueIdentifier.isSupported()) {
            throw new NoSuchElementException(String.format("ReplacedUniqueIdentifier not supported for spec %s", spec));
        }
