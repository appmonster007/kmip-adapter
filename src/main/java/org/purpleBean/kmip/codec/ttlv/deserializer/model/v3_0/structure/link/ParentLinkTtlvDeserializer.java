...
public class ParentLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ParentLink, ParentLink.ParentLinkBuilder> {
    ...
    @Override
    protected void setValue(ParentLink.ParentLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
