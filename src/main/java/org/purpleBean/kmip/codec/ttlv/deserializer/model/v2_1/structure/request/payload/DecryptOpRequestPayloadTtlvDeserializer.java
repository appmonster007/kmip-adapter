...
public class DecryptOpRequestPayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DecryptOpRequestPayload, DecryptOpRequestPayload.DecryptOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(DecryptOpRequestPayload.DecryptOpRequestPayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
        ...
        switch (nodeTag) {
            ...
            case KmipTag.Standard.AUTHENTICATED_ENCRYPTION_ADDITIONAL_DATA -> builder.authenticatedEncryptionAdditionalData(mapper.readValue(p, AuthenticatedEncryptionAdditionalData.class));
