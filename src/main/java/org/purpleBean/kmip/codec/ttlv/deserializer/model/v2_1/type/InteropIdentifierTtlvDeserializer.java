...
public class InteropIdentifierTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<InteropIdentifier, InteropIdentifier.InteropIdentifierBuilder> {
    ...
    @Override
    protected void setValue(InteropIdentifier.InteropIdentifierBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
