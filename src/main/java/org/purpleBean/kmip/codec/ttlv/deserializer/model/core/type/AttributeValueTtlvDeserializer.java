...
public class AttributeValueTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<AttributeValue, AttributeValue.AttributeValueBuilder> {
    ...
    @Override
    protected void setValue(AttributeValue.AttributeValueBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
    ...
    @Override
    protected byte verifyType(TtlvObject obj, TtlvMapper mapper, AttributeValue.AttributeValueBuilder builder) {
