 ...
 * <ul>
 *   <li><b>Serialization Logic:</b> The main responsibility of a concrete implementation is to provide
 ...
 *   <li><b>Recursive Serialization:</b> The provided {@link TtlvMapper} instance allows for recursive
 *       serialization of nested objects, enabling the handling of complex data structures.</li>
 * </ul>
 *
 * <p><b>Usage:</b></p>
 * To create a custom serializer, extend this class and implement the abstract {@code serialize} method.
