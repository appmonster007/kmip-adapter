...
public class MachineIdentifierTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<MachineIdentifier, MachineIdentifier.MachineIdentifierBuilder> {
    ...
    @Override
    protected void setValue(MachineIdentifier.MachineIdentifierBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
