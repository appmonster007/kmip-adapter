...
public class TransparentEcmqvPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcmqvPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentEcmqvPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcmqvPrivateKey value, TtlvMapper mapper) throws IOException {
