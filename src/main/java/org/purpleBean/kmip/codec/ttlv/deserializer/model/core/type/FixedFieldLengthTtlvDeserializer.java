...
public class FixedFieldLengthTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<FixedFieldLength, FixedFieldLength.FixedFieldLengthBuilder> {
    ...
    @Override
    protected void setValue(FixedFieldLength.FixedFieldLengthBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
