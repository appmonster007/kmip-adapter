...
public class GetAttributesOpRequestPayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<GetAttributesOpRequestPayload, GetAttributesOpRequestPayload.GetAttributesOpRequestPayloadBuilder> {

    public GetAttributesOpRequestPayloadTtlvDeserializer() {
        super(GetAttributesOpRequestPayload.kmipTag);
    }
    ...
    @Override
    protected void setValue(GetAttributesOpRequestPayload.GetAttributesOpRequestPayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return GetAttributesOpRequestPayload.encodingType;
    }
}
