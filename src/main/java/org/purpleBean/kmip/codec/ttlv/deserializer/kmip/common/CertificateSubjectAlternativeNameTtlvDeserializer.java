...
public class CertificateSubjectAlternativeNameTtlvDeserializer extends KmipDataTypeTtlvDeserializer<CertificateSubjectAlternativeName> {
    ...
    @Override
    public CertificateSubjectAlternativeName deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        if (!certificateSubjectAlternativeName.isSupported()) {
            throw new NoSuchElementException(String.format("CertificateSubjectAlternativeName not supported for spec %s", spec));
        }
