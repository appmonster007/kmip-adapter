...
public class NewAttributeTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<NewAttribute, NewAttribute.NewAttributeBuilder> {
    ...
    @Override
    protected void setValue(NewAttribute.NewAttributeBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
        ...
        EncodingType childEncodingType = EncodingType.fromTypeValue(view.get())
                .orElseThrow(() -> new IllegalArgumentException("Unknown encoding type in NewAttribute child TTLV"));
