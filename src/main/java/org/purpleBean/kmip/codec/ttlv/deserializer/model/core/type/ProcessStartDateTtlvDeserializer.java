...
public class ProcessStartDateTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ProcessStartDate, ProcessStartDate.ProcessStartDateBuilder> {
    ...
    @Override
    protected void setValue(ProcessStartDate.ProcessStartDateBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
