...
public class CheckOpResponsePayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<CheckOpResponsePayload, CheckOpResponsePayload.CheckOpResponsePayloadBuilder> {

    public CheckOpResponsePayloadTtlvDeserializer() {
        super(CheckOpResponsePayload.kmipTag);
    }
    ...
    @Override
    protected void setValue(CheckOpResponsePayload.CheckOpResponsePayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return CheckOpResponsePayload.encodingType;
    }
}
