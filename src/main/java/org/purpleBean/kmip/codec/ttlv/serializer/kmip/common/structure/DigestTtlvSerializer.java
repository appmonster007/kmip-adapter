...
public class DigestTtlvSerializer extends KmipDataTypeTtlvSerializer<Digest> {
    @Override
    public ByteBuffer serialize(Digest value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(Digest value, TtlvMapper mapper) throws IOException {
