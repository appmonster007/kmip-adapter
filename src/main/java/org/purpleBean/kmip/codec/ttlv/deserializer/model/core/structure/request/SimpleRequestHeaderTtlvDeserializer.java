...
public class SimpleRequestHeaderTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<SimpleRequestHeader, SimpleRequestHeader.SimpleRequestHeaderBuilder> {
    ...
    @Override
    protected void setValue(SimpleRequestHeader.SimpleRequestHeaderBuilder builder, byte[] tagBytes, ByteBuffer p, TtlvMapper mapper) throws IOException {
