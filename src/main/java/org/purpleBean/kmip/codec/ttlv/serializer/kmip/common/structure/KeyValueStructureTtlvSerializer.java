...
public class KeyValueStructureTtlvSerializer extends KmipDataTypeTtlvSerializer<KeyValueStructure> {
    @Override
    public ByteBuffer serialize(KeyValueStructure value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(KeyValueStructure value, TtlvMapper mapper) throws IOException {
