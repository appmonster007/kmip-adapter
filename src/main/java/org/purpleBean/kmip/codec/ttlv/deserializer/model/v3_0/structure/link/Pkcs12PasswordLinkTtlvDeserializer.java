...
public class Pkcs12PasswordLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<Pkcs12PasswordLink, Pkcs12PasswordLink.Pkcs12PasswordLinkBuilder> {
    ...
    @Override
    protected void setValue(Pkcs12PasswordLink.Pkcs12PasswordLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
