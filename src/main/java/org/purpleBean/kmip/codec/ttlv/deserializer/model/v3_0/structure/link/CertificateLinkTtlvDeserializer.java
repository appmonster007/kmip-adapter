...
public class CertificateLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateLink, CertificateLink.CertificateLinkBuilder> {
    ...
    @Override
    protected void setValue(CertificateLink.CertificateLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
