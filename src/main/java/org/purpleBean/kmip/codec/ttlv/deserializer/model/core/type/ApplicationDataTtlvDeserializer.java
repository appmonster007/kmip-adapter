...
public class ApplicationDataTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ApplicationData, ApplicationData.ApplicationDataBuilder> {
    ...
    @Override
    protected void setValue(ApplicationData.ApplicationDataBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
