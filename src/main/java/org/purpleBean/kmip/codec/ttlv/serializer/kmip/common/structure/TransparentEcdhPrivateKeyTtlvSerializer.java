...
public class TransparentEcdhPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcdhPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentEcdhPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcdhPrivateKey value, TtlvMapper mapper) throws IOException {
