...
public class CertificateRequestTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateRequest, CertificateRequest.CertificateRequestBuilder> {
    ...
    @Override
    protected void setValue(CertificateRequest.CertificateRequestBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
