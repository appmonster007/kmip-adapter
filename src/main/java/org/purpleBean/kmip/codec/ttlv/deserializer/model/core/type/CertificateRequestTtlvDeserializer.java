...
public class CertificateRequestTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateRequest, CertificateRequest.CertificateRequestBuilder> {
    ...
    @Override
    protected void setValue(CertificateRequest.CertificateRequestBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
