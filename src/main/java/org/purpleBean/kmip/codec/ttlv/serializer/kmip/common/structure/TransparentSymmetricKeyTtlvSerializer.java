...
public class TransparentSymmetricKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentSymmetricKey> {
    @Override
    public ByteBuffer serialize(TransparentSymmetricKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentSymmetricKey value, TtlvMapper mapper) throws IOException {
