...
/**
 * TTLV serializer for RngMode.
 */
public class RngModeTtlvSerializer extends KmipDataTypeTtlvSerializer<RngMode> {

    @Override
    public ByteBuffer serialize(RngMode value, TtlvMapper mapper) throws IOException {
