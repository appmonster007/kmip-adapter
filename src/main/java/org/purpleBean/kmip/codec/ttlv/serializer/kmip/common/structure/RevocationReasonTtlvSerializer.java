...
public class RevocationReasonTtlvSerializer extends KmipDataTypeTtlvSerializer<RevocationReason> {
    @Override
    public ByteBuffer serialize(RevocationReason value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(RevocationReason value, TtlvMapper mapper) throws IOException {
