...
public class TransparentDsaPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentDsaPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentDsaPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentDsaPrivateKey value, TtlvMapper mapper) throws IOException {
