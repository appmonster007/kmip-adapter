...
public class TransparentEcdsaPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcdsaPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentEcdsaPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcdsaPrivateKey value, TtlvMapper mapper) throws IOException {
