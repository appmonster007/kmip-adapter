...
/**
 * TTLV serializer for TicketType.
 */
public class TicketTypeTtlvSerializer extends KmipDataTypeTtlvSerializer<TicketType> {

    @Override
    public ByteBuffer serialize(TicketType value, TtlvMapper mapper) throws IOException {
