...
public class ApplicationSpecificInformationTtlvSerializer extends KmipDataTypeTtlvSerializer<ApplicationSpecificInformation> {
    @Override
    public ByteBuffer serialize(ApplicationSpecificInformation value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(ApplicationSpecificInformation value, TtlvMapper mapper) throws IOException {
