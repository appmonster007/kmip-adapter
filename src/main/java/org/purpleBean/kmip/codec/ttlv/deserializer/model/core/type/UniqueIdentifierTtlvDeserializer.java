...
public class UniqueIdentifierTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<UniqueIdentifier, UniqueIdentifier.UniqueIdentifierBuilder> {
    ...
    @Override
    protected byte verifyType(TtlvObject obj, TtlvMapper mapper, UniqueIdentifier.UniqueIdentifierBuilder builder) {
    ...
    @Override
    protected void setValue(UniqueIdentifier.UniqueIdentifierBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
        builder.value(mapper.readValue(byteBuffer, String.class));
        EncodingType.fromTypeValue(type).ifPresent(builder::sourceEncoding);
    }
