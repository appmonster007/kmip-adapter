...
public class TransparentDhPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentDhPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentDhPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentDhPrivateKey value, TtlvMapper mapper) throws IOException {
