...
public class PublicKeyUniqueIdentifierTtlvDeserializer extends KmipDataTypeTtlvDeserializer<PublicKeyUniqueIdentifier> {
    ...
    @Override
    public PublicKeyUniqueIdentifier deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        if (!publicKeyUniqueIdentifier.isSupported()) {
            throw new NoSuchElementException(String.format("PublicKeyUniqueIdentifier not supported for spec %s", spec));
        }
