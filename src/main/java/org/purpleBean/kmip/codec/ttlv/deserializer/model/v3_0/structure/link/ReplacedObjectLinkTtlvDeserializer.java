...
public class ReplacedObjectLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ReplacedObjectLink, ReplacedObjectLink.ReplacedObjectLinkBuilder> {
    ...
    @Override
    protected void setValue(ReplacedObjectLink.ReplacedObjectLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
