...
public class DeviceIdentifierTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DeviceIdentifier, DeviceIdentifier.DeviceIdentifierBuilder> {
    ...
    @Override
    protected void setValue(DeviceIdentifier.DeviceIdentifierBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
