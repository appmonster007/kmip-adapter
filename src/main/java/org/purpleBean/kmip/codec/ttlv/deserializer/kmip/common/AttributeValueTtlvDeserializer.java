...
public class AttributeValueTtlvDeserializer extends KmipDataTypeTtlvDeserializer<AttributeValue.Value> {

    private final KmipTag kmipTag = AttributeValue.kmipTag;

    @Override
    public AttributeValue.Value deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        ttlvBuffer.rewind();
        AttributeValue.Value attributeValue = (AttributeValue.Value) mapper.readValue(ttlvBuffer, clazz);
