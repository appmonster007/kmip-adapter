...
public class DrbgAlgorithmTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DrbgAlgorithm, DrbgAlgorithm.DrbgAlgorithmBuilder> {
    ...
    @Override
    protected void setValue(DrbgAlgorithm.DrbgAlgorithmBuilder builder, byte[] tagBytes, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
