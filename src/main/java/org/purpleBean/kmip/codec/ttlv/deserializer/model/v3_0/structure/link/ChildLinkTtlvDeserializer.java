...
public class ChildLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ChildLink, ChildLink.ChildLinkBuilder> {
    ...
    @Override
    protected void setValue(ChildLink.ChildLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
