...
public class AlternativeNameTtlvSerializer extends KmipDataTypeTtlvSerializer<AlternativeName> {
    @Override
    public ByteBuffer serialize(AlternativeName value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(AlternativeName value, TtlvMapper mapper) throws IOException {
