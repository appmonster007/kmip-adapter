...
public class CertificateIssuerOuTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateIssuerOu, CertificateIssuerOu.CertificateIssuerOuBuilder> {
    ...
    @Override
    protected void setValue(CertificateIssuerOu.CertificateIssuerOuBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
