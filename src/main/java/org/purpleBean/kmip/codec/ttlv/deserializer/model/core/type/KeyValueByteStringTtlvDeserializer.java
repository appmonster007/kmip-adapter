...
public class KeyValueByteStringTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<KeyValueByteString, KeyValueByteString.KeyValueByteStringBuilder> {
    ...
    @Override
    protected void setValue(KeyValueByteString.KeyValueByteStringBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
