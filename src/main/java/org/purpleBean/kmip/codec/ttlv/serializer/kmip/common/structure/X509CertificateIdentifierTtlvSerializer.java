...
public class X509CertificateIdentifierTtlvSerializer extends KmipDataTypeTtlvSerializer<X509CertificateIdentifier> {
    @Override
    public ByteBuffer serialize(X509CertificateIdentifier value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(X509CertificateIdentifier value, TtlvMapper mapper) throws IOException {
