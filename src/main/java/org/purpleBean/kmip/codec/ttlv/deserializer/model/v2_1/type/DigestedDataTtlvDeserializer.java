...
public class DigestedDataTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DigestedData, DigestedData.DigestedDataBuilder> {
    ...
    @Override
    protected void setValue(DigestedData.DigestedDataBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
