...
public class LogoutOpRequestPayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<LogoutOpRequestPayload, LogoutOpRequestPayload.LogoutOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(LogoutOpRequestPayload.LogoutOpRequestPayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
