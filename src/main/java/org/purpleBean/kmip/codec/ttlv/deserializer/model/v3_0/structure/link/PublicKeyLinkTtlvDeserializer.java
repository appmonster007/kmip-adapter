...
public class PublicKeyLinkTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<PublicKeyLink, PublicKeyLink.PublicKeyLinkBuilder> {
    ...
    @Override
    protected void setValue(PublicKeyLink.PublicKeyLinkBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
