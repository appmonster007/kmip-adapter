...
public class InitializationVectorTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<InitializationVector, InitializationVector.InitializationVectorBuilder> {
    ...
    @Override
    protected void setValue(InitializationVector.InitializationVectorBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
