...
public class UsageLimitsCountTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<UsageLimitsCount, UsageLimitsCount.UsageLimitsCountBuilder> {
    ...
    @Override
    protected void setValue(UsageLimitsCount.UsageLimitsCountBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
