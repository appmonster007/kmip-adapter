...
public class KeyWrappingSpecificationTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<KeyWrappingSpecification, KeyWrappingSpecification.KeyWrappingSpecificationBuilder> {
    ...
    @Override
    protected void setValue(KeyWrappingSpecification.KeyWrappingSpecificationBuilder builder, byte[] tagBytes, ByteBuffer p, TtlvMapper mapper) throws IOException {
