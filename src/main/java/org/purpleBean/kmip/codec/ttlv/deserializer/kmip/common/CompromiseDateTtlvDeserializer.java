...
public class CompromiseDateTtlvDeserializer extends KmipDataTypeTtlvDeserializer<CompromiseDate> {
    ...
    @Override
    public CompromiseDate deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
