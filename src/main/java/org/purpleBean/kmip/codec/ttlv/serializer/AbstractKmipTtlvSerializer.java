...
public abstract class AbstractKmipTtlvSerializer<T extends KmipDataType, V> extends KmipDataTypeTtlvSerializer<T> {

    private final Function<T, V> valueExtractor;

    protected AbstractKmipTtlvSerializer(Function<T, V> valueExtractor) {
