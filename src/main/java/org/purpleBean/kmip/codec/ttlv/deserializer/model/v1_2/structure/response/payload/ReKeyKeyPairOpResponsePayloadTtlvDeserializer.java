...
public class ReKeyKeyPairOpResponsePayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<ReKeyKeyPairOpResponsePayload, ReKeyKeyPairOpResponsePayload.ReKeyKeyPairOpResponsePayloadBuilder> {

    public ReKeyKeyPairOpResponsePayloadTtlvDeserializer() {
        super(ReKeyKeyPairOpResponsePayload.kmipTag);
    }
    ...
    @Override
    protected void setValue(ReKeyKeyPairOpResponsePayload.ReKeyKeyPairOpResponsePayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return ReKeyKeyPairOpResponsePayload.encodingType;
    }
}