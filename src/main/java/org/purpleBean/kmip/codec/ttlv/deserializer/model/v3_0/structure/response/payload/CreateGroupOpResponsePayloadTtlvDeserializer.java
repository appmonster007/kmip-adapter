...
public class CreateGroupOpResponsePayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CreateGroupOpResponsePayload, CreateGroupOpResponsePayload.CreateGroupOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(CreateGroupOpResponsePayload.CreateGroupOpResponsePayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
