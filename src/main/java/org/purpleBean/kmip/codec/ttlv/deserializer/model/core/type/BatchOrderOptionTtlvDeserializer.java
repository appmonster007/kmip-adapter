...
public class BatchOrderOptionTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<BatchOrderOption, BatchOrderOption.BatchOrderOptionBuilder> {
    ...
    @Override
    protected void setValue(BatchOrderOption.BatchOrderOptionBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
