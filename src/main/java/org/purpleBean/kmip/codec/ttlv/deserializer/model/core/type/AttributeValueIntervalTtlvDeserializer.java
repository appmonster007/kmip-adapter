...
public class AttributeValueIntervalTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<AttributeValueInterval, AttributeValueInterval.AttributeValueIntervalBuilder> {
    ...
    @Override
    protected void setValue(AttributeValueInterval.AttributeValueIntervalBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
