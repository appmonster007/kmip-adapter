...
public class CertificateLengthTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateLength, CertificateLength.CertificateLengthBuilder> {
    ...
    @Override
    protected void setValue(CertificateLength.CertificateLengthBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
