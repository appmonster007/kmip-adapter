...
public class CertificateLengthTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateLength, CertificateLength.CertificateLengthBuilder> {
    ...
    @Override
    protected void setValue(CertificateLength.CertificateLengthBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
