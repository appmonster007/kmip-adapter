...
public class TransparentRsaPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentRsaPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentRsaPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentRsaPublicKey value, TtlvMapper mapper) throws IOException {
