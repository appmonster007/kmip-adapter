...
public class ContactInformationTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ContactInformation, ContactInformation.ContactInformationBuilder> {
    ...
    @Override
    protected void setValue(ContactInformation.ContactInformationBuilder builder, byte[] tag, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
