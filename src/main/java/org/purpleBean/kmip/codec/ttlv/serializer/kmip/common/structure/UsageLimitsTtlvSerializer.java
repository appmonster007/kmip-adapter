...
public class UsageLimitsTtlvSerializer extends KmipDataTypeTtlvSerializer<UsageLimits> {
    @Override
    public ByteBuffer serialize(UsageLimits value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(UsageLimits value, TtlvMapper mapper) throws IOException {
