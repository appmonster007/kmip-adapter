...
/**
 * TTLV serializer for NameType.
 */
public class NameTypeTtlvSerializer extends KmipDataTypeTtlvSerializer<NameType> {

    @Override
    public ByteBuffer serialize(NameType value, TtlvMapper mapper) throws IOException {
