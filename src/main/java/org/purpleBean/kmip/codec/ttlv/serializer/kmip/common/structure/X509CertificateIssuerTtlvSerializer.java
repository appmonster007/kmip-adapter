...
public class X509CertificateIssuerTtlvSerializer extends KmipDataTypeTtlvSerializer<X509CertificateIssuer> {
    @Override
    public ByteBuffer serialize(X509CertificateIssuer value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(X509CertificateIssuer value, TtlvMapper mapper) throws IOException {
