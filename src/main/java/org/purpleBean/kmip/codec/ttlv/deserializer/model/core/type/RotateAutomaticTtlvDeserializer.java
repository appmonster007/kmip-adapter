...
public class RotateAutomaticTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<RotateAutomatic, RotateAutomatic.RotateAutomaticBuilder> {
    ...
    @Override
    protected void setValue(RotateAutomatic.RotateAutomaticBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
