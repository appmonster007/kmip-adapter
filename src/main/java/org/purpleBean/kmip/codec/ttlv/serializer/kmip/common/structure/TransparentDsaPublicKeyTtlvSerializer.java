...
public class TransparentDsaPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentDsaPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentDsaPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentDsaPublicKey value, TtlvMapper mapper) throws IOException {
