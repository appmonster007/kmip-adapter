...
public class StreamingCapabilityTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<StreamingCapability, StreamingCapability.StreamingCapabilityBuilder> {
    ...
    @Override
    protected void setValue(StreamingCapability.StreamingCapabilityBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
