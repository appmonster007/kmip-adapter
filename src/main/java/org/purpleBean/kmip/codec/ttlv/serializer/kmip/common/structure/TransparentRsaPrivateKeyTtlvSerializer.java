...
public class TransparentRsaPrivateKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentRsaPrivateKey> {
    @Override
    public ByteBuffer serialize(TransparentRsaPrivateKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentRsaPrivateKey value, TtlvMapper mapper) throws IOException {
