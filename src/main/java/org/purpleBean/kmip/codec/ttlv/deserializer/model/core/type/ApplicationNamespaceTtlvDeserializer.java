...
public class ApplicationNamespaceTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ApplicationNamespace, ApplicationNamespace.ApplicationNamespaceBuilder> {
    ...
    @Override
    protected void setValue(ApplicationNamespace.ApplicationNamespaceBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
