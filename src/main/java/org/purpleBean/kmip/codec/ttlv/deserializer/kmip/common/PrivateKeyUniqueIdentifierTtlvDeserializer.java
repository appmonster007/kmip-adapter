...
public class PrivateKeyUniqueIdentifierTtlvDeserializer extends KmipDataTypeTtlvDeserializer<PrivateKeyUniqueIdentifier> {
    ...
    @Override
    public PrivateKeyUniqueIdentifier deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
        ...
        if (!privateKeyUniqueIdentifier.isSupported()) {
            throw new NoSuchElementException(String.format("PrivateKeyUniqueIdentifier not supported for spec %s", spec));
        }
