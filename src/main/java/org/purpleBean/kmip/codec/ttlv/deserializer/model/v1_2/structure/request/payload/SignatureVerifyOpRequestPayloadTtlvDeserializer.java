...
public class SignatureVerifyOpRequestPayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<SignatureVerifyOpRequestPayload, SignatureVerifyOpRequestPayload.SignatureVerifyOpRequestPayloadBuilder> {

    public SignatureVerifyOpRequestPayloadTtlvDeserializer() {
        super(SignatureVerifyOpRequestPayload.kmipTag);
    }
    ...
    @Override
    protected void setValue(SignatureVerifyOpRequestPayload.SignatureVerifyOpRequestPayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return SignatureVerifyOpRequestPayload.encodingType;
    }
}
