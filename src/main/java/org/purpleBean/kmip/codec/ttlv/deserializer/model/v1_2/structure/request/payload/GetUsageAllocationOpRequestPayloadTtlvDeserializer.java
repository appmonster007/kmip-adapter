...
public class GetUsageAllocationOpRequestPayloadTtlvDeserializer extends AbstractKmipStructureTtlvDeserializer<GetUsageAllocationOpRequestPayload, GetUsageAllocationOpRequestPayload.GetUsageAllocationOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(GetUsageAllocationOpRequestPayload.GetUsageAllocationOpRequestPayloadBuilder builder, KmipTag.Value nodeTag, ByteBuffer p, TtlvMapper mapper) throws IOException {
        switch (nodeTag) {
    ...
    protected EncodingType getEncodingType() {
        return GetUsageAllocationOpRequestPayload.encodingType;
    }
}
