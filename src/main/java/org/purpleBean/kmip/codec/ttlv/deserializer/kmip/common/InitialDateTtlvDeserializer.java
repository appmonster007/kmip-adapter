...
public class InitialDateTtlvDeserializer extends KmipDataTypeTtlvDeserializer<InitialDate> {
    ...
    @Override
    public InitialDate deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
