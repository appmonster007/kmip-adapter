...
public class IVCounterNonceTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<IVCounterNonce, IVCounterNonce.IVCounterNonceBuilder> {
    ...
    @Override
    protected void setValue(IVCounterNonce.IVCounterNonceBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
