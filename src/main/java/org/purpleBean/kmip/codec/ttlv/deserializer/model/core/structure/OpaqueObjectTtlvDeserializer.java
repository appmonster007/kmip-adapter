...
public class OpaqueObjectTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<OpaqueObject, OpaqueObject.OpaqueObjectBuilder> {
    ...
    @Override
    protected void setValue(OpaqueObject.OpaqueObjectBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
