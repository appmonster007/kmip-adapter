...
public class StorageStatusMaskTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<StorageStatusMask, StorageStatusMask.StorageStatusMaskBuilder> {
    ...
    @Override
    protected void setValue(StorageStatusMask.StorageStatusMaskBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
