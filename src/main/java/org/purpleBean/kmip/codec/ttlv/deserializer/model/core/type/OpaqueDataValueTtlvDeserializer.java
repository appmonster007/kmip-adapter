...
public class OpaqueDataValueTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<OpaqueDataValue, OpaqueDataValue.OpaqueDataValueBuilder> {
    ...
    @Override
    protected void setValue(OpaqueDataValue.OpaqueDataValueBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
