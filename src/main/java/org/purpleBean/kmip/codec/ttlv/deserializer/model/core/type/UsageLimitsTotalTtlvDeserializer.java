...
public class UsageLimitsTotalTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<UsageLimitsTotal, UsageLimitsTotal.UsageLimitsTotalBuilder> {
    ...
    @Override
    protected void setValue(UsageLimitsTotal.UsageLimitsTotalBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
