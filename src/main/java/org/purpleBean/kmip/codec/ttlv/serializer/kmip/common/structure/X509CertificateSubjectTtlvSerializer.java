...
public class X509CertificateSubjectTtlvSerializer extends KmipDataTypeTtlvSerializer<X509CertificateSubject> {
    @Override
    public ByteBuffer serialize(X509CertificateSubject value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(X509CertificateSubject value, TtlvMapper mapper) throws IOException {
