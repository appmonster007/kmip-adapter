...
public class ResponsePayloadStructureTtlvDeserializer extends KmipDataTypeTtlvDeserializer<ResponsePayloadStructure> {

    @Override
    public ResponsePayloadStructure deserialize(ByteBuffer ttlvBuffer, TtlvMapper mapper) throws IOException {
