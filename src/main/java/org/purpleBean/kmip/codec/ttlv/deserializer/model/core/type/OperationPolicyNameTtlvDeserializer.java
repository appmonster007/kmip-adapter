...
public class OperationPolicyNameTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<OperationPolicyName, OperationPolicyName.OperationPolicyNameBuilder> {
    ...
    @Override
    protected void setValue(OperationPolicyName.OperationPolicyNameBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
