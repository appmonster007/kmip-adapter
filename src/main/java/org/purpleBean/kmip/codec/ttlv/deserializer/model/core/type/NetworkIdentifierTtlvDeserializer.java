...
public class NetworkIdentifierTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<NetworkIdentifier, NetworkIdentifier.NetworkIdentifierBuilder> {
    ...
    @Override
    protected void setValue(NetworkIdentifier.NetworkIdentifierBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
