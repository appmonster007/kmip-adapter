...
public class AttestationCapabilityTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<AttestationCapability, AttestationCapability.AttestationCapabilityBuilder> {
    ...
    @Override
    protected void setValue(AttestationCapability.AttestationCapabilityBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
