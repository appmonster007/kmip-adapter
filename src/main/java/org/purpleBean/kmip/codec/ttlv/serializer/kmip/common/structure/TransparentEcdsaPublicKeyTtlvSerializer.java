...
public class TransparentEcdsaPublicKeyTtlvSerializer extends KmipDataTypeTtlvSerializer<TransparentEcdsaPublicKey> {
    @Override
    public ByteBuffer serialize(TransparentEcdsaPublicKey value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(TransparentEcdsaPublicKey value, TtlvMapper mapper) throws IOException {
