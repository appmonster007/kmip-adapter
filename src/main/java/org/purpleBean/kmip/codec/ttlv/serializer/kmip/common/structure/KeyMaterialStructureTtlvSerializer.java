...
public class KeyMaterialStructureTtlvSerializer extends KmipDataTypeTtlvSerializer<KeyMaterialStructure> {
    @Override
    public ByteBuffer serialize(KeyMaterialStructure value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(KeyMaterialStructure value, TtlvMapper mapper) throws IOException {
