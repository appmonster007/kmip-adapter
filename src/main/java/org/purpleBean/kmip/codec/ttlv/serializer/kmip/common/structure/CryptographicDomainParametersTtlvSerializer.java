...
public class CryptographicDomainParametersTtlvSerializer extends KmipDataTypeTtlvSerializer<CryptographicDomainParameters> {
    @Override
    public ByteBuffer serialize(CryptographicDomainParameters value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(CryptographicDomainParameters value, TtlvMapper mapper) throws IOException {
