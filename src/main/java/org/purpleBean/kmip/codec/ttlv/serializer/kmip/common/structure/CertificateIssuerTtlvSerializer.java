...
public class CertificateIssuerTtlvSerializer extends KmipDataTypeTtlvSerializer<CertificateIssuer> {
    @Override
    public ByteBuffer serialize(CertificateIssuer value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(CertificateIssuer value, TtlvMapper mapper) throws IOException {
