...
public class QueryOpResponsePayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<QueryOpResponsePayload, QueryOpResponsePayload.QueryOpResponsePayloadBuilder> {
    ...
    protected void setValue(QueryOpResponsePayload.QueryOpResponsePayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
        ...
        switch (nodeTag) {
            ...
            case KmipTag.Standard.SERVER_INFORMATION -> builder.serverInformation(mapper.readValue(p, ServerInformation.class));
            case KmipTag.Standard.APPLICATION_NAMESPACE -> builder.applicationNamespace(mapper.readValue(p, ApplicationNamespace.class));
            case KmipTag.Standard.EXTENSION_INFORMATION -> builder.extensionInformation(mapper.readValue(p, ExtensionInformation.class));
