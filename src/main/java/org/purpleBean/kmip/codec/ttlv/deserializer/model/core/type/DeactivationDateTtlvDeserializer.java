...
public class DeactivationDateTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<DeactivationDate, DeactivationDate.DeactivationDateBuilder> {
    ...
    @Override
    protected void setValue(DeactivationDate.DeactivationDateBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
