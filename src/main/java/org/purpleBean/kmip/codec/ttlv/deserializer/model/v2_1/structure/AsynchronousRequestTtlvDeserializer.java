...
public class AsynchronousRequestTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<AsynchronousRequest, AsynchronousRequest.AsynchronousRequestBuilder> {
    ...
    @Override
    protected void setValue(AsynchronousRequest.AsynchronousRequestBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
        ...
        switch (nodeTag) {
            ...
            case KmipTag.Standard.SUBMISSION_DATE -> builder.submissionDate(mapper.readValue(p, SubmissionDate.class));
            case KmipTag.Standard.PROCESSING_STAGE -> builder.processingStage(mapper.readValue(p, ProcessingStage.class));
