...
public class ObjectGroupMemberTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ObjectGroupMember, ObjectGroupMember.ObjectGroupMemberBuilder> {
    ...
    @Override
    protected void setValue(ObjectGroupMember.ObjectGroupMemberBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
