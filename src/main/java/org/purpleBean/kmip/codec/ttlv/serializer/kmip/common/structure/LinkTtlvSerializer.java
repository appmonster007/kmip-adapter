...
public class LinkTtlvSerializer extends KmipDataTypeTtlvSerializer<Link> {
    @Override
    public ByteBuffer serialize(Link value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(Link value, TtlvMapper mapper) throws IOException {
