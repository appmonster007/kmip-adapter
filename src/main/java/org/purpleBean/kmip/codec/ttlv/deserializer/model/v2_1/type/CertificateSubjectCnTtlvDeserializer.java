...
public class CertificateSubjectCnTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<CertificateSubjectCn, CertificateSubjectCn.CertificateSubjectCnBuilder> {
    ...
    @Override
    protected void setValue(CertificateSubjectCn.CertificateSubjectCnBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
