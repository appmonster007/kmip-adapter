...
public class CertificateIdentifierTtlvSerializer extends KmipDataTypeTtlvSerializer<CertificateIdentifier> {
    @Override
    public ByteBuffer serialize(CertificateIdentifier value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(CertificateIdentifier value, TtlvMapper mapper) throws IOException {
