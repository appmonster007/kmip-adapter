...
public class ObliterateOpRequestPayloadTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<ObliterateOpRequestPayload, ObliterateOpRequestPayload.ObliterateOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(ObliterateOpRequestPayload.ObliterateOpRequestPayloadBuilder builder, byte[] tag, byte type, ByteBuffer p, TtlvMapper mapper) throws IOException {
