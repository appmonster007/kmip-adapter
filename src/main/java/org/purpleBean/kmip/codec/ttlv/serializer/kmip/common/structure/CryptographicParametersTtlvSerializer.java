...
public class CryptographicParametersTtlvSerializer extends KmipDataTypeTtlvSerializer<CryptographicParameters> {
    @Override
    public ByteBuffer serialize(CryptographicParameters value, TtlvMapper mapper) throws IOException {
        return serializeToTtlvObject(value, mapper).toByteBuffer();
    }

    private TtlvObject serializeToTtlvObject(CryptographicParameters value, TtlvMapper mapper) throws IOException {
