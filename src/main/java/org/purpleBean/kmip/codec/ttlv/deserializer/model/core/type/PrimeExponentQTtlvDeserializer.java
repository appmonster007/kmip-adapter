...
public class PrimeExponentQTtlvDeserializer extends AbstractKmipDataTypeTtlvDeserializer<PrimeExponentQ, PrimeExponentQ.PrimeExponentQBuilder> {
    ...
    @Override
    protected void setValue(PrimeExponentQ.PrimeExponentQBuilder builder, byte[] tagBytes, byte type, ByteBuffer byteBuffer, TtlvMapper mapper) throws IOException {
