...
public class CertificateSubjectDistinguishedNameJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CertificateSubjectDistinguishedName, CertificateSubjectDistinguishedName.CertificateSubjectDistinguishedNameBuilder> {
    ...
    @Override
    protected void setValue(CertificateSubjectDistinguishedName.CertificateSubjectDistinguishedNameBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
