...
public class ObjectGroupJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ObjectGroup, ObjectGroup.ObjectGroupBuilder> {
    ...
    @Override
    protected void setValue(ObjectGroup.ObjectGroupBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
