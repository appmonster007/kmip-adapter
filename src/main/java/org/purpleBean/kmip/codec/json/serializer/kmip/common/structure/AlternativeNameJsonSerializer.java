...
public class AlternativeNameJsonSerializer extends KmipDataTypeJsonSerializer<AlternativeName> {

    @Override
    public void serialize(AlternativeName value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
