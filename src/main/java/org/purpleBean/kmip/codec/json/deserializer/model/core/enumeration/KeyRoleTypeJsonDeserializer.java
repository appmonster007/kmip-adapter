...
public class KeyRoleTypeJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<KeyRoleType, KeyRoleType.KeyRoleTypeBuilder> {
    ...
    @Override
    protected void setValue(KeyRoleType.KeyRoleTypeBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
