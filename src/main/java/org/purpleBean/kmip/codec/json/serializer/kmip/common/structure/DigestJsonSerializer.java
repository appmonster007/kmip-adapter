...
public class DigestJsonSerializer extends KmipDataTypeJsonSerializer<Digest> {

    @Override
    public void serialize(Digest value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
