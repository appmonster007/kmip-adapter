...
public class UsageLimitsJsonSerializer extends KmipDataTypeJsonSerializer<UsageLimits> {

    @Override
    public void serialize(UsageLimits value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
