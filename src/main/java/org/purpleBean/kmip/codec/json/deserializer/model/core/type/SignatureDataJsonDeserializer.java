...
public class SignatureDataJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<SignatureData, SignatureData.SignatureDataBuilder> {
    ...
    @Override
    protected void setValue(SignatureData.SignatureDataBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
