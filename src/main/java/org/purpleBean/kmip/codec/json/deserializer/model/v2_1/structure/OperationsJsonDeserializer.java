...
public class OperationsJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Operations, Operations.OperationsBuilder> {
    ...
    @Override
    protected void setValue(Operations.OperationsBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
