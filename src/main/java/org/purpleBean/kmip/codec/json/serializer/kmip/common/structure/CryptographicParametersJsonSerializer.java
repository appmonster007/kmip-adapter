...
public class CryptographicParametersJsonSerializer extends KmipDataTypeJsonSerializer<CryptographicParameters> {

    @Override
    public void serialize(CryptographicParameters value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
