...
public class CertificateSubjectLJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CertificateSubjectL, CertificateSubjectL.CertificateSubjectLBuilder> {
    ...
    @Override
    protected void setValue(CertificateSubjectL.CertificateSubjectLBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
