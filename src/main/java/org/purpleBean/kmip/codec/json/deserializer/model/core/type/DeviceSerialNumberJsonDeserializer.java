...
public class DeviceSerialNumberJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<DeviceSerialNumber, DeviceSerialNumber.DeviceSerialNumberBuilder> {
    ...
    @Override
    protected void setValue(DeviceSerialNumber.DeviceSerialNumberBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
