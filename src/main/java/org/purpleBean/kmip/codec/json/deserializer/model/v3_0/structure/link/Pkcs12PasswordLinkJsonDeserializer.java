...
public class Pkcs12PasswordLinkJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Pkcs12PasswordLink, Pkcs12PasswordLink.Pkcs12PasswordLinkBuilder> {
    ...
    @Override
    protected void setValue(Pkcs12PasswordLink.Pkcs12PasswordLinkBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
