...
public class ServerUriJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ServerUri, ServerUri.ServerUriBuilder> {
    ...
    @Override
    protected void setValue(ServerUri.ServerUriBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
