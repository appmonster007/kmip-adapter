...
/**
 * JSON serializer for InitialDate.
 */
public class InitialDateJsonSerializer extends KmipDataTypeJsonSerializer<InitialDate> {

    @Override
    public void serialize(InitialDate value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
