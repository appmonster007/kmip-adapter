...
public class DataEnumerationJsonDeserializer extends KmipDataTypeJsonDeserializer<DataEnumeration> {
    ...
    public DataEnumeration deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(DataEnumeration.class, String.format("JSON node cannot be null for DataEnumeration deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(DataEnumeration.class, String.format("Invalid KMIP tag for DataEnumeration"));
                return null;
            }
        } catch (Exception e) {
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(DataEnumeration.class, String.format("Missing or non-text 'type' field for DataEnumeration"));
            return null;
        }
