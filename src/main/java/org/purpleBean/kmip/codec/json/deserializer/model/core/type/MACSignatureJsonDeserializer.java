...
public class MACSignatureJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<MACSignature, MACSignature.MACSignatureBuilder> {
    ...
    @Override
    protected void setValue(MACSignature.MACSignatureBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
