...
public class ObliterateOpRequestPayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ObliterateOpRequestPayload, ObliterateOpRequestPayload.ObliterateOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(ObliterateOpRequestPayload.ObliterateOpRequestPayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    @Override
    protected ObliterateOpRequestPayload build(ObliterateOpRequestPayload.ObliterateOpRequestPayloadBuilder builder) {
