...
public class AttributeValueIntervalJsonDeserializer extends KmipDataTypeJsonDeserializer<AttributeValue.Interval> {
    ...
    public AttributeValue.Interval deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(AttributeValue.Interval.class, String.format("JSON node cannot be null for AttributeValue.Interval deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(AttributeValue.Interval.class, String.format("Invalid KMIP tag for AttributeValue.Interval"));
                return null;
            }
        } catch (Exception e) {
            ctxt.reportInputMismatch(AttributeValue.Interval.class, String.format("Failed to parse KMIP tag for AttributeValue.Interval: %s", e.getMessage()));
            return null;
        }
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(AttributeValue.Interval.class, String.format("Missing or non-text 'type' field for AttributeValue.Interval"));
            return null;
        }
        ...
        if (valueNode == null || !valueNode.isNumber()) {
            ctxt.reportInputMismatch(AttributeValue.Interval.class, "AttributeValue.Interval 'value' must be a non-empty number");
            return null;
        }
