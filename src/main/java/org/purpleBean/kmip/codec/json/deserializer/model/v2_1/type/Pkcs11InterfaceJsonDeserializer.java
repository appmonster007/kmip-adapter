...
public class Pkcs11InterfaceJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Pkcs11Interface, Pkcs11Interface.Pkcs11InterfaceBuilder> {
    ...
    @Override
    protected void setValue(Pkcs11Interface.Pkcs11InterfaceBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
