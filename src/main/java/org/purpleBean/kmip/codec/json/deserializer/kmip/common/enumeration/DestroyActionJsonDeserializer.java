...
public class DestroyActionJsonDeserializer extends KmipDataTypeJsonDeserializer<DestroyAction> {
    ...
    public DestroyAction deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(DestroyAction.class, String.format("JSON node cannot be null for DestroyAction deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(DestroyAction.class, String.format("Invalid KMIP tag for DestroyAction"));
                return null;
            }
        } catch (Exception e) {
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(DestroyAction.class, String.format("Missing or non-text 'type' field for DestroyAction"));
            return null;
        }
