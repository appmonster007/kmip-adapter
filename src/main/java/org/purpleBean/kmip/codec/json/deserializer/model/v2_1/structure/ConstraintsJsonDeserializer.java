...
public class ConstraintsJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Constraints, Constraints.ConstraintsBuilder> {
    ...
    @Override
    protected void setValue(Constraints.ConstraintsBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
