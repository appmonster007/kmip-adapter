...
public class CryptographicDomainParametersJsonSerializer extends KmipDataTypeJsonSerializer<CryptographicDomainParameters> {

    @Override
    public void serialize(CryptographicDomainParameters value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
