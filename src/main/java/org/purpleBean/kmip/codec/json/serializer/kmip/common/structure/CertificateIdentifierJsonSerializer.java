...
public class CertificateIdentifierJsonSerializer extends KmipDataTypeJsonSerializer<CertificateIdentifier> {

    @Override
    public void serialize(CertificateIdentifier value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
