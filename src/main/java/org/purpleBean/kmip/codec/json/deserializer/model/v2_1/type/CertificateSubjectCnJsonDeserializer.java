...
public class CertificateSubjectCnJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CertificateSubjectCn, CertificateSubjectCn.CertificateSubjectCnBuilder> {

    public CertificateSubjectCnJsonDeserializer() {
    ...
    @Override
    protected void setValue(CertificateSubjectCn.CertificateSubjectCnBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
