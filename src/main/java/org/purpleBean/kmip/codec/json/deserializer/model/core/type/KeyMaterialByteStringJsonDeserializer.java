...
public class KeyMaterialByteStringJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<KeyMaterialByteString, KeyMaterialByteString.KeyMaterialByteStringBuilder> {
    ...
    @Override
    protected void setValue(KeyMaterialByteString.KeyMaterialByteStringBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
