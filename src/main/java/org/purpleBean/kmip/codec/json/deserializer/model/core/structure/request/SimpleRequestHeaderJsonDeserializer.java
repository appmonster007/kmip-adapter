...
public class SimpleRequestHeaderJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<SimpleRequestHeader, SimpleRequestHeader.SimpleRequestHeaderBuilder> {
    ...
    @Override
    protected void setValue(SimpleRequestHeader.SimpleRequestHeaderBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
