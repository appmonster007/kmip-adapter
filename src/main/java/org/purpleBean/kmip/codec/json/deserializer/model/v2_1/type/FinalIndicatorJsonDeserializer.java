...
public class FinalIndicatorJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<FinalIndicator, FinalIndicator.FinalIndicatorBuilder> {
    ...
    @Override
    protected void setValue(FinalIndicator.FinalIndicatorBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
