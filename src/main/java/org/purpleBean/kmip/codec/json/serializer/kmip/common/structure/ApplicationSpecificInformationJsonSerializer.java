...
public class ApplicationSpecificInformationJsonSerializer extends KmipDataTypeJsonSerializer<ApplicationSpecificInformation> {

    @Override
    public void serialize(ApplicationSpecificInformation value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
