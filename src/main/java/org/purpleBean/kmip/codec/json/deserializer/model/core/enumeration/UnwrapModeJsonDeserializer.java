...
public class UnwrapModeJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<UnwrapMode, UnwrapMode.UnwrapModeBuilder> {
    ...
    @Override
    protected void setValue(UnwrapMode.UnwrapModeBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
