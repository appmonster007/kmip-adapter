...
public class HashingAlgorithmJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<HashingAlgorithm, HashingAlgorithm.HashingAlgorithmBuilder> {
    ...
    @Override
    protected void setValue(HashingAlgorithm.HashingAlgorithmBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
