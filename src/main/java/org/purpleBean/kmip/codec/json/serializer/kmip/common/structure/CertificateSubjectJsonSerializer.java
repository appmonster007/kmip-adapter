...
public class CertificateSubjectJsonSerializer extends KmipDataTypeJsonSerializer<CertificateSubject> {

    @Override
    public void serialize(CertificateSubject value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
