...
public class MediaIdentifierJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<MediaIdentifier, MediaIdentifier.MediaIdentifierBuilder> {
    ...
    @Override
    protected void setValue(MediaIdentifier.MediaIdentifierBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
