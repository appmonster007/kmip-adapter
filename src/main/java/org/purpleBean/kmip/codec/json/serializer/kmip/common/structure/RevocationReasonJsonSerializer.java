...
public class RevocationReasonJsonSerializer extends KmipDataTypeJsonSerializer<RevocationReason> {

    @Override
    public void serialize(RevocationReason value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
