...
public class ValidationCertificateIdentifierJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ValidationCertificateIdentifier, ValidationCertificateIdentifier.ValidationCertificateIdentifierBuilder> {
    ...
    @Override
    protected void setValue(ValidationCertificateIdentifier.ValidationCertificateIdentifierBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
