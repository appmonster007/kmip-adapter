...
public class UniqueBatchItemIDJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<UniqueBatchItemID, UniqueBatchItemID.UniqueBatchItemIDBuilder> {
    ...
    @Override
    protected void setValue(UniqueBatchItemID.UniqueBatchItemIDBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
