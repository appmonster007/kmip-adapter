...
public class X509CertificateIssuerJsonSerializer extends KmipDataTypeJsonSerializer<X509CertificateIssuer> {

    @Override
    public void serialize(X509CertificateIssuer value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
