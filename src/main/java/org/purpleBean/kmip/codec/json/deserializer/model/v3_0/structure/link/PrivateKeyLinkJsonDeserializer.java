...
public class PrivateKeyLinkJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<PrivateKeyLink, PrivateKeyLink.PrivateKeyLinkBuilder> {
    ...
    @Override
    protected void setValue(PrivateKeyLink.PrivateKeyLinkBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
