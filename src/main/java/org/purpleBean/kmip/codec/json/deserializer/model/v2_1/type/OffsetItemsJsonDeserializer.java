...
public class OffsetItemsJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<OffsetItems, OffsetItems.OffsetItemsBuilder> {
    ...
    @Override
    protected void setValue(OffsetItems.OffsetItemsBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
