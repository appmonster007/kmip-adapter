...
public class PreviousLinkJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<PreviousLink, PreviousLink.PreviousLinkBuilder> {
    ...
    @Override
    protected void setValue(PreviousLink.PreviousLinkBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
