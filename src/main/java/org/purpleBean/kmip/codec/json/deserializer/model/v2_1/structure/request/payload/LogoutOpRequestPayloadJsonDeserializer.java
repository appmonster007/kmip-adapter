...
public class LogoutOpRequestPayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<LogoutOpRequestPayload, LogoutOpRequestPayload.LogoutOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(LogoutOpRequestPayload.LogoutOpRequestPayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
    ...
    @Override
    protected LogoutOpRequestPayload build(LogoutOpRequestPayload.LogoutOpRequestPayloadBuilder builder) {
