...
public class SimpleResponseMessageJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<SimpleResponseMessage, SimpleResponseMessage.SimpleResponseMessageBuilder> {
    ...
    @Override
    protected void setValue(SimpleResponseMessage.SimpleResponseMessageBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
