...
public class CertificateIssuerCnJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CertificateIssuerCn, CertificateIssuerCn.CertificateIssuerCnBuilder> {
    ...
    @Override
    protected void setValue(CertificateIssuerCn.CertificateIssuerCnBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
