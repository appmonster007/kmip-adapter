...
public class CertificateIssuerJsonSerializer extends KmipDataTypeJsonSerializer<CertificateIssuer> {

    @Override
    public void serialize(CertificateIssuer value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
