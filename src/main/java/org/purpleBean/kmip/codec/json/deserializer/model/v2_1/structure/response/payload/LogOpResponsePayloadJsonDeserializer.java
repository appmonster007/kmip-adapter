...
public class LogOpResponsePayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<LogOpResponsePayload, LogOpResponsePayload.LogOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(LogOpResponsePayload.LogOpResponsePayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
