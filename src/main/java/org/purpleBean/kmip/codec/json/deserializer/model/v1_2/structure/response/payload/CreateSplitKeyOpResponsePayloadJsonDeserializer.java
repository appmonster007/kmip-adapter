...
public class CreateSplitKeyOpResponsePayloadJsonDeserializer extends AbstractKmipStructureJsonDeserializer<CreateSplitKeyOpResponsePayload, CreateSplitKeyOpResponsePayload.CreateSplitKeyOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(CreateSplitKeyOpResponsePayload.CreateSplitKeyOpResponsePayloadBuilder builder, KmipTag.Value nodeTag, JsonParser p, DeserializationContext ctxt) throws IOException {
        switch (nodeTag) {
