...
public class SubmissionDateJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<SubmissionDate, SubmissionDate.SubmissionDateBuilder> {
    ...
    @Override
    protected void setValue(SubmissionDate.SubmissionDateBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
