...
public class CriticalityIndicatorJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CriticalityIndicator, CriticalityIndicator.CriticalityIndicatorBuilder> {
    ...
    @Override
    protected void setValue(CriticalityIndicator.CriticalityIndicatorBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
