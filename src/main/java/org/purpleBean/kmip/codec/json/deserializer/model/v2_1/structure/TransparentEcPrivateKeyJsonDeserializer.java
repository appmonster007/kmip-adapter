...
public class TransparentEcPrivateKeyJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<TransparentEcPrivateKey, TransparentEcPrivateKey.TransparentEcPrivateKeyBuilder> {
    ...
    @Override
    protected void setValue(TransparentEcPrivateKey.TransparentEcPrivateKeyBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
