...
public class CertificateIssuerOuJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<CertificateIssuerOu, CertificateIssuerOu.CertificateIssuerOuBuilder> {
    ...
    @Override
    protected void setValue(CertificateIssuerOu.CertificateIssuerOuBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
