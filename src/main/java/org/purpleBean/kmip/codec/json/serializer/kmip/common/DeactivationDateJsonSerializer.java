...
/**
 * JSON serializer for DeactivationDate.
 */
public class DeactivationDateJsonSerializer extends KmipDataTypeJsonSerializer<DeactivationDate> {

    @Override
    public void serialize(DeactivationDate value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
