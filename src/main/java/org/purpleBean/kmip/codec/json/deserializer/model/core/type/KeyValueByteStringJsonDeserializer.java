...
public class KeyValueByteStringJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<KeyValueByteString, KeyValueByteString.KeyValueByteStringBuilder> {
    ...
    @Override
    protected void setValue(KeyValueByteString.KeyValueByteStringBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
