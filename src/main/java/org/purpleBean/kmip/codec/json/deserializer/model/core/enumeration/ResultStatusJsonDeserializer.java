...
public class ResultStatusJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ResultStatus, ResultStatus.ResultStatusBuilder> {
    ...
    @Override
    protected void setValue(ResultStatus.ResultStatusBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
