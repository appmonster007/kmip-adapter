...
public class X509CertificateSubjectJsonSerializer extends KmipDataTypeJsonSerializer<X509CertificateSubject> {

    @Override
    public void serialize(X509CertificateSubject value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
