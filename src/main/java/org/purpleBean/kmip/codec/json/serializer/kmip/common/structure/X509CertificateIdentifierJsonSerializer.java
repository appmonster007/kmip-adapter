...
public class X509CertificateIdentifierJsonSerializer extends KmipDataTypeJsonSerializer<X509CertificateIdentifier> {

    @Override
    public void serialize(X509CertificateIdentifier value, JsonGenerator jsonGenerator, SerializerProvider serializerProvider) throws IOException {
