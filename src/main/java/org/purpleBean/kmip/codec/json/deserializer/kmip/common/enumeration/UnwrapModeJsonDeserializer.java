...
public class UnwrapModeJsonDeserializer extends KmipDataTypeJsonDeserializer<UnwrapMode> {
    ...
    public UnwrapMode deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(UnwrapMode.class, String.format("JSON node cannot be null for UnwrapMode deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(UnwrapMode.class, String.format("Invalid KMIP tag for UnwrapMode"));
                return null;
            }
        } catch (Exception e) {
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(UnwrapMode.class, String.format("Missing or non-text 'type' field for UnwrapMode"));
            return null;
        }
