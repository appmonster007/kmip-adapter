...
public class QueryOpResponsePayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<QueryOpResponsePayload, QueryOpResponsePayload.QueryOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(QueryOpResponsePayload.QueryOpResponsePayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        switch (nodeTag) {
            ...
            case KmipTag.Standard.SERVER_INFORMATION -> builder.serverInformation(ctxt.readValue(p, ServerInformation.class));
            case KmipTag.Standard.APPLICATION_NAMESPACE -> builder.applicationNamespace(ctxt.readValue(p, ApplicationNamespace.class));
            case KmipTag.Standard.EXTENSION_INFORMATION -> builder.extensionInformation(ctxt.readValue(p, ExtensionInformation.class));
