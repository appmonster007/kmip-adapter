...
/**
 * JSON serializer for ProtectStopDate.
 */
public class ProtectStopDateJsonSerializer extends KmipDataTypeJsonSerializer<ProtectStopDate> {

    @Override
    public void serialize(ProtectStopDate value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
