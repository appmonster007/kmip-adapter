...
public class AlternativeNameTypeJsonDeserializer extends KmipDataTypeJsonDeserializer<AlternativeNameType> {
    ...
    public AlternativeNameType deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(AlternativeNameType.class, String.format("JSON node cannot be null for AlternativeNameType deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(AlternativeNameType.class, String.format("Invalid KMIP tag for AlternativeNameType"));
                return null;
            }
        } catch (Exception e) {
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(AlternativeNameType.class, String.format("Missing or non-text 'type' field for AlternativeNameType"));
            return null;
        }
        ...
        try {
            alternativenametypeValue = AlternativeNameType.fromName(spec, description);
