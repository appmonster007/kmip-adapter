...
public class ContactInformationJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ContactInformation, ContactInformation.ContactInformationBuilder> {
    ...
    @Override
    protected void setValue(ContactInformation.ContactInformationBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
