...
public class AttributesJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<Attributes, Attributes.AttributesBuilder> {
    ...
    @Override
    protected void setValue(Attributes.AttributesBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
