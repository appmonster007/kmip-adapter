...
public class KeyValueLocationJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<KeyValueLocation, KeyValueLocation.KeyValueLocationBuilder> {
    ...
    @Override
    protected void setValue(KeyValueLocation.KeyValueLocationBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
