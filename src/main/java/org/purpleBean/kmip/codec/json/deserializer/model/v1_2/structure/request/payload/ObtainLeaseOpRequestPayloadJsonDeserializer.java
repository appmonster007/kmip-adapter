...
public class ObtainLeaseOpRequestPayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<ObtainLeaseOpRequestPayload, ObtainLeaseOpRequestPayload.ObtainLeaseOpRequestPayloadBuilder> {
    ...
    @Override
    protected void setValue(ObtainLeaseOpRequestPayload.ObtainLeaseOpRequestPayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
