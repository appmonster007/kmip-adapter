...
public class AuthenticatedEncryptionAdditionalDataJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<AuthenticatedEncryptionAdditionalData, AuthenticatedEncryptionAdditionalData.AuthenticatedEncryptionAdditionalDataBuilder> {
    ...
    @Override
    protected void setValue(AuthenticatedEncryptionAdditionalData.AuthenticatedEncryptionAdditionalDataBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
