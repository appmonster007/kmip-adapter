...
public class RegisterOpResponsePayloadJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<RegisterOpResponsePayload, RegisterOpResponsePayload.RegisterOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(RegisterOpResponsePayload.RegisterOpResponsePayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
