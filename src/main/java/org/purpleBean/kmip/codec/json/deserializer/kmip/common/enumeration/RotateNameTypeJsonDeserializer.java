...
public class RotateNameTypeJsonDeserializer extends KmipDataTypeJsonDeserializer<RotateNameType> {
    ...
    public RotateNameType deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (node == null) {
            ctxt.reportInputMismatch(RotateNameType.class, String.format("JSON node cannot be null for RotateNameType deserialization"));
            return null;
        }
        ...
        try {
            ...
            if (tag == null) {
                ctxt.reportInputMismatch(RotateNameType.class, String.format("Invalid KMIP tag for RotateNameType"));
                return null;
            }
        } catch (Exception e) {
        ...
        if (typeNode == null
            ...
            ctxt.reportInputMismatch(RotateNameType.class, String.format("Missing or non-text 'type' field for RotateNameType"));
            return null;
        }
