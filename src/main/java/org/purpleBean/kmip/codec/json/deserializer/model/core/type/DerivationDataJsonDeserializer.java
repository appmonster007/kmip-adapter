...
public class DerivationDataJsonDeserializer extends AbstractKmipDataTypeJsonDeserializer<DerivationData, DerivationData.DerivationDataBuilder> {
    ...
    @Override
    protected void setValue(DerivationData.DerivationDataBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
