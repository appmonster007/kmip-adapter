...
public class ReKeyKeyPairOpResponsePayloadXmlDeserializer extends AbstractKmipStructureXmlDeserializer<ReKeyKeyPairOpResponsePayload, ReKeyKeyPairOpResponsePayload.ReKeyKeyPairOpResponsePayloadBuilder> {
    ...
    @Override
    protected void setValue(ReKeyKeyPairOpResponsePayload.ReKeyKeyPairOpResponsePayloadBuilder builder, KmipTag.Value nodeTag, JsonParser p, DeserializationContext ctxt) throws IOException {
        switch (nodeTag) {
