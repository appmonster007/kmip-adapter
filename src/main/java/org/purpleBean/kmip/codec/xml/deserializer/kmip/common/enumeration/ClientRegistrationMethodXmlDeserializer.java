...
public class ClientRegistrationMethodXmlDeserializer extends KmipDataTypeXmlDeserializer<ClientRegistrationMethod> {
    ...
    public ClientRegistrationMethod deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
                ...
                if ("value".equalsIgnoreCase(fieldName)) {
                    if (p.hasTextCharacters()) {
                        ctxt.reportInputMismatch(ClientRegistrationMethod.class,
                                "Missing or non-text 'value' for ClientRegistrationMethod");
                        return null;
                    }
        ...
        if (description == null) {
            ctxt.reportInputMismatch(ClientRegistrationMethod.class, "Missing 'value' for ClientRegistrationMethod");
            return null;
        }
