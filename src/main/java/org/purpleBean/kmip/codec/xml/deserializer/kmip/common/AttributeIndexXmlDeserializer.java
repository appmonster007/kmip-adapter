...
public class AttributeIndexXmlDeserializer extends KmipDataTypeXmlDeserializer<AttributeIndex> {
    ...
    public AttributeIndex deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        AttributeIndex.AttributeIndexBuilder builder = AttributeIndex.builder();
            ...
            if (p.currentToken() == JsonToken.FIELD_NAME) {
                ...
                if ("type".equalsIgnoreCase(fieldName)) {
                    ...
                    if (!encodingType.getDescription().equals(type)) {
                        ctxt.reportInputMismatch(AttributeIndex.class, "Missing or invalid 'type' attribute for AttributeIndex");
                        return null;
                    }
                }
        ...
        AttributeIndex attributeIndex = builder.build();
