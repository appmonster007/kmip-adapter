...
public class BatchErrorContinuationOptionXmlDeserializer extends KmipDataTypeXmlDeserializer<BatchErrorContinuationOption> {
    ...
    public BatchErrorContinuationOption deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
                ...
                if ("value".equalsIgnoreCase(fieldName)) {
                    if (p.hasTextCharacters()) {
                        ctxt.reportInputMismatch(BatchErrorContinuationOption.class,
                                "Missing or non-text 'value' for BatchErrorContinuationOption");
                        return null;
                    }
        ...
        if (description == null) {
            ctxt.reportInputMismatch(BatchErrorContinuationOption.class, "Missing 'value' for BatchErrorContinuationOption");
            return null;
        }
