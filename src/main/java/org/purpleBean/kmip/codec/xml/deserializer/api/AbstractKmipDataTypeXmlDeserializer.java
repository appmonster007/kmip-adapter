...
public abstract class AbstractKmipDataTypeXmlDeserializer<T extends KmipDataType, V> extends KmipDataTypeXmlDeserializer<T> {
    ...
    protected AbstractKmipDataTypeXmlDeserializer(KmipTag kmipTag, EncodingType encodingType, Class<V> valueClass, Function<V, T> factory) {
