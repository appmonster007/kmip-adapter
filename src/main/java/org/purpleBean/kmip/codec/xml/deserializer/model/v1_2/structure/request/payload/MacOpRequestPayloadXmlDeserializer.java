...
public class MacOpRequestPayloadXmlDeserializer extends AbstractKmipDataTypeXmlDeserializer<MacOpRequestPayload, MacOpRequestPayload.MacOpRequestPayloadBuilder> {

    public MacOpRequestPayloadXmlDeserializer() {
    ...
    @Override
    protected void setValue(MacOpRequestPayload.MacOpRequestPayloadBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
