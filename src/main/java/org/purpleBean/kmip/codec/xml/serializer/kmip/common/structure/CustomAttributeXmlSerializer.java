...
/**
 * XML serializer for Custom.
 */
public class CustomAttributeXmlSerializer extends KmipDataTypeXmlSerializer<CustomAttribute> {
    ...
    public void serialize(CustomAttribute customAttribute, JsonGenerator gen, SerializerProvider serializers) throws IOException {
        ...
        String elementName = customAttribute.getKmipTag().getDescription();
        xmlGen.setNextName(QName.valueOf(elementName));
        xmlGen.writeStartObject(customAttribute);

        // Serialize all fields
        List<KmipDataType> values = customAttribute.getValues();
