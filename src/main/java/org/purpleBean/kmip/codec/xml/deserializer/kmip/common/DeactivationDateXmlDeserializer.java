...
/**
 * XML deserializer for DeactivationDate.
 */
public class DeactivationDateXmlDeserializer extends KmipDataTypeXmlDeserializer<DeactivationDate> {
    ...
    public DeactivationDate deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        if (!kmipTag.getDescription().equalsIgnoreCase(currentName)) {
            ctxt.reportInputMismatch(DeactivationDate.class, "Invalid Tag for DeactivationDate");
            return null;
        }
        ...
        DeactivationDate.DeactivationDateBuilder builder = DeactivationDate.builder();
            ...
            if (p.currentToken() == JsonToken.FIELD_NAME) {
                ...
                if ("type".equalsIgnoreCase(fieldName)) {
                    ...
                    if (!encodingType.getDescription().equals(type)) {
                        ctxt.reportInputMismatch(DeactivationDate.class, "Missing or invalid 'type' attribute for DeactivationDate");
                        return null;
                    }
                }
        ...
        DeactivationDate attribute = builder.build();
