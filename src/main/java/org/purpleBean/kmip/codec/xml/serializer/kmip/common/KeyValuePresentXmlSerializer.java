...
/**
 * XML serializer for KeyValuePresent.
 */
public class KeyValuePresentXmlSerializer extends KmipDataTypeXmlSerializer<KeyValuePresent> {

    @Override
    public void serialize(KeyValuePresent value, JsonGenerator gen, SerializerProvider provider) throws IOException {
