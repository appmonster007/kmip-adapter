...
public class UsageLimitsXmlSerializer extends KmipDataTypeXmlSerializer<UsageLimits> {

    @Override
    public void serialize(UsageLimits value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
