...
public class ValidationProfileXmlDeserializer extends AbstractKmipDataTypeXmlDeserializer<ValidationProfile, ValidationProfile.ValidationProfileBuilder> {

    public ValidationProfileXmlDeserializer() {
    ...
    @Override
    protected void setValue(ValidationProfile.ValidationProfileBuilder builder, String tag, String type, JsonParser p, DeserializationContext ctxt) throws IOException {
