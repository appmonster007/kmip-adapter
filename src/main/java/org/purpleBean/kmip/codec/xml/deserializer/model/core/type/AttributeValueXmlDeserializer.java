...
public class AttributeValueXmlDeserializer extends
  ...
  @Override
  protected void setValue(AttributeValue.AttributeValueBuilder builder, String tag, String type,
      ...
      case INTEGER -> {
        ...
        if (attributeName != null && attributeName
          ...
          Function<String, ? extends KmipMaskType> fromMaskString =
              KmipMaskType.getFromMaskString(kmipTag);
          valueStack.push(fromMaskString
              .apply(value)
              .getValue());
