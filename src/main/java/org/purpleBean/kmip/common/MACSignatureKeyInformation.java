...
/**
 * KMIP MACSignatureKeyInformation dataType.
 */
@Data
...
public class MACSignatureKeyInformation implements KmipDataType {
    ...
    public static MACSignatureKeyInformation of(@NonNull String value) {
        return MACSignatureKeyInformation.builder().value(value).build();
    }
