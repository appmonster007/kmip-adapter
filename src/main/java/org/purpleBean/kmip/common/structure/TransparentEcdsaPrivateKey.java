...
public class TransparentEcdsaPrivateKey implements KeyMaterial.Structure {
    private static final Set<KmipSpec> supportedVersions = Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_2);

    static {
        for (KmipSpec spec : supportedVersions) {
            if (spec == KmipSpec.UnknownVersion || spec == KmipSpec.UnsupportedVersion) continue;
            KeyMaterial.Value.register(spec, encodingType, KeyFormatType.Standard.TRANSPARENT_ECDSA_PRIVATE_KEY, TransparentEcdsaPrivateKey.class, TransparentEcdsaPrivateKey::of);
        }
    }
    ...
    public static TransparentEcdsaPrivateKey of(@NonNull KeyMaterial.Value value) {
