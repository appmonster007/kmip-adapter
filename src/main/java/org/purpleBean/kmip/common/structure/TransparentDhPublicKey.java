...
public class TransparentDhPublicKey implements KeyMaterial.Structure {
    private static final Set<KmipSpec> supportedVersions = Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_2);

    static {
        for (KmipSpec spec : supportedVersions) {
            if (spec == KmipSpec.UnknownVersion || spec == KmipSpec.UnsupportedVersion) continue;
            KeyMaterial.Value.register(spec, encodingType, KeyFormatType.Standard.TRANSPARENT_DH_PUBLIC_KEY, TransparentDhPublicKey.class, TransparentDhPublicKey::of);
        }
    }
    ...
    public static TransparentDhPublicKey of(@NonNull KeyMaterial.Value value) {
