...
public class TransparentEcdsaPublicKey implements KeyMaterial.Structure {
    private static final Set<KmipSpec> supportedVersions = Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_2);

    static {
        for (KmipSpec spec : supportedVersions) {
            if (spec == KmipSpec.UnknownVersion || spec == KmipSpec.UnsupportedVersion) continue;
            KeyMaterial.Value.register(spec, encodingType, KeyFormatType.Standard.TRANSPARENT_ECDSA_PUBLIC_KEY, TransparentEcdsaPublicKey.class, TransparentEcdsaPublicKey::of);
        }
    }
    ...
    public static TransparentEcdsaPublicKey of(@NonNull KeyMaterial.Value value) {
    ...
    public static class TransparentEcdsaPublicKeyBuilder {
        public TransparentEcdsaPublicKey build() {
            validate();
            return new TransparentEcdsaPublicKey(recommendedCurve, qString);
        }
