...
public class PrimeFieldSize implements KmipDataType {
    ...
    public static final KmipTag kmipTag = KmipTag.Standard.PRIME_FIELD_SIZE.inst();
    ...
    static {
        for (KmipSpec spec : supportedVersions) {
            ...
            KmipDataType.register(spec, kmipTag.getValue(), encodingType, PrimeFieldSize.class);
        }
    }
