...
public class CryptographicAlgorithm implements KmipEnumeration {
    ...
    public enum Standard implements Value {
        ...
        ML_KEM_512(0x00000039, "MLKEM512", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        ML_KEM_768(0x0000003A, "MLKEM768", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        ML_KEM_1024(0x0000003B, "MLKEM1024", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        ML_DSA_44(0x0000003C, "MLDSA44", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        ML_DSA_65(0x0000003D, "MLDSA65", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        ML_DSA_87(0x0000003E, "MLDSA87", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_128S(0x0000003F, "SLHDSASHA2128s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_128F(0x00000040, "SLHDSASHA2128f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_192S(0x00000041, "SLHDSASHA2192s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_192F(0x00000042, "SLHDSASHA2192f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_256S(0x00000043, "SLHDSASHA2256s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHA2_256F(0x00000044, "SLHDSASHA2256f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_128S(0x00000045, "SLHDSASHAKE128s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_128F(0x00000046, "SLHDSASHAKE128f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_192S(0x00000047, "SLHDSASHAKE192s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_192F(0x00000048, "SLHDSASHAKE192f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_256S(0x00000049, "SLHDSASHAKE256s", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0),
        SLH_DSA_SHAKE_256F(0x0000004A, "SLHDSASHAKE256f", KmipSpec.UnknownVersion, KmipSpec.V2_1, KmipSpec.V3_0);
