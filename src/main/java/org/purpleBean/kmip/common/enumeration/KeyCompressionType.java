...
/**
 * KMIP Key Compression Type enumeration.
 */
@Data
public class KeyCompressionType implements KmipEnumeration {
    ...
    public enum Standard implements Value {
        NONE(0x00000001, "None", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0, KmipSpec.V1_1, KmipSpec.V1_2, KmipSpec.V1_3, KmipSpec.V1_4, KmipSpec.V2_0)),
        EC_PUBLIC_KEY(0x00000002, "EC Public Key", Set.of(KmipSpec.UnknownVersion, KmipSpec.V1_0, KmipSpec.V1_1, KmipSpec.V1_2, KmipSpec.V1_3, KmipSpec.V1_4, KmipSpec.V2_0));
