...
public class CancellationResult implements KmipEnumeration {
    ...
    public CancellationResult(@NonNull Value value) {
        // KMIP spec compatibility validation
        KmipSpec spec = KmipContext.getSpec();
        if (!value.isSupportedFor(spec)) {
            throw new IllegalArgumentException(
                    String.format("Value '%s' for CancellationResult is not supported for KMIP spec %s", value.getDescription(), spec)
            );
        }
        this.value = value;
    }
    ...
    */
    ...
    public enum Standard implements Value {
        CANCELED(0x00000001, "Canceled", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        UNABLE_TO_CANCEL(0x00000002, "UnableToCancel", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        COMPLETED(0x00000003, "Completed", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        FAILED(0x00000004, "Failed", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0),
        UNAVAILABLE(0x00000005, "Unavailable", KmipSpec.UnknownVersion, KmipSpec.V1_2, KmipSpec.V2_1, KmipSpec.V3_0);
