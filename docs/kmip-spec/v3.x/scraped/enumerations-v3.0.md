...
| ----------------- | ---------- | ----------- |
| Unspecified       | 0x00000001 |  |
| Deactivation Date | 0x00000002 |  |
| Protect Stop Date | 0x00000003 |  |
| Usage Limit       | 0x00000004 |  |
...
| Name              | Hex        | Description |
| ----------------- | ---------- | ----------- |
| Data              | 0x00000001 | Only the Data tag is omitted from the Response Payload |
| Empty             | 0x00000002 | The Response Payload is returned as empty (all fields are omitted) |
| Unique Identifier | 0x00000003 | All fields in the Response Payload other than the Unique Identifier are omitted. |
...
| Identifier         | 0x0000000C | Sequences of character values. |
| Reference          | 0x0000000D | Sequences of character values. |
| Name Reference     | 0x0000000E | Sequence of character values. |
...
| Name | Hex        | Description |
| ---- | ---------- | ----------- |
| HOTP | 0x00000001 | HMAC-Based One-Time Password Algorithm [RFC4226] |
| TOTP | 0x00000002 | Time-Based One-Time Password Algorithm [RFC6238] |
...
| User                         | 0x0000000B |  |
| Group                        | 0x0000000C |  |
| Password Credential          | 0x0000000D |  |
| Device Credential            | 0x0000000E |  |
| One Time Password Credential | 0x0000000F |  |
| Hashed Password Credential   | 0x00000010 |  |
...
| Process                     | 0x0000003A |  |
| Ping                        | 0x0000003B |  |
| Create Group                | 0x0000003C |  |
| Obliterate                  | 0x0000003D |  |
| Create User                 | 0x0000003E |  |
| Create Credential           | 0x0000003F |  |
...
| Query Credential Information      | 0x0000000F |  |
...
| Numeric Range                          | 0x0000001B | An operation produced a number that is too large or too small to be stored in the specified data type |
...
| Invalid CSR                            | 0x0000002F | Invalid Certificate Signing Request |
...
| Circular Link Error                    | 0x0000004D | A ParentLink sets up a directed acyclic relationship. Detection of a cycle in the relationship graph results in this reason code. |
...
| Name           | Hex        | Description |
| -------------- | ---------- | ----------- |
| Polynomial-283 | 0x00000001 |  |
| Polynomial-285 | 0x00000002 |  |
...
| Re-Provision                | 0x00000012 |  |
| Create User                 | 0x00000013 |  |
| Create Group                | 0x00000014 |  |
| Create Credential           | 0x00000015 |  |
